...
#define CKFN_ISP() \
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP) != NULL)

#define CKFN_ISP_RegisterBusCallBack()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISPRegisterBusCallBack != NULL)
...
#define CKFN_ISP_RegisterPirisCallBack()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISPRegisterPirisCallBack != NULL)
...
#define CKFN_ISP_RegisterSnapCallBack()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISPRegisterSnapCallBack != NULL)
...
#define CKFN_ISP_RegisterViBusCallBack()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISPRegisterViBusCallBack != NULL)
...
#define CKFN_ISP_GetDCFInfo()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_GetDCFInfo != NULL)
...
#define CKFN_ISP_GetIspUpdateInfo()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_GetIspUpdateInfo != NULL)
...
#define CKFN_ISP_SetIspUpdateInfo()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_SetIspUpdateInfo != NULL)
...
#define CKFN_ISP_GetFrameInfo()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_GetFrameInfo != NULL)
...
#define CKFN_ISP_SetFrameInfo()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_SetFrameInfo != NULL)
...
#define CKFN_ISP_GetAttachInfo()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_GetAttachInfo != NULL)
...
#define CKFN_ISP_GetColorGamutInfo()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S,HI_ID_ISP)->pfnISP_GetColorGamutInfo != NULL)
...
#define CKFN_ISP_SetDCFInfo()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_SetDCFInfo != NULL)
...
#define CKFN_ISP_GetDngImageDynamicInfo()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_GetDngImageDynamicInfo != NULL)
...
#define CKFN_ISP_SaveSnapConfig()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_SaveSnapConfig != NULL)
...
#define CKFN_ISP_SetProEnable()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_SetProEnable != NULL)
...
#define CKFN_ISP_DRV_GetReadyBeBuf()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_DRV_GetReadyBeBuf != NULL)
...
#define CKFN_ISP_DRV_PutFreeBeBuf()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_DRV_PutFreeBeBuf != NULL)
...
#define CKFN_ISP_DRV_HoldBusyBeBuf()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_DRV_HoldBusyBeBuf != NULL)
...
#define CKFN_ISP_DRV_GetBeSyncPara()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_DRV_GetBeSyncPara != NULL)
...
#define CKFN_ISP_GetProCtrl()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_GetProCtrl != NULL)
...
#define CKFN_ISP_SetSnapAttr()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_SetSnapAttr != NULL)
...
#define CKFN_ISP_SetProNrParam()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_SetProNrParam != NULL)
...
#define CKFN_ISP_SetProShpParam()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_SetProShpParam != NULL)
...
#define CKFN_ISP_GetProNrParam()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_GetProNrParam != NULL)
...
#define CKFN_ISP_GetProShpParam()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_GetProShpParam != NULL)
...
#define CKFN_ISP_DRV_BeEndIntProc()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_DRV_BeEndIntProc != NULL)
...
#define CKFN_ISP_GetPubAttr()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISP_GetPubAttr != NULL)
...
#define CKFN_ISP_RegisterSyncTask()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISPRegisterSyncTask != NULL)
...
#define CKFN_ISP_UnRegisterSyncTask()\
    (FUNC_ENTRY(ISP_EXPORT_FUNC_S, HI_ID_ISP)->pfnISPUnRegisterSyncTask != NULL)
