...
#define VREG_EDGEMARK_BASE(ViPipe)  (HI_EXT_BASE_ADDR(ViPipe) + VREG_EDGEMARK_OFFSET)

/* Hlc:0x1040~0x104f */
#define VREG_HLC_OFFSET             (VREG_EDGEMARK_OFFSET + VREG_EDGEMARK_SIZE)
#define VREG_HLC_SIZE               (0x10)
#define VREG_HLC_BASE(ViPipe)       (HI_EXT_BASE_ADDR(ViPipe) + VREG_HLC_OFFSET)
...
#define VREG_FCR_BASE(ViPipe)       (HI_EXT_BASE_ADDR(ViPipe) + VREG_FCR_OFFSET)
...
#define VREG_DE_BASE(ViPipe)        (HI_EXT_BASE_ADDR(ViPipe) + VREG_DE_OFFSET)
...
#define VREG_RGBIR_BASE(ViPipe)       (HI_EXT_BASE_ADDR(ViPipe) + VREG_RGBIR_OFFSET)
...
static __inline HI_VOID hi_ext_system_be_total_width_write(VI_PIPE ViPipe, HI_U16 data)
{
    IOWR_16DIRECT(VREG_TOP_BASE(ViPipe) + 0x44, data);
}
static __inline HI_U16 hi_ext_system_be_total_width_read(VI_PIPE ViPipe)
{
    return IORD_16DIRECT(VREG_TOP_BASE(ViPipe) + 0x44);
}

static __inline HI_VOID hi_ext_system_be_total_height_write(VI_PIPE ViPipe, HI_U16 data)
{
    IOWR_16DIRECT(VREG_TOP_BASE(ViPipe) + 0x46, data);
}
static __inline HI_U16 hi_ext_system_be_total_height_read(VI_PIPE ViPipe)
{
...
static __inline HI_VOID hi_ext_system_sys_iso_write(VI_PIPE ViPipe, HI_U32 data)
{
    IOWR_32DIRECT((VREG_TOP_BASE(ViPipe) + 0xac), data);
}

static __inline HI_U32 hi_ext_system_sys_iso_read(VI_PIPE ViPipe)
{
...
{
    IOWR_16DIRECT(VREG_TOP_BASE(ViPipe) + 0x0200 + (i * sizeof(HI_U16)), data);
}
static __inline HI_U16 hi_ext_system_bayernr_actual_coarse_strength_read(VI_PIPE ViPipe, HI_U8 i)
{
    return IORD_16DIRECT(VREG_TOP_BASE(ViPipe) + 0x0200 + (i * sizeof(HI_U16)));
}
...
#define HI_EXT_SYSTEM_BE_LUT_STT_BUFFER_HIGH_ADDR_DATASIZE (32)

// args: data (32-bit)
static __inline HI_VOID hi_ext_system_be_lut_stt_buffer_high_addr_write(VI_PIPE ViPipe, HI_U32 data)
{
    IOWR_32DIRECT(VREG_TOP_BASE(ViPipe) + 0x278, data);
}

static __inline HI_U32 hi_ext_system_be_lut_stt_buffer_high_addr_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_BE_LUT_STT_BUFFER_LOW_ADDR_DATASIZE (32)

// args: data (32-bit)
static __inline HI_VOID hi_ext_system_be_lut_stt_buffer_low_addr_write(VI_PIPE ViPipe, HI_U32 data)
{
    IOWR_32DIRECT(VREG_TOP_BASE(ViPipe) + 0x27c, data);
}

static __inline HI_U32 hi_ext_system_be_lut_stt_buffer_low_addr_read(VI_PIPE ViPipe)
{
...
// args: data (32-bit)
static __inline HI_VOID hi_ext_system_ldci_read_stt_buffer_high_addr_write(VI_PIPE ViPipe, HI_U32 data)
{
    IOWR_32DIRECT(VREG_TOP_BASE(ViPipe) + 0x2ac, data);
}

static __inline HI_U32 hi_ext_system_ldci_read_stt_buffer_high_addr_read(VI_PIPE ViPipe)
{
...
// args: data (32-bit)
static __inline HI_VOID hi_ext_system_ldci_read_stt_buffer_low_addr_write(VI_PIPE ViPipe, HI_U32 data)
{
    IOWR_32DIRECT(VREG_TOP_BASE(ViPipe) + 0x2b0, data);
}

static __inline HI_U32 hi_ext_system_ldci_read_stt_buffer_low_addr_read(VI_PIPE ViPipe)
{
...
static __inline HI_VOID hi_ext_af_iir_gain0_group0_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00a0), data);
}
static __inline HI_S16 hi_ext_af_iir_gain0_group0_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00a0));
}

static __inline HI_VOID hi_ext_af_iir_gain0_group1_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00a2), data);
}
static __inline HI_S16 hi_ext_af_iir_gain0_group1_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00a2));
}

static __inline HI_VOID hi_ext_af_iir_gain1_group0_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00a4), data);
}
static __inline HI_S16 hi_ext_af_iir_gain1_group0_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00a4));
}

static __inline HI_VOID hi_ext_af_iir_gain1_group1_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00a6), data);
}
static __inline HI_S16 hi_ext_af_iir_gain1_group1_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00a6));
}

static __inline HI_VOID hi_ext_af_iir_gain2_group0_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00a8), data);
}
static __inline HI_S16 hi_ext_af_iir_gain2_group0_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00a8));
}

static __inline HI_VOID hi_ext_af_iir_gain2_group1_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00aa), data);
}
static __inline HI_S16 hi_ext_af_iir_gain2_group1_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00aa));
}

static __inline HI_VOID hi_ext_af_iir_gain3_group0_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00ac), data);
}
static __inline HI_S16 hi_ext_af_iir_gain3_group0_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00ac));
}

static __inline HI_VOID hi_ext_af_iir_gain3_group1_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00ae), data);
}
static __inline HI_S16 hi_ext_af_iir_gain3_group1_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00ae));
}

static __inline HI_VOID hi_ext_af_iir_gain4_group0_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00b0), data);
}
static __inline HI_S16 hi_ext_af_iir_gain4_group0_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00b0));
}

static __inline HI_VOID hi_ext_af_iir_gain4_group1_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00b2), data);
}
static __inline HI_S16 hi_ext_af_iir_gain4_group1_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00b2));
}

static __inline HI_VOID hi_ext_af_iir_gain5_group0_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00b4), data);
}
static __inline HI_S16 hi_ext_af_iir_gain5_group0_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00b4));
}

static __inline HI_VOID hi_ext_af_iir_gain5_group1_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00b6), data);
}
static __inline HI_S16 hi_ext_af_iir_gain5_group1_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00b6));
}

static __inline HI_VOID hi_ext_af_iir_gain6_group0_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00b8), data);
}
static __inline HI_S16 hi_ext_af_iir_gain6_group0_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00b8));
}

static __inline HI_VOID hi_ext_af_iir_gain6_group1_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00ba), data);
}
static __inline HI_S16 hi_ext_af_iir_gain6_group1_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00ba));
}

static __inline HI_VOID hi_ext_af_fir_h_gain0_group0_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00bc), data);
}
static __inline HI_S16 hi_ext_af_fir_h_gain0_group0_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00bc));
}

static __inline HI_VOID hi_ext_af_fir_h_gain0_group1_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00be), data);
}
static __inline HI_S16 hi_ext_af_fir_h_gain0_group1_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00be));
}

static __inline HI_VOID hi_ext_af_fir_h_gain1_group0_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00c0), data);
}
static __inline HI_S16 hi_ext_af_fir_h_gain1_group0_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00c0));
}

static __inline HI_VOID hi_ext_af_fir_h_gain1_group1_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00c2), data);
}
static __inline HI_S16 hi_ext_af_fir_h_gain1_group1_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00c2));
}

static __inline HI_VOID hi_ext_af_fir_h_gain2_group0_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00c4), data);
}
static __inline HI_S16 hi_ext_af_fir_h_gain2_group0_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00c4));
}

static __inline HI_VOID hi_ext_af_fir_h_gain2_group1_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00c6), data);
}
static __inline HI_S16 hi_ext_af_fir_h_gain2_group1_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00c6));
}

static __inline HI_VOID hi_ext_af_fir_h_gain3_group0_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00c8), data);
}
static __inline HI_S16 hi_ext_af_fir_h_gain3_group0_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00c8));
}

static __inline HI_VOID hi_ext_af_fir_h_gain3_group1_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00ca), data);
}
static __inline HI_S16 hi_ext_af_fir_h_gain3_group1_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00ca));
}

static __inline HI_VOID hi_ext_af_fir_h_gain4_group0_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00cc), data);
}
static __inline HI_S16 hi_ext_af_fir_h_gain4_group0_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_AF_BASE(ViPipe) + 0x00cc));
}

static __inline HI_VOID hi_ext_af_fir_h_gain4_group1_write(VI_PIPE ViPipe, HI_S16 data)
{
    IOWR_16DIRECT((VREG_AF_BASE(ViPipe) + 0x00ce), data);
}
static __inline HI_S16 hi_ext_af_fir_h_gain4_group1_read(VI_PIPE ViPipe)
{
...
static __inline HI_VOID hi_ext_system_af_enable_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_AF_BASE(ViPipe) + 0x00e0, (data & HI_ISP_AF_ENABLE_MASK));
}
static __inline HI_U8 hi_ext_system_af_enable_read(VI_PIPE ViPipe)
{
    return (IORD_8DIRECT(VREG_AF_BASE(ViPipe) + 0x00e0) & HI_ISP_AF_ENABLE_MASK);
}
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_drc_dp_detect_rb2rb_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT((VREG_DRC_BASE(ViPipe) + 0x58), data);
}
static __inline HI_U8 hi_ext_system_drc_dp_detect_rb2rb_read(VI_PIPE ViPipe)
{
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_drc_dp_detect_g2rb_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT((VREG_DRC_BASE(ViPipe) + 0x59), data);
}
static __inline HI_U8 hi_ext_system_drc_dp_detect_g2rb_read(VI_PIPE ViPipe)
{
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_drc_dp_detect_repl_ctr_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT((VREG_DRC_BASE(ViPipe) + 0x5a), data);
}
static __inline HI_U8 hi_ext_system_drc_dp_detect_repl_ctr_read(VI_PIPE ViPipe)
{
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_drc_dp_detect_rng_ratio_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT((VREG_DRC_BASE(ViPipe) + 0x5b), data);
}
static __inline HI_U8 hi_ext_system_drc_dp_detect_rng_ratio_read(VI_PIPE ViPipe)
{
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_drc_dp_detect_thr_slo_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_16DIRECT((VREG_DRC_BASE(ViPipe) + 0x5c), data);
}
static __inline HI_U8 hi_ext_system_drc_dp_detect_thr_slo_read(VI_PIPE ViPipe)
{
...
// ------------------------------------------------------------------------------ //
// args: data (16-bit)
static __inline HI_VOID hi_ext_system_drc_dp_detect_thr_min_write(VI_PIPE ViPipe, HI_U16 data)
{
    IOWR_16DIRECT((VREG_DRC_BASE(ViPipe) + 0x5e), data);
}
static __inline HI_U16 hi_ext_system_drc_dp_detect_thr_min_read(VI_PIPE ViPipe)
{
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_drc_dark_gain_lmt_c_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT((VREG_DRC_BASE(ViPipe) + 0x80), data);
}
static __inline HI_U8 hi_ext_system_drc_dark_gain_lmt_c_read(VI_PIPE ViPipe)
{
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_drc_dark_gain_lmt_y_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT((VREG_DRC_BASE(ViPipe) + 0x82), data);
}
static __inline HI_U8 hi_ext_system_drc_dark_gain_lmt_y_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_MANUAL_DEHAZE_STRENGTH_DATASIZE (8)
...
static __inline void hi_ext_system_manual_fpn_Type_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_FPN_BASE(ViPipe) + 0xd, data);
}

static __inline HI_U8 isp_ext_system_manual_fpn_Type_read(VI_PIPE ViPipe)
{
    return IORD_8DIRECT(VREG_FPN_BASE(ViPipe) + 0xd);
}

static __inline void hi_ext_system_manual_fpn_Enable_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_FPN_BASE(ViPipe) + 0xe, data);
}

static __inline HI_U8 isp_ext_system_manual_fpn_Enable_read(VI_PIPE ViPipe)
{
    return IORD_8DIRECT(VREG_FPN_BASE(ViPipe) + 0xe);
}

static __inline void hi_ext_system_manual_fpn_Pixelformat_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_FPN_BASE(ViPipe) + 0xf, data);
}

static __inline HI_U8 isp_ext_system_manual_fpn_Pixelformat_read(VI_PIPE ViPipe)
{
    return IORD_8DIRECT(VREG_FPN_BASE(ViPipe) + 0xf);
}

static __inline void hi_ext_system_manual_fpn_Gain_write(VI_PIPE ViPipe, HI_U32 data)
{
    IOWR_32DIRECT(VREG_FPN_BASE(ViPipe) + 0x10, data);
}

static __inline HI_U32 isp_ext_system_manual_fpn_Gain_read(VI_PIPE ViPipe)
{
    return IORD_32DIRECT(VREG_FPN_BASE(ViPipe) + 0x10);
}

static __inline void hi_ext_system_manual_fpn_Offset_write(VI_PIPE ViPipe, HI_U32 data)
{
    IOWR_32DIRECT(VREG_FPN_BASE(ViPipe) + 0x14, data);
}

static __inline HI_U32 isp_ext_system_manual_fpn_Offset_read(VI_PIPE ViPipe)
{
...
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_fpn_cablibrate_enable_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_FPN_BASE(ViPipe) + 0x19, data);
}

static __inline HI_U8 hi_ext_system_fpn_cablibrate_enable_read(VI_PIPE ViPipe)
{
...
static __inline HI_VOID hi_ext_system_black_level_manual_mode_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_BLC_BASE(ViPipe) + 0xa, data & 0x1);
}
static __inline HI_U8 hi_ext_system_black_level_manual_mode_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_CROP_EN_DATASIZE (8)

// args: data (8-bit)
static __inline HI_VOID hi_ext_system_ae_crop_en_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT((VREG_AE_BASE(ViPipe) + 0xf), data);
}
static __inline HI_U8 hi_ext_system_ae_crop_en_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_AE_CROP_X_DATASIZE (16)

// args: data (16-bit)
static __inline HI_VOID hi_ext_system_ae_crop_x_write(VI_PIPE ViPipe, HI_U16 data)
{
    IOWR_16DIRECT((VREG_AE_BASE(ViPipe) + 0x10), data);
}
static __inline HI_U32 hi_ext_system_ae_crop_x_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_AE_CROP_Y_DATASIZE (16)

// args: data (16-bit)
static __inline HI_VOID hi_ext_system_ae_crop_y_write(VI_PIPE ViPipe, HI_U16 data)
{
    IOWR_16DIRECT((VREG_AE_BASE(ViPipe) + 0x14), data);
}
static __inline HI_U16 hi_ext_system_ae_crop_y_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_AE_CROP_HEIGHT_DATASIZE (16)

// args: data (16-bit)
static __inline HI_VOID hi_ext_system_ae_crop_height_write(VI_PIPE ViPipe, HI_U16 data)
{
    IOWR_16DIRECT((VREG_AE_BASE(ViPipe) + 0x18), data);
}
static __inline HI_U16 hi_ext_system_ae_crop_height_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_AE_CROP_WIDTH_DATASIZE (16)

// args: data (16-bit)
static __inline HI_VOID hi_ext_system_ae_crop_width_write(VI_PIPE ViPipe, HI_U16 data)
{
    IOWR_16DIRECT((VREG_AE_BASE(ViPipe) + 0x1c), data);
}
static __inline HI_U16 hi_ext_system_ae_crop_width_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_SMART_ENABLE_DATASIZE (8)

// args: data (8-bit)
static __inline HI_VOID hi_ext_system_smart_enable_write(VI_PIPE ViPipe, HI_U16 index, HI_U8 data)
{
    IOWR_8DIRECT((VREG_AE_BASE(ViPipe) + 0x20 + index), data);
}
static __inline HI_U8 hi_ext_system_smart_enable_read(VI_PIPE ViPipe, HI_U16 index)
{
...
#define HI_EXT_SYSTEM_SMART_AVAILABLE_DATASIZE (8)

// args: data (8-bit)
static __inline HI_VOID hi_ext_system_smart_available_write(VI_PIPE ViPipe, HI_U16 index, HI_U8 data)
{
    IOWR_8DIRECT((VREG_AE_BASE(ViPipe) + 0x30 + index), data);
}
static __inline HI_U8 hi_ext_system_smart_available_read(VI_PIPE ViPipe, HI_U16 index)
{
...
#define HI_EXT_SYSTEM_SMART_LUMA_DATASIZE (8)

// args: data (8-bit)
static __inline HI_VOID hi_ext_system_smart_luma_write(VI_PIPE ViPipe, HI_U16 index, HI_U8 data)
{
    IOWR_8DIRECT((VREG_AE_BASE(ViPipe) + 0x40 + index), data);
}
static __inline HI_U8 hi_ext_system_smart_luma_read(VI_PIPE ViPipe, HI_U16 index)
{
...
#define HI_EXT_SYSTEM_SMART_UPDATE_DATASIZE (8)

// args: data (8-bit)
static __inline HI_VOID hi_ext_system_smart_update_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT((VREG_AE_BASE(ViPipe) + 0x50), data);
}
static __inline HI_U8 hi_ext_system_smart_update_read(VI_PIPE ViPipe)
{
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
#define HI_EXT_SYSTEM_DEMOSAIC_MANUAL_NONDIRECTION_MIDFREQ_DETAILENHANCE_STRENGTH_LINEAR_DEFAULT (8)
#define HI_EXT_SYSTEM_DEMOSAIC_MANUAL_NONDIRECTION_MIDFREQ_DETAILENHANCE_STRENGTH_WDR_DEFAULT    (0)
static __inline HI_VOID hi_ext_system_demosaic_manual_nondirection_midfreq_detailenhance_strength_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_DM_BASE(ViPipe) + 0x13, data);
}
static __inline HI_U8 hi_ext_system_demosaic_manual_nondirection_midfreq_detailenhance_strength_read(VI_PIPE ViPipe)
{
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
#define HI_EXT_SYSTEM_DEMOSAIC_MANUAL_NONDIRECTION_HIGFREQ_DETAILENHANCE_STRENGTH_LINEAR_DEFAULT (3)
#define HI_EXT_SYSTEM_DEMOSAIC_MANUAL_NONDIRECTION_HIGFREQ_DETAILENHANCE_STRENGTH_WDR_DEFAULT    (0)
static __inline HI_VOID hi_ext_system_demosaic_manual_nondirection_higfreq_detailenhance_strength_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_DM_BASE(ViPipe) + 0x14, data);
}
static __inline HI_U8 hi_ext_system_demosaic_manual_nondirection_higfreq_detailenhance_strength_read(VI_PIPE ViPipe)
{
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_demosaic_auto_nondirection_midfreq_detailenhance_strength_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT(VREG_DM_BASE(ViPipe) + 0x20 + (u8Index * sizeof(HI_U8)), data);
}
static __inline HI_U8 hi_ext_system_demosaic_auto_nondirection_midfreq_detailenhance_strength_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_demosaic_auto_nondirection_higfreq_detailenhance_strength_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT(VREG_DM_BASE(ViPipe) + 0x30 + (u8Index * sizeof(HI_U8)), data);
}
static __inline HI_U8 hi_ext_system_demosaic_auto_nondirection_higfreq_detailenhance_strength_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
...
{
    IOWR_8DIRECT(VREG_DM_BASE(ViPipe) + 0x50 + (u8Index * sizeof(HI_U8)), data);
}
static __inline HI_U8 hi_ext_system_demosaic_auto_detail_smooth_range_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return IORD_8DIRECT(VREG_DM_BASE(ViPipe) + 0x50 + (u8Index * sizeof(HI_U8)));
}
...
{
    IOWR_16DIRECT(VREG_DM_BASE(ViPipe) + 0x60 + (u8Index * sizeof(HI_U16)), data);
}
static __inline HI_U16 hi_ext_system_demosaic_auto_detail_smooth_strength_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return IORD_16DIRECT(VREG_DM_BASE(ViPipe) + 0x60 + (u8Index * sizeof(HI_U16)));
}
...
{
    IOWR_8DIRECT(VREG_FCR_BASE(ViPipe) + 0x2 + (u8Index * sizeof(HI_U8)), data);
}
static __inline HI_U8 hi_ext_system_antifalsecolor_auto_threshold_read(VI_PIPE ViPipe, HI_U8 u8Index)
{
    return IORD_8DIRECT(VREG_FCR_BASE(ViPipe) + 0x2 + (u8Index * sizeof(HI_U8)));
}
...
{
    IOWR_8DIRECT(VREG_FCR_BASE(ViPipe) + 0x12 + (u8Index * sizeof(HI_U8)), data);
}
static __inline HI_U8 hi_ext_system_antifalsecolor_auto_strenght_read(VI_PIPE ViPipe, HI_U8 u8Index)
{
    return IORD_8DIRECT(VREG_FCR_BASE(ViPipe) + 0x12 + (u8Index * sizeof(HI_U8)));
}
...
#define HI_EXT_SYSTEM_BAYERNR_LSC_MAX_GAIN_DATASIZE  (8)
static __inline HI_VOID hi_ext_system_bayernr_lsc_max_gain_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_BNR_BASE(ViPipe) + 0x9, data);
}
static __inline HI_U8 hi_ext_system_bayernr_lsc_max_gain_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_BAYERNR_LSC_CMP_STRENGTH_DATASIZE  (16)
static __inline HI_VOID hi_ext_system_bayernr_lsc_cmp_strength_write(VI_PIPE ViPipe, HI_U16 data)
{
    IOWR_16DIRECT(VREG_BNR_BASE(ViPipe) + 0xa, data);
}
static __inline HI_U16 hi_ext_system_bayernr_lsc_cmp_strength_read(VI_PIPE ViPipe)
{
...
{
    IOWR_8DIRECT(VREG_BNR_BASE(ViPipe) + 0x200 + (i * sizeof(HI_U8)), data);
}
static __inline HI_U8 hi_ext_system_bayernr_manual_chroma_strength_read(VI_PIPE ViPipe,  HI_U8 i)
{
    return IORD_8DIRECT(VREG_BNR_BASE(ViPipe) + 0x200 + (i * sizeof(HI_U8)));
}
...
#define HI_EXT_SYSTEM_BAYERNR_MANU_FINE_STRENGTH_DATASIZE (8)
static __inline HI_VOID hi_ext_system_bayernr_manual_fine_strength_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_BNR_BASE(ViPipe) + 0x210, data);
}
static __inline HI_U8 hi_ext_system_bayernr_manual_fine_strength_read(VI_PIPE ViPipe)
{
...
{
    IOWR_16DIRECT(VREG_BNR_BASE(ViPipe) + 0x220 + (i * sizeof(HI_U16)), data);
}
static __inline HI_U16 hi_ext_system_bayernr_manual_coarse_strength_read(VI_PIPE ViPipe, HI_U8 i)
{
    return IORD_16DIRECT(VREG_BNR_BASE(ViPipe) + 0x220  + (i * sizeof(HI_U16)));
}
...
{
    IOWR_8DIRECT(VREG_BNR_BASE(ViPipe) + 0x250 + (i * sizeof(HI_U8)), data);
}
static __inline HI_U8 hi_ext_system_bayernr_wdr_frame_strength_read(VI_PIPE ViPipe,  HI_U8 i)
{
    return IORD_8DIRECT(VREG_BNR_BASE(ViPipe) + 0x250 + (i * sizeof(HI_U8)));
}
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
#define HI_EXT_SYSTEM_BAYERNR_FUSION_FRAME_STRENGTH_DATASIZE (8)
static __inline HI_VOID hi_ext_system_bayernr_fusion_frame_strength_write(VI_PIPE ViPipe, HI_U8 i, HI_U8 data)
{
    IOWR_8DIRECT(VREG_BNR_BASE(ViPipe) + 0x270 + (i * sizeof(HI_U8)), data);
}
static __inline HI_U8 hi_ext_system_bayernr_fusion_frame_strength_read(VI_PIPE ViPipe,  HI_U8 i)
{
    return IORD_8DIRECT(VREG_BNR_BASE(ViPipe) + 0x270 + (i * sizeof(HI_U8)));
}
...
{
    IOWR_16DIRECT(VREG_BNR_BASE(ViPipe) + 0x290 + (i * sizeof(HI_U16)), data);
}
static __inline HI_U16 hi_ext_system_bayernr_coring_ratio_read(VI_PIPE ViPipe,  HI_U8 i)
{
    return IORD_16DIRECT(VREG_BNR_BASE(ViPipe) + 0x290 + (i * sizeof(HI_U16)));
}
...
#define HI_EXT_SYSTEM_WDR_WBGAIN_POSITION_DATASIZE (8)
#define HI_EXT_SYSTEM_WDR_WBGAIN_IN_DG1 (0)
#define HI_EXT_SYSTEM_WDR_WBGAIN_IN_WB (1)

// args: data (2-bit)
static __inline HI_VOID hi_ext_system_wdr_wbgain_position_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT((VREG_WDR_BASE(ViPipe) + 0x4f), data);
}
static __inline HI_U8 hi_ext_system_wdr_wbgain_position_read(VI_PIPE ViPipe)
{
...
static __inline HI_VOID hi_ext_system_isp_bnr_shading_r_gain_write(VI_PIPE ViPipe,  HI_U8 u8Index, HI_U16 data)
{
    IOWR_16DIRECT((VREG_LSC_BASE(ViPipe) + 0x4462 + u8Index * sizeof(HI_U16)), data);
}

static __inline HI_U16 hi_ext_system_isp_bnr_shading_r_gain_read(VI_PIPE ViPipe, HI_U8 u8Index)
{
    return (IORD_16DIRECT((VREG_LSC_BASE(ViPipe) + 0x4462 + u8Index * sizeof(HI_U16))));
}

/* length : 129; bytes : 129*2 = 258 = 0x102 */
static __inline HI_VOID hi_ext_system_isp_bnr_shading_gr_gain_write(VI_PIPE ViPipe,  HI_U8 u8Index, HI_U16 data)
{
    IOWR_16DIRECT((VREG_LSC_BASE(ViPipe) + 0x4564 + u8Index * sizeof(HI_U16)), data);
}

static __inline HI_U16 hi_ext_system_isp_bnr_shading_gr_gain_read(VI_PIPE ViPipe, HI_U8 u8Index)
{
    return (IORD_16DIRECT((VREG_LSC_BASE(ViPipe) + 0x4564 + u8Index * sizeof(HI_U16))));
}

/* length : 129; bytes : 129*2 = 258 = 0x102 */
static __inline HI_VOID hi_ext_system_isp_bnr_shading_gb_gain_write(VI_PIPE ViPipe,  HI_U8 u8Index, HI_U16 data)
{
    IOWR_16DIRECT((VREG_LSC_BASE(ViPipe) + 0x4666 + u8Index * sizeof(HI_U16)), data);
}

static __inline HI_U16 hi_ext_system_isp_bnr_shading_gb_gain_read(VI_PIPE ViPipe, HI_U8 u8Index)
{
    return (IORD_16DIRECT((VREG_LSC_BASE(ViPipe) + 0x4666 + u8Index * sizeof(HI_U16))));
}

/* length : 129; bytes : 129*2 = 258 = 0x102 */
static __inline HI_VOID hi_ext_system_isp_bnr_shading_b_gain_write(VI_PIPE ViPipe,  HI_U8 u8Index, HI_U16 data)
{
    IOWR_16DIRECT((VREG_LSC_BASE(ViPipe) + 0x4768 + u8Index * sizeof(HI_U16)), data);
}

static __inline HI_U16 hi_ext_system_isp_bnr_shading_b_gain_read(VI_PIPE ViPipe, HI_U8 u8Index)
{
    return (IORD_16DIRECT((VREG_LSC_BASE(ViPipe) + 0x4768 + u8Index * sizeof(HI_U16))));
}
...
{
    IOWR_16DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0x044  + (index * sizeof(HI_U16)), data & 0xFFF);
}
static __inline HI_U16 hi_ext_system_manual_Isp_sharpen_EdgeStr_read(VI_PIPE ViPipe,  HI_U8 index)
{
    return (IORD_16DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0x044  + (index * sizeof(HI_U16))) & 0xFFF);
}
...
// args: data (8-bit)
// ******************************32 multi addrs*********************************//
#define     HI_EXT_SYSTEM_MANUAL_ISP_SHARPEN_LUMAWGT_DEFAULT        (HI_ISP_SHARPEN_LUMAWGT)
static __inline HI_VOID hi_ext_system_manual_Isp_sharpen_LumaWgt_write(VI_PIPE ViPipe, HI_U8 index, HI_U8 data)
{
    IOWR_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0x08e  + (index * sizeof(HI_U8)), data & HI_ISP_SHARPEN_LUMAWGT_BIT);
}
static __inline HI_U8 hi_ext_system_manual_Isp_sharpen_LumaWgt_read(VI_PIPE ViPipe,  HI_U8 index)
{
    return (IORD_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0x08e  + (index * sizeof(HI_U8))) & HI_ISP_SHARPEN_LUMAWGT_BIT);
}
...
{
    IOWR_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xae, data & HI_ISP_SHARPEN_RGAIN_BIT);
}
static __inline HI_U8 hi_ext_system_manual_Isp_sharpen_RGain_read(VI_PIPE ViPipe)
{
    return (IORD_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xae)&HI_ISP_SHARPEN_RGAIN_BIT);
}
...
{
    IOWR_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xaf, data & HI_ISP_SHARPEN_BGAIN_BIT);
}
static __inline HI_U8 hi_ext_system_manual_Isp_sharpen_BGain_read(VI_PIPE ViPipe)
{
    return (IORD_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xaf)&HI_ISP_SHARPEN_BGAIN_BIT);
}
...
#define     HI_EXT_SYSTEM_MANUAL_ISP_SHARPEN_EDGEFILTMAXCAP_DEFAULT        (HI_ISP_SHARPEN_EdgeFiltMaxCap)
//***********************************************************************//
static __inline HI_VOID hi_ext_system_manual_Isp_sharpen_EdgeFiltMaxCap_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xb1, data & HI_ISP_SHARPEN_EdgeFiltMaxCap_BIT);
}
static __inline HI_U8 hi_ext_system_manual_Isp_sharpen_EdgeFiltMaxCap_read(VI_PIPE ViPipe)
{
    return ((IORD_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xb1)) & HI_ISP_SHARPEN_EdgeFiltMaxCap_BIT);
}
...
{
    IOWR_16DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0xb2  +  u16Index * sizeof(HI_U16)), data & 0xFFF);
}
static __inline HI_U16 hi_ext_system_Isp_sharpen_TextureStr_read(VI_PIPE ViPipe,  HI_U16 u16Index)
{
    return ((IORD_16DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0xb2  +  u16Index * sizeof(HI_U16)))) & 0xFFF);
}

// ******************************auoto 32 x 16 multi addrs*********************************//
static __inline HI_VOID hi_ext_system_Isp_sharpen_EdgeStr_write(VI_PIPE ViPipe, HI_U16 u16Index, HI_U16 data)
{
    IOWR_16DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x4b2  +  u16Index * sizeof(HI_U16)), data & 0xFFF);
}
static __inline HI_U16 hi_ext_system_Isp_sharpen_EdgeStr_read(VI_PIPE ViPipe,  HI_U16 u16Index)
{
    return ((IORD_16DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x4b2  +  u16Index * sizeof(HI_U16)))) & 0xFFF);
}
...
{
    IOWR_16DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x8b2  +  u8Index * sizeof(HI_U16)), data & 0xFFF);
}
static __inline HI_U16 hi_ext_system_Isp_sharpen_TextureFreq_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return ((IORD_16DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x8b2  +  u8Index * sizeof(HI_U16)))) & 0xFFF);
}

// ******************************auoto 16 multi addrs*********************************//
static __inline HI_VOID hi_ext_system_Isp_sharpen_EdgeFreq_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U16 data)
{
    IOWR_16DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x8d2  +  u8Index * sizeof(HI_U16)), data & 0xFFF);
}
static __inline HI_U16 hi_ext_system_Isp_sharpen_EdgeFreq_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return ((IORD_16DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x8d2  +  u8Index * sizeof(HI_U16)))) & 0xFFF);
}

// ******************************auoto 16 multi addrs*********************************//
static __inline HI_VOID hi_ext_system_Isp_sharpen_OverShoot_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x8f2  +  u8Index * sizeof(HI_U8)), data & 0x7f);
}
static __inline HI_U8 hi_ext_system_Isp_sharpen_OverShoot_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return ((IORD_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x8f2  +  u8Index * sizeof(HI_U8)))) & 0x7f);
}

// ******************************auoto 16 multi addrs*********************************//
static __inline HI_VOID hi_ext_system_Isp_sharpen_UnderShoot_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x902  +  u8Index * sizeof(HI_U8)), data & 0x7f);
}
static __inline HI_U8 hi_ext_system_Isp_sharpen_UnderShoot_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return ((IORD_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x902  +  u8Index * sizeof(HI_U8)))) & 0x7f);
}

// ******************************auoto 16 multi addrs*********************************//
static __inline HI_VOID hi_ext_system_Isp_sharpen_shootSupStr_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x912  +  u8Index * sizeof(HI_U8)), data);
}
static __inline HI_U8 hi_ext_system_Isp_sharpen_shootSupStr_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return ((IORD_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x912  +  u8Index * sizeof(HI_U8)))));
}

// ******************************auoto 16 multi addrs*********************************//
static __inline HI_VOID hi_ext_system_Isp_sharpen_detailctrl_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x922  +  u8Index * sizeof(HI_U8)), data);
}
static __inline HI_U8 hi_ext_system_Isp_sharpen_detailctrl_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return ((IORD_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x922  +  u8Index * sizeof(HI_U8)))));
}

// ******************************auoto 16 multi addrs*********************************//
static __inline HI_VOID hi_ext_system_Isp_sharpen_RGain_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x932  +  u8Index * sizeof(HI_U8)), data & HI_ISP_SHARPEN_RGAIN_BIT);
}
static __inline HI_U8 hi_ext_system_Isp_sharpen_RGain_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return ((IORD_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x932  +  u8Index * sizeof(HI_U8))))&HI_ISP_SHARPEN_RGAIN_BIT);
}

// ******************************auoto 16 multi addrs*********************************//
static __inline HI_VOID hi_ext_system_Isp_sharpen_BGain_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x942  +  u8Index * sizeof(HI_U8)), data & HI_ISP_SHARPEN_BGAIN_BIT);
}
static __inline HI_U8 hi_ext_system_Isp_sharpen_BGain_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return ((IORD_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x942  +  u8Index * sizeof(HI_U8))))&HI_ISP_SHARPEN_BGAIN_BIT);
}

// ******************************auoto 16 multi addrs*********************************//
static __inline HI_VOID hi_ext_system_Isp_sharpen_SkinGain_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x952  +  u8Index * sizeof(HI_U8)), data & 0x1f);
}
static __inline HI_U8 hi_ext_system_Isp_sharpen_SkinGain_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return ((IORD_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x952  +  u8Index * sizeof(HI_U8)))) & 0x1f);
}

// ******************************auoto 16 multi addrs*********************************//
static __inline HI_VOID hi_ext_system_Isp_sharpen_EdgeFiltStr_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x962  +  u8Index * sizeof(HI_U8)), data & 0x3f);
}
static __inline HI_U8 hi_ext_system_Isp_sharpen_EdgeFiltStr_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return ((IORD_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x962  +  u8Index * sizeof(HI_U8)))) & 0x3f);
}

// ******************************auoto 32 x 16 multi addrs*********************************//
static __inline HI_VOID hi_ext_system_Isp_sharpen_LumaWgt_write(VI_PIPE ViPipe, HI_U16 u16Index, HI_U8 data)
{
    IOWR_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x972  +  u16Index * sizeof(HI_U8)), data & HI_ISP_SHARPEN_LUMAWGT_BIT);
}
static __inline HI_U16 hi_ext_system_Isp_sharpen_LumaWgt_read(VI_PIPE ViPipe,  HI_U16 u16Index)
{
    return ((IORD_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0x972  +  u16Index * sizeof(HI_U8)))) & HI_ISP_SHARPEN_LUMAWGT_BIT);
}

// new add manual
#define     HI_EXT_SYSTEM_MANUAL_ISP_SHARPEN_DETAILCTRLTHR_DEFAULT     (160)

static __inline HI_VOID hi_ext_system_manual_Isp_sharpen_detailctrlThr_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB80, data);
}
static __inline HI_U8 hi_ext_system_manual_Isp_sharpen_detailctrlThr_read(VI_PIPE ViPipe)
{
    return (IORD_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB80));
}

#define     HI_EXT_SYSTEM_MANUAL_ISP_SHARPEN_SHOOTSUPADJ_DEFAULT     (9)

static __inline HI_VOID hi_ext_system_manual_Isp_sharpen_ShootSupAdj_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB81, data & 0x0f);
}
static __inline HI_U8 hi_ext_system_manual_Isp_sharpen_ShootSupAdj_read(VI_PIPE ViPipe)
{
    return (IORD_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB81) & 0x0f);
}

#define     HI_EXT_SYSTEM_MANUAL_ISP_SHARPEN_MAXSHARPGAIN_DEFAULT     (160)

static __inline HI_VOID hi_ext_system_manual_Isp_sharpen_MaxSharpGain_write(VI_PIPE ViPipe, HI_U16 data)
{
    IOWR_16DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB82, data & 0x7FF);
}
static __inline HI_U16 hi_ext_system_manual_Isp_sharpen_MaxSharpGain_read(VI_PIPE ViPipe)
{
    return (IORD_16DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB82) & 0x7FF);
}

#define     HI_EXT_SYSTEM_MANUAL_ISP_SHARPEN_SKINUMIN_DEFAULT     (100)

static __inline HI_VOID hi_ext_system_manual_Isp_sharpen_SkinUmin_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB86, data);
}
static __inline HI_U8 hi_ext_system_manual_Isp_sharpen_SkinUmin_read(VI_PIPE ViPipe)
{
    return (IORD_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB86));
}

#define     HI_EXT_SYSTEM_MANUAL_ISP_SHARPEN_SKINVMIN_DEFAULT     (135)

static __inline HI_VOID hi_ext_system_manual_Isp_sharpen_SkinVmin_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB87, data);
}
static __inline HI_U8 hi_ext_system_manual_Isp_sharpen_SkinVmin_read(VI_PIPE ViPipe)
{
    return (IORD_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB87));
}

#define     HI_EXT_SYSTEM_MANUAL_ISP_SHARPEN_SKINUMAX_DEFAULT     (127)

static __inline HI_VOID hi_ext_system_manual_Isp_sharpen_SkinUmax_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB88, data);
}
static __inline HI_U8 hi_ext_system_manual_Isp_sharpen_SkinUmax_read(VI_PIPE ViPipe)
{
    return (IORD_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB88));
}

#define     HI_EXT_SYSTEM_MANUAL_ISP_SHARPEN_SKINVMAX_DEFAULT     (160)

static __inline HI_VOID hi_ext_system_manual_Isp_sharpen_SkinVmax_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB89, data);
}
static __inline HI_U8 hi_ext_system_manual_Isp_sharpen_SkinVmax_read(VI_PIPE ViPipe)
{
    return (IORD_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB89));
}
// GGain: data (8-bit)
#define     HI_EXT_SYSTEM_MANUAL_ISP_SHARPEN_GGAIN_DEFAULT      (HI_ISP_SHARPEN_GGAIN)

static __inline HI_VOID hi_ext_system_manual_Isp_sharpen_GGain_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB8A, data & HI_ISP_SHARPEN_GGAIN_BIT);
}
static __inline HI_U8 hi_ext_system_manual_Isp_sharpen_GGain_read(VI_PIPE ViPipe)
{
    return (IORD_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB8A)&HI_ISP_SHARPEN_GGAIN_BIT);
}
#define     HI_EXT_SYSTEM_MANUAL_ISP_SHARPEN_WEAKDETAILGAIN_DEFAULT     (0)
static __inline HI_VOID hi_ext_system_manual_Isp_sharpen_WeakDetailGain_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB8b, data & 0x7F);
}
static __inline HI_U8 hi_ext_system_manual_Isp_sharpen_WeakDetailGain_read(VI_PIPE ViPipe)
{
    return ((IORD_8DIRECT(VREG_SHARPEN_BASE(ViPipe)  +  0xB8b)) & 0x7F);
}
// new add auto
static __inline HI_VOID hi_ext_system_Isp_sharpen_detailctrlThr_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0xB8C  +  u8Index * sizeof(HI_U8)), data);
}
static __inline HI_U8 hi_ext_system_Isp_sharpen_detailctrlThr_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return ((IORD_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0xB8C  +  u8Index * sizeof(HI_U8)))));
}

static __inline HI_VOID hi_ext_system_Isp_sharpen_MaxSharpGain_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U16 data)
{
    IOWR_16DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0xBaC  +  u8Index * sizeof(HI_U16)), data & 0x7ff);
}
static __inline HI_U16 hi_ext_system_Isp_sharpen_MaxSharpGain_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return ((IORD_16DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0xBaC  +  u8Index * sizeof(HI_U16)))) & 0x7ff);
}

static __inline HI_VOID hi_ext_system_Isp_sharpen_ShootSupAdj_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0xBCC  +  u8Index * sizeof(HI_U8)), data & 0x0f);
}
static __inline HI_U8 hi_ext_system_Isp_sharpen_ShootSupAdj_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return ((IORD_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0xBCC  +  u8Index * sizeof(HI_U8)))) & 0x0f);
}

static __inline HI_VOID hi_ext_system_Isp_sharpen_WeakDetailGain_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0xBDC  +  u8Index * sizeof(HI_U8)), data & 0x7f);
}
static __inline HI_U8 hi_ext_system_Isp_sharpen_WeakDetailGain_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return ((IORD_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0xBDC  +  u8Index * sizeof(HI_U8)))) & 0x7f);
}
static __inline HI_VOID hi_ext_system_Isp_sharpen_GGain_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0xBEC  +  u8Index * sizeof(HI_U8)), data & HI_ISP_SHARPEN_GGAIN_BIT);
}
static __inline HI_U8 hi_ext_system_Isp_sharpen_GGain_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return ((IORD_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0xBEC  +  u8Index * sizeof(HI_U8))))&HI_ISP_SHARPEN_GGAIN_BIT);
}

//******************************auoto 16 multi addrs*********************************//
static __inline HI_VOID hi_ext_system_Isp_sharpen_EdgeFiltMaxCap_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0xBFC  +  u8Index * sizeof(HI_U8)), data & HI_ISP_SHARPEN_EdgeFiltMaxCap_BIT);
}
static __inline HI_U8 hi_ext_system_Isp_sharpen_EdgeFiltMaxCap_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return ((IORD_8DIRECT((VREG_SHARPEN_BASE(ViPipe)  +  0xBFC  +  u8Index * sizeof(HI_U8)))) & HI_ISP_SHARPEN_EdgeFiltMaxCap_BIT);
}
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_csc_attr_update_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT((VREG_CSC_BASE(ViPipe) + 0x58), data);
}

static __inline HI_U8 hi_ext_system_csc_attr_update_read(VI_PIPE ViPipe)
{
...
static __inline HI_VOID hi_ext_system_ldci_TprDecrCoef_write(VI_PIPE ViPipe, HI_U16 data)
{
    IOWR_16DIRECT(VREG_LDCI_BASE(ViPipe) + 0x92, data & 0x1ff);
}
static __inline HI_U16 hi_ext_system_ldci_TprDecrCoef_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_AWB_GAIN_ENABLE_DATASIZE (8)
...
// args: data (16-bit)
static __inline HI_VOID hi_ext_system_awb_sta_enable_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT((VREG_AWB_BASE(ViPipe) + 0x2a), (data & 0x1));
}

static __inline HI_U8 hi_ext_system_awb_sta_enable_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_AWB_CROP_EN_DATASIZE (8)

// args: data (8-bit)
static __inline HI_VOID hi_ext_system_awb_crop_en_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT((VREG_AWB_BASE(ViPipe) + 0x2c), data);
}
static __inline HI_U8 hi_ext_system_awb_crop_en_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_AWB_CROP_X_DATASIZE (16)

// args: data (16-bit)
static __inline HI_VOID hi_ext_system_awb_crop_x_write(VI_PIPE ViPipe, HI_U16 data)
{
    IOWR_16DIRECT((VREG_AWB_BASE(ViPipe) + 0x2e), data);
}
static __inline HI_U16 hi_ext_system_awb_crop_x_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_AWB_CROP_Y_DATASIZE (16)

// args: data (16-bit)
static __inline HI_VOID hi_ext_system_awb_crop_y_write(VI_PIPE ViPipe, HI_U16 data)
{
    IOWR_16DIRECT((VREG_AWB_BASE(ViPipe) + 0x30), data);
}
static __inline HI_U16 hi_ext_system_awb_crop_y_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_AWB_CROP_HEIGHT_DATASIZE (16)

// args: data (16-bit)
static __inline HI_VOID hi_ext_system_awb_crop_height_write(VI_PIPE ViPipe, HI_U16 data)
{
    IOWR_16DIRECT((VREG_AWB_BASE(ViPipe) + 0x32), data);
}
static __inline HI_U16 hi_ext_system_awb_crop_height_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_AWB_CROP_WIDTH_DATASIZE (16)

// args: data (16-bit)
static __inline HI_VOID hi_ext_system_awb_crop_width_write(VI_PIPE ViPipe, HI_U16 data)
{
    IOWR_16DIRECT((VREG_AWB_BASE(ViPipe) + 0x34), data);
}
static __inline HI_U16 hi_ext_system_awb_crop_width_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_DETAIL_ENABLE_DATASIZE (8)
static __inline HI_VOID hi_ext_system_detail_enable_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_DE_BASE(ViPipe), (data & 0x1));
}
static __inline HI_U8 hi_ext_system_detail_enable_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_DETAIL_MANU_MODE_DATASIZE (8)
static __inline HI_VOID hi_ext_system_detail_manual_mode_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_DE_BASE(ViPipe) + 0x1, (data & 0x1));
}
static __inline HI_U8 hi_ext_system_detail_manual_mode_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_DETAIL_LUMA_GAIN_LUT_DATASIZE (16)
static __inline HI_VOID hi_ext_system_detail_luma_gain_lut_write(VI_PIPE ViPipe, HI_U16 i, HI_U16 data)
{
    IOWR_16DIRECT(VREG_DE_BASE(ViPipe) + 0x2 + i * sizeof(HI_U16), (data & 0x1ff));   // end 36 = 2 + 17x2
}
static __inline HI_U16 hi_ext_system_detail_luma_gain_lut_read(VI_PIPE ViPipe, HI_U16 i)
{
    return ((IORD_16DIRECT(VREG_DE_BASE(ViPipe) + 0x2 + i * sizeof(HI_U16))) & 0x1ff);
}
...
#define HI_EXT_SYSTEM_DETAIL_AUTO_GLOBAL_GAIN_DATASIZE (16)
static __inline HI_VOID hi_ext_system_detail_auto_global_gain_write(VI_PIPE ViPipe, HI_U16 i, HI_U16 data)
{
    IOWR_16DIRECT(VREG_DE_BASE(ViPipe) + 0x28 + i * sizeof(HI_U16), (data & 0x1ff));     // end 40 + 16x2
}
static __inline HI_U16 hi_ext_system_detail_auto_global_gain_read(VI_PIPE ViPipe, HI_U16 i)
{
    return ((IORD_16DIRECT(VREG_DE_BASE(ViPipe) + 0x28 + i * sizeof(HI_U16))) & 0x1ff);
}
...
#define HI_EXT_SYSTEM_DETAIL_AUTO_GAIN_LF_DATASIZE (16)
static __inline HI_VOID hi_ext_system_detail_auto_gain_lf_write(VI_PIPE ViPipe, HI_U16 i, HI_U16 data)
{
    IOWR_16DIRECT(VREG_DE_BASE(ViPipe) + 0x50 + i * sizeof(HI_U16), (data & 0x1ff));    // end 80 + 16x2
}
static __inline HI_U16 hi_ext_system_detail_auto_gain_lf_read(VI_PIPE ViPipe, HI_U16 i)
{
    return ((IORD_16DIRECT(VREG_DE_BASE(ViPipe) + 0x50 + i * sizeof(HI_U16))) & 0x1ff);
}
...
#define HI_EXT_SYSTEM_DETAIL_AUTO_GAIN_HF_DATASIZE (16)
static __inline HI_VOID hi_ext_system_detail_auto_gain_hf_write(VI_PIPE ViPipe, HI_U16 i, HI_U16 data)
{
    IOWR_16DIRECT(VREG_DE_BASE(ViPipe) + 0x78 + i * sizeof(HI_U16), (data & 0x1ff));  // end 120 + 16x2
}
static __inline HI_U16 hi_ext_system_detail_auto_gain_hf_read(VI_PIPE ViPipe, HI_U16 i)
{
    return ((IORD_16DIRECT(VREG_DE_BASE(ViPipe) + 0x78 + i * sizeof(HI_U16))) & 0x1ff);
}
...
#define HI_EXT_SYSTEM_DETAIL_MANUAL_GLOBAL_GAIN_DATASIZE (16)
static __inline HI_VOID hi_ext_system_detail_manual_global_gain_write(VI_PIPE ViPipe,  HI_U16 data)
{
    IOWR_16DIRECT(VREG_DE_BASE(ViPipe) + 0xA0, (data & 0x1ff));    // 160
}
static __inline HI_U16 hi_ext_system_detail_manual_global_gain_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_DETAIL_MANUAL_GAIN_LF_DATASIZE (16)
static __inline HI_VOID hi_ext_system_detail_manual_gain_lf_write(VI_PIPE ViPipe,  HI_U16 data)
{
    IOWR_16DIRECT(VREG_DE_BASE(ViPipe) + 0xA2, (data & 0x1ff));   // 162
}
static __inline HI_U16 hi_ext_system_detail_manual_gain_lf_read(VI_PIPE ViPipe)
{
...
#define HI_EXT_SYSTEM_DETAIL_MANUAL_GAIN_HF_DATASIZE (16)
static __inline HI_VOID hi_ext_system_detail_manual_gain_hf_write(VI_PIPE ViPipe,  HI_U16 data)
{
    IOWR_16DIRECT(VREG_DE_BASE(ViPipe) + 0xA4, (data & 0x1ff));  // 164
}
static __inline HI_U16 hi_ext_system_detail_manual_gain_hf_read(VI_PIPE ViPipe)
{
...
static __inline HI_VOID hi_ext_system_detail_attr_update_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_DE_BASE(ViPipe) + 0xA6, (data & 0x1));    // 166
}
static __inline HI_U8 hi_ext_system_detail_attr_update_read(VI_PIPE ViPipe)
{
...
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_rgbir_enable_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_RGBIR_BASE(ViPipe), (data & 0x1));
}
static __inline HI_U8 hi_ext_system_rgbir_enable_read(VI_PIPE ViPipe)
{
...
static __inline HI_VOID hi_ext_system_rgbir_th_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_RGBIR_BASE(ViPipe) + 0x1, (data & 0xff));
}
static __inline HI_U8 hi_ext_system_rgbir_th_read(VI_PIPE ViPipe)
{
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_rgbir_tv_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_RGBIR_BASE(ViPipe) + 0x2, (data & 0xff));
}
static __inline HI_U8 hi_ext_system_rgbir_tv_read(VI_PIPE ViPipe)
{
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_rgbir_outpattern_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_RGBIR_BASE(ViPipe) + 0x3, (data & 0x3));
}
static __inline HI_U8 hi_ext_system_rgbir_outpattern_read(VI_PIPE ViPipe)
{
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_rgbir_inpattern_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_RGBIR_BASE(ViPipe) + 0x4, (data & 0x7));
}
static __inline HI_U8 hi_ext_system_rgbir_inpattern_read(VI_PIPE ViPipe)
{
...
// ------------------------------------------------------------------------------ //
// args: data (16-bit)
static __inline HI_VOID hi_ext_system_rgbir_expctrl_write(VI_PIPE ViPipe, HI_U16 data, HI_U16 i)
{
    IOWR_16DIRECT(VREG_RGBIR_BASE(ViPipe) + 0x6 + i * sizeof(HI_U16), (data & 0xffff));
}
static __inline HI_U16 hi_ext_system_rgbir_expctrl_read(VI_PIPE ViPipe, HI_U16 i)
{
    return ((IORD_16DIRECT(VREG_RGBIR_BASE(ViPipe) + 0x6 + i * sizeof(HI_U16))) & 0xffff);
}
...
// ------------------------------------------------------------------------------ //
// args: data (16-bit)
static __inline HI_VOID hi_ext_system_rgbir_gain_write(VI_PIPE ViPipe, HI_U16 data, HI_U16 i)
{
    IOWR_16DIRECT(VREG_RGBIR_BASE(ViPipe) + 0xa + i * sizeof(HI_U16), (data & 0xffff));
}
static __inline HI_U16 hi_ext_system_rgbir_gain_read(VI_PIPE ViPipe, HI_U16 i)
{
    return ((IORD_16DIRECT(VREG_RGBIR_BASE(ViPipe) + 0xa + i * sizeof(HI_U16))) & 0xffff);
}
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_rgbir_irstatus_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_RGBIR_BASE(ViPipe) + 0xe, (data & 0x3));
}
static __inline HI_U8 hi_ext_system_rgbir_irstatus_read(VI_PIPE ViPipe)
{
...
static __inline HI_VOID hi_ext_system_rgbir_cvtmatrix_write(VI_PIPE ViPipe, HI_U16 data, HI_U16 i)
{
    IOWR_16DIRECT(VREG_RGBIR_BASE(ViPipe) + 0x10 + i * sizeof(HI_U16), (data & 0xffff));
}
static __inline HI_U16 hi_ext_system_rgbir_cvtmatrix_read(VI_PIPE ViPipe, HI_U16 i)
{
    return ((IORD_16DIRECT(VREG_RGBIR_BASE(ViPipe) + 0x10 + i * sizeof(HI_U16))) & 0xffff);
}

static __inline HI_VOID hi_ext_system_rgbir_attr_update_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_RGBIR_BASE(ViPipe) + 0x20, (data & 0x1));
}
static __inline HI_U8 hi_ext_system_rgbir_attr_update_read(VI_PIPE ViPipe)
{
