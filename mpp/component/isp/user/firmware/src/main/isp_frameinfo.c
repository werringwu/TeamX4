...
HI_S32 ISP_FrameInfoInit(VI_PIPE ViPipe)
{
    ...
    if (pstIspCtx->stFrameInfoCtrl.pstIspFrame == HI_NULL) {
...
HI_S32 ISP_ProNrParamInit(VI_PIPE ViPipe)
{
    ...
    if (pstIspCtx->stProNrParamCtrl.pstProNrParam == HI_NULL) {
...
HI_S32 ISP_ProShpParamInit(VI_PIPE ViPipe)
{
    ...
    if (pstIspCtx->stProShpParamCtrl.pstProShpParam == HI_NULL) {
