...
HI_S32 HI_MPI_ISP_SetModuleControl(VI_PIPE ViPipe, const ISP_MODULE_CTRL_U *punModCtrl)
{
    ...
    hi_ext_system_isp_bit_bypass_write(ViPipe, u64Key);

    hi_ext_system_isp_dgain_enable_write(ViPipe, !((u64Key >> 0) & 0x1));
    hi_ext_system_antifalsecolor_enable_write(ViPipe, !((u64Key >> 1) & 0x1));
    hi_ext_system_ge_enable_write(ViPipe, !((u64Key >> 2) & 0x1));
    hi_ext_system_dpc_dynamic_cor_enable_write(ViPipe, !((u64Key >> 3) & 0x1));
    hi_ext_system_bayernr_enable_write(ViPipe, !((u64Key >> 4) & 0x1));
    hi_ext_system_dehaze_enable_write(ViPipe, !((u64Key >> 5) & 0x1));
    hi_ext_system_awb_gain_enable_write(ViPipe, !((u64Key >> 6) & 0x1));
    hi_ext_system_isp_mesh_shading_enable_write(ViPipe, !((u64Key >> 7) & 0x1));
    hi_ext_system_drc_enable_write(ViPipe, !((u64Key >> 8) & 0x1));
    hi_ext_system_demosaic_enable_write(ViPipe, !((u64Key >> 9) & 0x1));
    hi_ext_system_cc_enable_write(ViPipe, !((u64Key >> 10) & 0x1));
    hi_ext_system_gamma_en_write(ViPipe, !((u64Key >> 11) & 0x1));
    hi_ext_system_wdr_en_write(ViPipe, !((u64Key >> 12) & 0x1));
    hi_ext_system_ca_en_write(ViPipe, !((u64Key >> 13) & 0x1));
    hi_ext_system_csc_enable_write(ViPipe, !((u64Key >> 14) & 0x1));
    hi_ext_system_rc_en_write(ViPipe, !((u64Key >> 15) & 0x1));
    hi_ext_system_manual_isp_sharpen_en_write(ViPipe, !((u64Key >> 16) & 0x1));
    hi_ext_system_localCAC_enable_write(ViPipe, !((u64Key >> 17) & 0x1));
    hi_ext_system_GlobalCAC_enable_write(ViPipe, !((u64Key >> 18) & 0x1));
    hi_ext_system_top_channel_select_write(ViPipe, (u64Key >> 19) & 0x3);
    hi_ext_system_ldci_enable_write(ViPipe, !((u64Key >> 21) & 0x1));
    hi_ext_system_pregamma_en_write(ViPipe, !((u64Key >> 22) & 0x1));
    hi_ext_system_isp_radial_shading_enable_write(ViPipe, !((u64Key >> 23) & 0x1));
    hi_ext_system_ae_fe_en_write(ViPipe, !((u64Key >> 24) & 0x1));
    hi_ext_system_ae_be_en_write(ViPipe, !((u64Key >> 25) & 0x1));
    hi_ext_system_mg_en_write(ViPipe, !((u64Key >> 26) & 0x1));
    hi_ext_system_detail_enable_write(ViPipe, !((u64Key >> 27) & 0x1));
    hi_ext_system_af_enable_write(ViPipe, ~((u64Key >> 28) & 0x3));
    hi_ext_system_awb_sta_enable_write(ViPipe, !((u64Key >> 30) & 0x1));
    hi_ext_system_clut_en_write(ViPipe, !((u64Key >> 31) & 0x1));
    hi_ext_system_manual_isp_hlc_en_write(ViPipe, !((u64Key >> 32) & 0x1));
    hi_ext_system_manual_isp_edgemark_en_write(ViPipe, !((u64Key >> 33) & 0x1));
    hi_ext_system_rgbir_enable_write(ViPipe, !((u64Key >> 34) & 0x1));
    ...
    if (u32ChnSelPre != u32ChnSelCur) {
        ...
        if (s32Ret != HI_SUCCESS) {
            ISP_TRACE(HI_DBG_ERR, "Set isp[%d] chn select failed with ec %#x!\n", ViPipe, s32Ret);
            return s32Ret;
        }
...
HI_S32 HI_MPI_ISP_GetModuleControl(VI_PIPE ViPipe, ISP_MODULE_CTRL_U *punModCtrl)
{
    ...
    punModCtrl->bitBypassAEStatFE      = !(hi_ext_system_ae_fe_en_read(ViPipe));
    punModCtrl->bitBypassAEStatBE      = !(hi_ext_system_ae_be_en_read(ViPipe));
    punModCtrl->bitBypassMGStat        = !(hi_ext_system_mg_en_read(ViPipe));
    punModCtrl->bitBypassDE            = !(hi_ext_system_detail_enable_read(ViPipe));
    punModCtrl->bitBypassAFStatFE      = !(hi_ext_system_af_enable_read(ViPipe) & 0x1);
    punModCtrl->bitBypassAFStatBE      = !((hi_ext_system_af_enable_read(ViPipe) >> 1) & 0x1);
    punModCtrl->bitBypassAWBStat       = !(hi_ext_system_awb_sta_enable_read(ViPipe));
    punModCtrl->bitBypassCLUT          = !(hi_ext_system_clut_en_read(ViPipe));
    punModCtrl->bitBypassHLC           = !(hi_ext_system_manual_isp_hlc_en_read(ViPipe));
    punModCtrl->bitBypassEdgeMark      = !(hi_ext_system_manual_isp_edgemark_en_read(ViPipe));
    punModCtrl->bitBypassRGBIR         = !(hi_ext_system_rgbir_enable_read(ViPipe));
...
HI_S32 HI_MPI_ISP_SetLDCIAttr(VI_PIPE ViPipe, const ISP_LDCI_ATTR_S *pstLDCIAttr)
{
    ...
    if (pstLDCIAttr->u8GaussLPFSigma < 0x1) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8GaussLPFSigma!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    ...
    for (i = 0; i < ISP_AUTO_ISO_STRENGTH_NUM; i++) {
        if (pstLDCIAttr->stAuto.astHeWgt[i].stHePosWgt.u8Wgt > HI_ISP_LDCI_HEPOSWGT_MAX) {
            ISP_TRACE(HI_DBG_ERR, "Invalid astHeWgt.stHePosWgt.u8Wgt[%d]!\n", i);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstLDCIAttr->stAuto.astHeWgt[i].stHePosWgt.u8Sigma < 0x1) {
            ISP_TRACE(HI_DBG_ERR, "Invalid astHeWgt.stHePosWgt.u8Sigma[%d]!\n", i);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstLDCIAttr->stAuto.astHeWgt[i].stHeNegWgt.u8Wgt > HI_ISP_LDCI_HENEGWGT_MAX) {
            ISP_TRACE(HI_DBG_ERR, "Invalid astHeWgt.stHeNegWgt.u8Wgt[%d]!\n", i);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstLDCIAttr->stAuto.astHeWgt[i].stHeNegWgt.u8Sigma < 0x1) {
            ISP_TRACE(HI_DBG_ERR, "Invalid astHeWgt.stHeNegWgt.u8Sigma[%d]!\n", i);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstLDCIAttr->stAuto.au16BlcCtrl[i] > 0x1ff) {
            ISP_TRACE(HI_DBG_ERR, "Invalid au16BlcCtrl[%d]!\n", i);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
    ...
    if (pstLDCIAttr->stManual.stHeWgt.stHePosWgt.u8Wgt > HI_ISP_LDCI_HEPOSWGT_MAX) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stHeWgt.stHePosWgt.u8Wgt!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstLDCIAttr->stManual.stHeWgt.stHePosWgt.u8Sigma < 0x1) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stHeWgt.stHePosWgt.u8Sigma!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstLDCIAttr->stManual.stHeWgt.stHeNegWgt.u8Wgt > HI_ISP_LDCI_HENEGWGT_MAX) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stHeWgt.stHeNegWgt.u8Wgt!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstLDCIAttr->stManual.stHeWgt.stHeNegWgt.u8Sigma < 0x1) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stHeWgt.stHeNegWgt.u8Sigma!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstLDCIAttr->stManual.u16BlcCtrl > 0x1ff) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16BlcCtrl!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstLDCIAttr->u16TprIncrCoef > 0x100) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16TprIncrCoef!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstLDCIAttr->u16TprDecrCoef > 0x100) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16TprDecrCoef!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    hi_ext_system_ldci_TprIncrCoef_write(ViPipe, pstLDCIAttr->u16TprIncrCoef);
    hi_ext_system_ldci_TprDecrCoef_write(ViPipe, pstLDCIAttr->u16TprDecrCoef);
...
HI_S32 HI_MPI_ISP_GetLDCIAttr(VI_PIPE ViPipe, ISP_LDCI_ATTR_S *pstLDCIAttr)
{
    ...
    pstLDCIAttr->u16TprIncrCoef  = hi_ext_system_ldci_TprIncrCoef_read(ViPipe);
    pstLDCIAttr->u16TprDecrCoef  = hi_ext_system_ldci_TprDecrCoef_read(ViPipe);
...
HI_S32 HI_MPI_ISP_SetDRCAttr(VI_PIPE ViPipe, const ISP_DRC_ATTR_S *pstDRC)
{
    ...
    if (pstDRC->stAuto.u16Strength > HI_ISP_DRC_STRENGTH_MAX) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stAuto.u16Strength!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->stAuto.u16StrengthMax > HI_ISP_DRC_STRENGTH_MAX) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stAuto.u16StrengthMax!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->stAuto.u16StrengthMin > HI_ISP_DRC_STRENGTH_MAX) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stAuto.u16StrengthMin!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->stAuto.u16StrengthMax < pstDRC->stAuto.u16StrengthMin) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stAuto.u16StrengthMin and stAuto.u16StrengthMax!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->stManual.u16Strength > HI_ISP_DRC_STRENGTH_MAX) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stManual.u16Strength!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8LocalMixingDarkMax > 0x80) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8LocalMixingDarkMax!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8LocalMixingDarkMin > 0x40) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8LocalMixingDarkMin!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->s8LocalMixingDarkSlo > 7 || pstDRC->s8LocalMixingDarkSlo < -7) {
        ISP_TRACE(HI_DBG_ERR, "Invalid s8LocalMixingDarkSlo!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8LocalMixingBrightMax > 0x80) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8LocalMixingBrightMax!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8LocalMixingBrightMin > 0x40) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8LocalMixingBrightMin!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->s8LocalMixingBrightSlo > 7 || pstDRC->s8LocalMixingBrightSlo < -7) {
        ISP_TRACE(HI_DBG_ERR, "Invalid s8LocalMixingBrightSlo!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8BrightGainLmt > 0xF) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8BrightGainLmt!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8BrightGainLmtStep > 0xF) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8BrightGainLmtStep!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstDRC->u8DarkGainLmtY > 0x85) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8DarkGainLmtY!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8DarkGainLmtC > 0x85) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8DarkGainLmtC!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8PDStrength > 0x80) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8PDStrength!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8DetailDarkStr > 0x80) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8DetailDarkStr!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8DetailBrightStr > 0x80) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8DetailBrightStr!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8DetailDarkStep > 0x80) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8DetailDarkStep!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8DetailBrightStep > 0x80) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8DetailBrightStep!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8FltScaleCoarse > 0xf) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8FltScaleCoarse!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8FltScaleFine > 0xf) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8FltScaleFine!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8ContrastControl > 0xF) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8ContrastControl!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8SpatialFltCoef > HI_ISP_DRC_SPA_FLT_COEF_MAX) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8SpatialFilterCoef!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8RangeFltCoef > 0xA) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8RangeFltCoef!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8RangeAdaMax > 0x8) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8RangeAdaMax!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstDRC->u8GradRevMax > 0x40) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8GradRevMax!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->u8GradRevThr > 0x80) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8GradRevThr!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDRC->s8DetailAdjustFactor > 15 || pstDRC->s8DetailAdjustFactor < -15) {
        ISP_TRACE(HI_DBG_ERR, "Invalid s8DetailAdjustFactor!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    ...
    hi_ext_system_drc_mixing_dark_thr_write(ViPipe, pstDRC->u8LocalMixingDarkThr);
    hi_ext_system_drc_mixing_dark_slo_write(ViPipe, pstDRC->s8LocalMixingDarkSlo);
    ...
    hi_ext_system_drc_mixing_bright_thr_write(ViPipe, pstDRC->u8LocalMixingBrightThr);
    hi_ext_system_drc_mixing_bright_slo_write(ViPipe, pstDRC->s8LocalMixingBrightSlo);

    hi_ext_system_drc_gain_clip_knee_write(ViPipe, pstDRC->u8BrightGainLmt);
    hi_ext_system_drc_gain_clip_step_write(ViPipe, pstDRC->u8BrightGainLmtStep);
    hi_ext_system_drc_dark_gain_lmt_y_write(ViPipe, pstDRC->u8DarkGainLmtY);
    hi_ext_system_drc_dark_gain_lmt_c_write(ViPipe, pstDRC->u8DarkGainLmtC);
    ...
    hi_ext_system_drc_flt_rng_ada_max_write(ViPipe, pstDRC->u8RangeAdaMax);
    ...
    for (i = 0; i < HI_ISP_DRC_CC_NODE_NUM; i++) {
        if ((pstDRC->au16ColorCorrectionLut[i] > 0x400)) {
            ISP_TRACE(HI_DBG_ERR, "Invalid au16ColorCorrectionLut!\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
    ...
    for (i = 0; i < HI_ISP_DRC_CUBIC_POINT_NUM; i++) {
        if ((pstDRC->astCubicPoint[i].u16X > 0x3E8)) {
            ISP_TRACE(HI_DBG_ERR, "Invalid stCubicPoint[%d].u16X!\n", i);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
        if ((pstDRC->astCubicPoint[i].u16Y > 0x3E8)) {
            ISP_TRACE(HI_DBG_ERR, "Invalid stCubicPoint[%d].u16Y!\n", i);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
        if ((pstDRC->astCubicPoint[i].u16Slope > 0x2710)) {
            ISP_TRACE(HI_DBG_ERR, "Invalid stCubicPoint[%d].u16Slope!\n", i);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
    }
    ...
    hi_ext_system_drc_dp_detect_rng_ratio_write(ViPipe, pstDRC->u8DpDetectRangeRatio);
    hi_ext_system_drc_dp_detect_thr_slo_write(ViPipe, pstDRC->u8DpDetectThrSlo);
    hi_ext_system_drc_dp_detect_thr_min_write(ViPipe, pstDRC->u16DpDetectThrMin);
...
HI_S32 HI_MPI_ISP_GetDRCAttr(VI_PIPE ViPipe, ISP_DRC_ATTR_S *pstDRC)
{
    ...
    pstDRC->u8LocalMixingDarkThr   = hi_ext_system_drc_mixing_dark_thr_read(ViPipe);
    pstDRC->s8LocalMixingDarkSlo   = hi_ext_system_drc_mixing_dark_slo_read(ViPipe);
    ...
    pstDRC->u8LocalMixingBrightThr = hi_ext_system_drc_mixing_bright_thr_read(ViPipe);
    pstDRC->s8LocalMixingBrightSlo = hi_ext_system_drc_mixing_bright_slo_read(ViPipe);

    pstDRC->u8BrightGainLmt     = hi_ext_system_drc_gain_clip_knee_read(ViPipe);
    pstDRC->u8BrightGainLmtStep = hi_ext_system_drc_gain_clip_step_read(ViPipe);
    pstDRC->u8DarkGainLmtY      = hi_ext_system_drc_dark_gain_lmt_y_read(ViPipe);
    pstDRC->u8DarkGainLmtC      = hi_ext_system_drc_dark_gain_lmt_c_read(ViPipe);
    ...
    pstDRC->u8RangeAdaMax    = hi_ext_system_drc_flt_rng_ada_max_read(ViPipe);
    ...
    pstDRC->u8DpDetectRangeRatio = hi_ext_system_drc_dp_detect_rng_ratio_read(ViPipe);
    pstDRC->u8DpDetectThrSlo   = hi_ext_system_drc_dp_detect_thr_slo_read(ViPipe);
    pstDRC->u16DpDetectThrMin = hi_ext_system_drc_dp_detect_thr_min_read(ViPipe);
...
HI_S32 HI_MPI_ISP_SetDehazeAttr(VI_PIPE ViPipe, const ISP_DEHAZE_ATTR_S *pstDehazeAttr)
{
    ...
    if (pstDehazeAttr->enOpType >= OP_TYPE_BUTT) {
        ISP_TRACE(HI_DBG_ERR, "Invalid OpType!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDehazeAttr->u16TmprfltDecrCoef > 0x80) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16TmprfltDecrCoef\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDehazeAttr->u16TmprfltIncrCoef > 0x80) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16TmprfltIncrCoef\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    ...
    if (pstDehazeAttr->bUserLutEnable) {
        ...
        hi_ext_system_user_dehaze_lut_update_write(ViPipe, HI_TRUE);
    }
    ...
    hi_ext_system_dehaze_tfic_write(ViPipe, pstDehazeAttr->u16TmprfltIncrCoef);
    hi_ext_system_dehaze_tfdc_write(ViPipe, pstDehazeAttr->u16TmprfltDecrCoef);
...
HI_S32 HI_MPI_ISP_GetDehazeAttr(VI_PIPE ViPipe, ISP_DEHAZE_ATTR_S *pstDehazeAttr)
{
    ...
    pstDehazeAttr->u16TmprfltIncrCoef = hi_ext_system_dehaze_tfic_read(ViPipe);
    pstDehazeAttr->u16TmprfltDecrCoef = hi_ext_system_dehaze_tfdc_read(ViPipe);
...
HI_S32 HI_MPI_ISP_SetFSWDRAttr(VI_PIPE ViPipe, const ISP_WDR_FS_ATTR_S *pstFSWDRAttr)
{
    ...
    if (pstFSWDRAttr->enWDRMergeMode >= MERGE_BUTT) {
        ISP_TRACE(HI_DBG_ERR, "Invalid enWDRMergeMode !\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    ...
    if (pstFSWDRAttr->stWDRCombine.stWDRMdt.stManual.u8MdThrLowGain >
        ...
        ISP_TRACE(HI_DBG_ERR, "u8MdThrLowGain should NOT be larger than u8MdThrHigGain!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstFSWDRAttr->stWDRCombine.u16ForceLongHigThr > 0XFFF) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16ForceLongHigThr!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstFSWDRAttr->stWDRCombine.u16ForceLongLowThr > pstFSWDRAttr->stWDRCombine.u16ForceLongHigThr) {
        ISP_TRACE(HI_DBG_ERR, "u16ForceLongLowThr should NOT be larger than u16ForceLongHigThr!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstFSWDRAttr->stBnr.u8ShortFrameNRStr > 0X3F) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8Mot2SigCwgtHigh!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    ...
    if (pstFSWDRAttr->stWDRCombine.stWDRMdt.u8MdtFullThd > 254) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8MdtFullThd!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstFSWDRAttr->stWDRCombine.stWDRMdt.u8MdtStillThd > 254) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8MdtStillThd!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstFSWDRAttr->stWDRCombine.stWDRMdt.u8MdtLongBlend > 254) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8MdtLongBlend!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstFSWDRAttr->stBnr.u8FullMdtSigWgt > 31) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8FullMdtSigWgt!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstFSWDRAttr->stBnr.u8FullMdtSigGWgt > 31) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8FullMdtSigGWgt!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstFSWDRAttr->stBnr.u8FullMdtSigRBWgt > 31) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8FullMdtSigRBWgt!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstFSWDRAttr->stWDRCombine.stWDRMdt.u16ShortCheckThd > 4095) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16ShortCheckThd!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstFSWDRAttr->enWDRWbgainPosition >= WDR_WBGAIN_POSITION_BUTT) {
        ISP_TRACE(HI_DBG_ERR, "Invalid enWDRWbgainPosition %d!\n", pstFSWDRAttr->enWDRWbgainPosition);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    hi_ext_system_wdr_wbgain_position_write(ViPipe, pstFSWDRAttr->enWDRWbgainPosition);
    ...
    hi_ext_system_wdr_shortcheck_thd_write(ViPipe, pstFSWDRAttr->stWDRCombine.stWDRMdt.u16ShortCheckThd);
    hi_ext_system_wdr_mdt_full_thr_write(ViPipe, pstFSWDRAttr->stWDRCombine.stWDRMdt.u8MdtFullThd);
    hi_ext_system_wdr_mdt_still_thr_write(ViPipe, pstFSWDRAttr->stWDRCombine.stWDRMdt.u8MdtStillThd);
    hi_ext_system_wdr_mdt_long_blend_write(ViPipe, pstFSWDRAttr->stWDRCombine.stWDRMdt.u8MdtLongBlend);

    for (j = 0; j < NoiseSet_EleNum; j++) {
        hi_ext_system_wdr_floorset_write(ViPipe, j, pstFSWDRAttr->stBnr.au8NoiseFloor[j]);
    }

    hi_ext_system_wdr_mot2sig_gwgt_high_write(ViPipe, pstFSWDRAttr->stBnr.u8FullMdtSigGWgt);
    hi_ext_system_wdr_mot2sig_cwgt_high_write(ViPipe, pstFSWDRAttr->stBnr.u8FullMdtSigRBWgt);
    hi_ext_system_wdr_full_mot_sigma_weight_write(ViPipe, pstFSWDRAttr->stBnr.u8FullMdtSigWgt);
    hi_ext_system_wdr_g_sigma_gain1_write(ViPipe, pstFSWDRAttr->stBnr.au8GsigmaGain[0]);
    hi_ext_system_wdr_g_sigma_gain2_write(ViPipe, pstFSWDRAttr->stBnr.au8GsigmaGain[1]);
    hi_ext_system_wdr_g_sigma_gain3_write(ViPipe, pstFSWDRAttr->stBnr.au8GsigmaGain[2]);
    hi_ext_system_wdr_c_sigma_gain1_write(ViPipe, pstFSWDRAttr->stBnr.au8RBsigmaGain[0]);
    hi_ext_system_wdr_c_sigma_gain2_write(ViPipe, pstFSWDRAttr->stBnr.au8RBsigmaGain[1]);
    hi_ext_system_wdr_c_sigma_gain3_write(ViPipe, pstFSWDRAttr->stBnr.au8RBsigmaGain[2]);
...
HI_S32 HI_MPI_ISP_GetFSWDRAttr(VI_PIPE ViPipe, ISP_WDR_FS_ATTR_S *pstFSWDRAttr)
{
    ...
    /*************************WDR DGAIN CONIFG ***************************/
    u8Tmp = hi_ext_system_wdr_wbgain_position_read(ViPipe);
    if (u8Tmp == HI_EXT_SYSTEM_WDR_WBGAIN_IN_DG1) {
        pstFSWDRAttr->enWDRWbgainPosition = WDR_WBGAIN_IN_DG1;
    } else if (u8Tmp == HI_EXT_SYSTEM_WDR_WBGAIN_IN_WB) {
    ...
    pstFSWDRAttr->stWDRCombine.stWDRMdt.u16ShortCheckThd = hi_ext_system_wdr_shortcheck_thd_read(ViPipe);
    pstFSWDRAttr->stWDRCombine.stWDRMdt.u8MdtFullThd     = hi_ext_system_wdr_mdt_full_thr_read(ViPipe);
    pstFSWDRAttr->stWDRCombine.stWDRMdt.u8MdtStillThd    = hi_ext_system_wdr_mdt_still_thr_read(ViPipe);
    pstFSWDRAttr->stWDRCombine.stWDRMdt.u8MdtLongBlend   = hi_ext_system_wdr_mdt_long_blend_read(ViPipe);

    for (j = 0; j < NoiseSet_EleNum; j++) {
        pstFSWDRAttr->stBnr.au8NoiseFloor[j] = hi_ext_system_wdr_floorset_read(ViPipe, j);
    }

    pstFSWDRAttr->stBnr.u8FullMdtSigGWgt  = hi_ext_system_wdr_mot2sig_gwgt_high_read(ViPipe);
    pstFSWDRAttr->stBnr.u8FullMdtSigRBWgt = hi_ext_system_wdr_mot2sig_cwgt_high_read(ViPipe);
    pstFSWDRAttr->stBnr.u8FullMdtSigWgt   = hi_ext_system_wdr_full_mot_sigma_weight_read(ViPipe);
    pstFSWDRAttr->stBnr.au8GsigmaGain[0]  = hi_ext_system_wdr_g_sigma_gain1_read(ViPipe);
    pstFSWDRAttr->stBnr.au8GsigmaGain[1]  = hi_ext_system_wdr_g_sigma_gain2_read(ViPipe);
    pstFSWDRAttr->stBnr.au8GsigmaGain[2]  = hi_ext_system_wdr_g_sigma_gain3_read(ViPipe);
    pstFSWDRAttr->stBnr.au8RBsigmaGain[0] = hi_ext_system_wdr_c_sigma_gain1_read(ViPipe);
    pstFSWDRAttr->stBnr.au8RBsigmaGain[1] = hi_ext_system_wdr_c_sigma_gain2_read(ViPipe);
    pstFSWDRAttr->stBnr.au8RBsigmaGain[2] = hi_ext_system_wdr_c_sigma_gain3_read(ViPipe);
...
HI_S32 HI_MPI_ISP_GetFocusStatistics(VI_PIPE ViPipe, ISP_AF_STATISTICS_S *pstAfStat)
{
    ...
    u8Col = MIN2(hi_ext_af_window_hnum_read(ViPipe), AF_ZONE_COLUMN);
    u8Row = MIN2(hi_ext_af_window_vnum_read(ViPipe), AF_ZONE_ROW);
    ...
    if (stActStatInfo.pVirtAddr == HI_NULL) {
...
HI_S32 HI_MPI_ISP_GetAEStatistics(VI_PIPE ViPipe, ISP_AE_STATISTICS_S *pstAeStat)
{
    ...
    if (stIspStatInfo.pVirtAddr == HI_NULL) {
        return HI_ERR_ISP_NULL_PTR;
    }
    ...
    if (s32Ret != HI_SUCCESS) {
        ISP_TRACE(HI_DBG_ERR, "ISP[%d] get WDR attr failed\n", ViPipe);
        HI_MPI_SYS_Munmap(stIspStatInfo.pVirtAddr, sizeof(ISP_STAT_S));
        return s32Ret;
    }
...
HI_S32 HI_MPI_ISP_SetStatisticsConfig(VI_PIPE ViPipe, const ISP_STATISTICS_CFG_S *pstStatCfg)
{
    ...
    if (ioctl(g_as32IspFd[ViPipe], ISP_WORK_MODE_GET, &stIspWorkMode) != HI_SUCCESS) {
        ISP_TRACE(HI_DBG_ERR, "Get Work Mode error!\n");
        return HI_FAILURE;
    }

    u16Width  = hi_ext_system_be_total_width_read(ViPipe);
    u16Height = hi_ext_system_be_total_height_read(ViPipe);

    if (stIspWorkMode.enIspDataInputMode == ISP_MODE_RAW) {
        // AWB
        if (pstStatCfg->stWBCfg.enAWBSwitch >= ISP_AWB_SWITCH_BUTT) {
            ISP_TRACE(HI_DBG_ERR, "Invalid WB enAWBSwitch %d !\n", pstStatCfg->stWBCfg.enAWBSwitch);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstStatCfg->stWBCfg.u16CrMax > 0xFFF) {
            ISP_TRACE(HI_DBG_ERR, "Max value WB u16CrMax is 0xFFF!\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstStatCfg->stWBCfg.u16CbMax > 0xFFF) {
            ISP_TRACE(HI_DBG_ERR, "Max value of WB u16CbMax is 0xFFF!\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstStatCfg->stWBCfg.u16BlackLevel > pstStatCfg->stWBCfg.u16WhiteLevel) {
            ISP_TRACE(HI_DBG_ERR, "WB BlackLevel should not larger than WhiteLevel!\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if ((pstStatCfg->stWBCfg.u16CrMin) > (pstStatCfg->stWBCfg.u16CrMax)) {
            ISP_TRACE(HI_DBG_ERR, "WB CrMin should not larger than CrMax!\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstStatCfg->stWBCfg.u16CbMin > pstStatCfg->stWBCfg.u16CbMax) {
            ISP_TRACE(HI_DBG_ERR, "WB CbMin should not larger than CbMax!\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
        ...
        if ((pstStatCfg->stWBCfg.u16ZoneRow < 1) || (pstStatCfg->stWBCfg.u16ZoneRow > u8MaxAwbRow)) {
            ISP_TRACE(HI_DBG_ERR, "Invalid u16ZoneRow! Value range:[1, %d]!\n", u8MaxAwbRow);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if ((pstStatCfg->stWBCfg.u16ZoneCol < stIspWorkMode.u8BlockNum) || (pstStatCfg->stWBCfg.u16ZoneCol > u8MaxAwbCol)) {
            ISP_TRACE(HI_DBG_ERR, "Invalid u16ZoneCol! Value range:[%d, %d]!\n", stIspWorkMode.u8BlockNum, u8MaxAwbCol);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstStatCfg->stWBCfg.u16ZoneBin == 0x0) {
            ISP_TRACE(HI_DBG_ERR, "The value of WB u16ZoneBin should be larger than 0x0!\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstStatCfg->stWBCfg.u16ZoneBin > AWB_ZONE_BIN) {
            ISP_TRACE(HI_DBG_ERR, "Max value of WB u16ZoneBin is %d!\n", AWB_ZONE_BIN);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        for (i = 1; i < 4; i++) {
            if (pstStatCfg->stWBCfg.au16HistBinThresh[i] < pstStatCfg->stWBCfg.au16HistBinThresh[i - 1]) {
                ISP_TRACE(HI_DBG_ERR, "Max value of WB au16HistBinThresh[%d] should not be smaller than au16HistBinThresh[%d]!\n",
                          i, i - 1);
                return HI_ERR_ISP_ILLEGAL_PARAM;
            }
        }
        ...
        if (pstStatCfg->stWBCfg.stCrop.u16W < pstStatCfg->stWBCfg.u16ZoneCol * AWB_MIN_WIDTH) {
            ISP_TRACE(HI_DBG_ERR, "u16W should NOT be less than %d(u16ZoneCol * 60)!\n",
        ...
        hi_ext_system_awb_crop_en_write(ViPipe, pstStatCfg->stWBCfg.stCrop.bEnable);
        hi_ext_system_awb_crop_x_write(ViPipe, pstStatCfg->stWBCfg.stCrop.u16X);
        hi_ext_system_awb_crop_y_write(ViPipe, pstStatCfg->stWBCfg.stCrop.u16Y);
        hi_ext_system_awb_crop_height_write(ViPipe, pstStatCfg->stWBCfg.stCrop.u16H);
        hi_ext_system_awb_crop_width_write(ViPipe, pstStatCfg->stWBCfg.stCrop.u16W);

        hi_ext_system_wb_statistics_mpi_update_en_write(ViPipe, HI_TRUE);

        // AE
        if (pstStatCfg->stAECfg.enAESwitch >= ISP_AE_SWITCH_BUTT) {
            ISP_TRACE(HI_DBG_ERR, "Invalid AE Switch %d!\n", pstStatCfg->stAECfg.enAESwitch);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstStatCfg->stAECfg.stHistConfig.enHistSkipX >= ISP_AE_HIST_SKIP_BUTT) {
            ISP_TRACE(HI_DBG_ERR, "u8HistSkipX should not be larger than 6\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstStatCfg->stAECfg.stHistConfig.enHistSkipY >= ISP_AE_HIST_SKIP_BUTT) {
            ISP_TRACE(HI_DBG_ERR, "u8HistSkipY should not be larger than 6\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstStatCfg->stAECfg.stHistConfig.enHistOffsetX >= ISP_AE_HIST_OFFSET_X_BUTT) {
            ISP_TRACE(HI_DBG_ERR, "u8HistOffsetX should not be larger than 1\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstStatCfg->stAECfg.stHistConfig.enHistOffsetY >= ISP_AE_HIST_OFFSET_Y_BUTT) {
            ISP_TRACE(HI_DBG_ERR, "u8HistOffsetY should not larger than 1\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstStatCfg->stAECfg.enFourPlaneMode >= ISP_AE_FOUR_PLANE_MODE_BUTT) {
            ISP_TRACE(HI_DBG_ERR, "enFourPlaneMode should not be larger than 1\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
        ...
        if ((pstStatCfg->stAECfg.enFourPlaneMode == ISP_AE_FOUR_PLANE_MODE_DISABLE) &&
            ...
            ISP_TRACE(HI_DBG_ERR, "u8HistSkipX should not be 0 when not in FourPlaneMode\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstStatCfg->stAECfg.enHistMode >= ISP_AE_MODE_BUTT) {
            ISP_TRACE(HI_DBG_ERR, "enHistMode should not be larger than 1\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstStatCfg->stAECfg.enAverMode >= ISP_AE_MODE_BUTT) {
            ISP_TRACE(HI_DBG_ERR, "enAverMode should not be larger than 1\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstStatCfg->stAECfg.enMaxGainMode >= ISP_AE_MODE_BUTT) {
            ISP_TRACE(HI_DBG_ERR, "enMaxGainMode should not be larger than 1\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
        ...
        for (i = 0; i < AE_ZONE_ROW; i++) {
            for (j = 0; j < AE_ZONE_COLUMN; j++) {
                if (pstStatCfg->stAECfg.au8Weight[i][j] > 0xF) {
                    ISP_TRACE(HI_DBG_ERR, "au8Weight[%d][%d] should not be larger than 0xF!\n", i, j);
                    return HI_ERR_ISP_ILLEGAL_PARAM;
                }
            }
        }
        ...
        if (pstStatCfg->stAECfg.enAESwitch == ISP_AE_AFTER_DG) {
            ...
            ISP_TRACE(HI_DBG_ERR, "ViPipe:%d Not Support this!\n", ViPipe);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
        ...
        if (pstStatCfg->stAECfg.stCrop.u16W < AE_MIN_WIDTH) {
            ISP_TRACE(HI_DBG_ERR, "u16CropWidth should be lager than 256!\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstStatCfg->stAECfg.stCrop.u16H < AE_MIN_HEIGHT) {
            ISP_TRACE(HI_DBG_ERR, "u16CropHeight should be lager than 120!\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if ((pstStatCfg->stAECfg.stCrop.u16X + pstStatCfg->stAECfg.stCrop.u16W) > u16Width) {
            ISP_TRACE(HI_DBG_ERR, "u16X + u16W should not be lager than %d!\n", u16Width);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if ((pstStatCfg->stAECfg.stCrop.u16Y + pstStatCfg->stAECfg.stCrop.u16H) > u16Height) {
            ISP_TRACE(HI_DBG_ERR, "u16Y + u16H should not be lager than %d!\n", u16Height);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
        ...
        hi_ext_system_ae_crop_en_write(ViPipe, pstStatCfg->stAECfg.stCrop.bEnable);
        hi_ext_system_ae_crop_x_write(ViPipe, pstStatCfg->stAECfg.stCrop.u16X);
        hi_ext_system_ae_crop_y_write(ViPipe, pstStatCfg->stAECfg.stCrop.u16Y);
        hi_ext_system_ae_crop_height_write(ViPipe, pstStatCfg->stAECfg.stCrop.u16H);
        hi_ext_system_ae_crop_width_write(ViPipe, pstStatCfg->stAECfg.stCrop.u16W);
    ...
    if (pstStatCfg->stFocusCfg.stConfig.u16Hwnd < stIspWorkMode.u8BlockNum) {
        ISP_TRACE(HI_DBG_ERR, "The value of AF u16Hwnd should be >= u8BlockNum:%d!\n", stIspWorkMode.u8BlockNum);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    ...
    if (pstStatCfg->stFocusCfg.stConfig.stCrop.u16W < 256) {
        ISP_TRACE(HI_DBG_ERR, "u16W should be larger than 256!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstStatCfg->stFocusCfg.stConfig.stCrop.u16H < 120) {
        ISP_TRACE(HI_DBG_ERR, "u16H should be larger than 256!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    ...
    MPI_ISP_ARRAY_MAX_PARAM_CHECK_RETURN(pstStatCfg->stFocusCfg.stHParam_IIR0.abIIREn,     HI_BOOL, 3,    0x1,    "Invalid AF stHParam_IIR0.abIIREn!\n");
    ...
    MPI_ISP_ARRAY_PARAM_CHECK_RETURN(&pstStatCfg->stFocusCfg.stHParam_IIR0.as16IIRGain[1],  HI_S16, 6, -511, 511, "Invalid AF stHParam_IIR0.as16IIRGain!\n");
    MPI_ISP_ARRAY_MAX_PARAM_CHECK_RETURN(pstStatCfg->stFocusCfg.stHParam_IIR0.au16IIRShift, HI_U16, 4,  0x7,      "Invalid AF stHParam_IIR0.au16IIRShift!\n");
    ...
    MPI_ISP_ARRAY_MAX_PARAM_CHECK_RETURN(pstStatCfg->stFocusCfg.stHParam_IIR1.abIIREn,     HI_BOOL, 3,  0x1,      "Invalid AF stHParam_IIR1.abIIREn!\n");
    ...
    MPI_ISP_ARRAY_PARAM_CHECK_RETURN(&pstStatCfg->stFocusCfg.stHParam_IIR1.as16IIRGain[1],  HI_S16, 6, -511, 511, "Invalid AF stHParam_IIR1.as16IIRGain!\n");
    MPI_ISP_ARRAY_MAX_PARAM_CHECK_RETURN(pstStatCfg->stFocusCfg.stHParam_IIR1.au16IIRShift, HI_U16, 4,  0x7,      "Invalid AF stHParam_IIR1.au16IIRShift!\n");
    ...
    /* FIR0 */
    MPI_ISP_ARRAY_PARAM_CHECK_RETURN(pstStatCfg->stFocusCfg.stVParam_FIR0.as16FIRH,      HI_S16, 5, -31,  31,   "Invalid AF stVParam_FIR0.as16FIRH!\n");
    ...
    /* FIR1 */
    MPI_ISP_ARRAY_PARAM_CHECK_RETURN(pstStatCfg->stFocusCfg.stVParam_FIR1.as16FIRH,     HI_S16, 5, -31,  31,  "Invalid AF stVParam_FIR1.as16FIRH!\n");
    ...
    MPI_ISP_ARRAY_MAX_PARAM_CHECK_RETURN(pstStatCfg->stFocusCfg.stFVParam.au16AccShiftH, HI_U16,       2,   0xF, "Invalid AF stFVParam.au16AccShiftH!\n");
    MPI_ISP_ARRAY_MAX_PARAM_CHECK_RETURN(pstStatCfg->stFocusCfg.stFVParam.au16AccShiftV, HI_U16,       2,   0xF, "Invalid AF stFVParam.au16AccShiftH!\n");
    ...
    if (pstStatCfg->stFocusCfg.stConfig.bEnable) {
        hi_ext_system_af_enable_write(ViPipe, 0x3);
    } else {
        hi_ext_system_af_enable_write(ViPipe, 0x0);
    }
...
HI_S32 HI_MPI_ISP_GetStatisticsConfig(VI_PIPE ViPipe, ISP_STATISTICS_CFG_S *pstStatCfg)
{
    ...
    pstStatCfg->stWBCfg.stCrop.bEnable = hi_ext_system_awb_crop_en_read(ViPipe);
    pstStatCfg->stWBCfg.stCrop.u16X = hi_ext_system_awb_crop_x_read(ViPipe);
    pstStatCfg->stWBCfg.stCrop.u16Y = hi_ext_system_awb_crop_y_read(ViPipe);
    pstStatCfg->stWBCfg.stCrop.u16H = hi_ext_system_awb_crop_height_read(ViPipe);
    pstStatCfg->stWBCfg.stCrop.u16W = hi_ext_system_awb_crop_width_read(ViPipe);
    ...
    pstStatCfg->stAECfg.stCrop.bEnable = hi_ext_system_ae_crop_en_read(ViPipe);
    pstStatCfg->stAECfg.stCrop.u16X = hi_ext_system_ae_crop_x_read(ViPipe);
    pstStatCfg->stAECfg.stCrop.u16Y = hi_ext_system_ae_crop_y_read(ViPipe);
    pstStatCfg->stAECfg.stCrop.u16H = hi_ext_system_ae_crop_height_read(ViPipe);
    pstStatCfg->stAECfg.stCrop.u16W = hi_ext_system_ae_crop_width_read(ViPipe);
    ...
    pstStatCfg->stFocusCfg.stConfig.bEnable = (hi_ext_system_af_enable_read(ViPipe) != 0x0) ? 1 : 0;
    ...
    pstStatCfg->stFocusCfg.stHParam_IIR0.as16IIRGain[0] = hi_ext_af_iir_gain0_group0_read(ViPipe);
    pstStatCfg->stFocusCfg.stHParam_IIR1.as16IIRGain[0] = hi_ext_af_iir_gain0_group1_read(ViPipe);
    pstStatCfg->stFocusCfg.stHParam_IIR0.as16IIRGain[1] = hi_ext_af_iir_gain1_group0_read(ViPipe);
    pstStatCfg->stFocusCfg.stHParam_IIR1.as16IIRGain[1] = hi_ext_af_iir_gain1_group1_read(ViPipe);
    pstStatCfg->stFocusCfg.stHParam_IIR0.as16IIRGain[2] = hi_ext_af_iir_gain2_group0_read(ViPipe);
    pstStatCfg->stFocusCfg.stHParam_IIR1.as16IIRGain[2] = hi_ext_af_iir_gain2_group1_read(ViPipe);
    pstStatCfg->stFocusCfg.stHParam_IIR0.as16IIRGain[3] = hi_ext_af_iir_gain3_group0_read(ViPipe);
    pstStatCfg->stFocusCfg.stHParam_IIR1.as16IIRGain[3] = hi_ext_af_iir_gain3_group1_read(ViPipe);
    pstStatCfg->stFocusCfg.stHParam_IIR0.as16IIRGain[4] = hi_ext_af_iir_gain4_group0_read(ViPipe);
    pstStatCfg->stFocusCfg.stHParam_IIR1.as16IIRGain[4] = hi_ext_af_iir_gain4_group1_read(ViPipe);
    pstStatCfg->stFocusCfg.stHParam_IIR0.as16IIRGain[5] = hi_ext_af_iir_gain5_group0_read(ViPipe);
    pstStatCfg->stFocusCfg.stHParam_IIR1.as16IIRGain[5] = hi_ext_af_iir_gain5_group1_read(ViPipe);
    pstStatCfg->stFocusCfg.stHParam_IIR0.as16IIRGain[6] = hi_ext_af_iir_gain6_group0_read(ViPipe);
    pstStatCfg->stFocusCfg.stHParam_IIR1.as16IIRGain[6] = hi_ext_af_iir_gain6_group1_read(ViPipe);
    ...
    pstStatCfg->stFocusCfg.stVParam_FIR0.as16FIRH[0] = hi_ext_af_fir_h_gain0_group0_read(ViPipe);
    pstStatCfg->stFocusCfg.stVParam_FIR1.as16FIRH[0] = hi_ext_af_fir_h_gain0_group1_read(ViPipe);
    pstStatCfg->stFocusCfg.stVParam_FIR0.as16FIRH[1] = hi_ext_af_fir_h_gain1_group0_read(ViPipe);
    pstStatCfg->stFocusCfg.stVParam_FIR1.as16FIRH[1] = hi_ext_af_fir_h_gain1_group1_read(ViPipe);
    pstStatCfg->stFocusCfg.stVParam_FIR0.as16FIRH[2] = hi_ext_af_fir_h_gain2_group0_read(ViPipe);
    pstStatCfg->stFocusCfg.stVParam_FIR1.as16FIRH[2] = hi_ext_af_fir_h_gain2_group1_read(ViPipe);
    pstStatCfg->stFocusCfg.stVParam_FIR0.as16FIRH[3] = hi_ext_af_fir_h_gain3_group0_read(ViPipe);
    pstStatCfg->stFocusCfg.stVParam_FIR1.as16FIRH[3] = hi_ext_af_fir_h_gain3_group1_read(ViPipe);
    pstStatCfg->stFocusCfg.stVParam_FIR0.as16FIRH[4] = hi_ext_af_fir_h_gain4_group0_read(ViPipe);
    pstStatCfg->stFocusCfg.stVParam_FIR1.as16FIRH[4] = hi_ext_af_fir_h_gain4_group1_read(ViPipe);
...
HI_S32 HI_MPI_ISP_SetGammaAttr(VI_PIPE ViPipe, const ISP_GAMMA_ATTR_S *pstGammaAttr)
{
    ...
    // HDR mode is only supported in Hi3559AV100
    ...
    switch (pstGammaAttr->enCurveType) {
        ...
        case ISP_GAMMA_CURVE_HDR:
            ISP_TRACE(HI_DBG_WARN, "ISP_GAMMA_CURVE_HDR is only used for Hi3559AV100!\n");
        ...
        case ISP_GAMMA_CURVE_USER_DEFINE:
            ...
            break;
        default:
            ISP_TRACE(HI_DBG_ERR, "Invalid  Gamma Curve Type %d!\n", pstGammaAttr->enCurveType);
            return HI_ERR_ISP_ILLEGAL_PARAM;
    }
...
HI_S32 HI_MPI_ISP_SetPreGammaAttr(VI_PIPE ViPipe, const ISP_PREGAMMA_ATTR_S *pstPreGammaAttr)
{
    ...
    for (i = 0; i < PREGAMMA_NODE_NUM; i++) {
        if (pstPreGammaAttr->au32Table[i] > HI_ISP_PREGAMMA_LUT_MAX) {
            ISP_TRACE(HI_DBG_ERR, "Invalid Table[%d] %d!\n", i, pstPreGammaAttr->au32Table[i]);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
...
HI_S32 HI_MPI_ISP_SetCSCAttr(VI_PIPE ViPipe, const ISP_CSC_ATTR_S *pstCSCAttr)
{
    ...
    if ((pstCSCAttr->u8Luma > 100) || (pstCSCAttr->u8Contr > 100) ||
        ...
        ISP_TRACE(HI_DBG_ERR, "Invalid csc parameter!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstCSCAttr->enColorGamut >= COLOR_GAMUT_BUTT) {
        ISP_TRACE(HI_DBG_ERR, "Invalid color gamut!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstCSCAttr->enColorGamut == COLOR_GAMUT_BT2020) {
        ISP_TRACE(HI_DBG_WARN, "BT.2020 gamut is only used in Hi3559AV100!\n");
    }
...
HI_S32 HI_MPI_ISP_SetDPCalibrate(VI_PIPE ViPipe, const ISP_DP_STATIC_CALIBRATE_S *pstDPCalibrate)
{
    ...
    if (((stIspWorkMode.enIspRunningMode == ISP_MODE_RUNNING_OFFLINE) ||
        ...
        (pstDPCalibrate->bEnableDetect == HI_TRUE) &&
    ...
    if (pstDPCalibrate->u16CountMax > u16StaticCountMax) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16CountMax!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstDPCalibrate->u16CountMin > pstDPCalibrate->u16CountMax) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16CountMin!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstDPCalibrate->u16TimeLimit > 0x640) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16TimeLimit!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDPCalibrate->enStaticDPType >= ISP_STATIC_DP_BUTT) {
        ISP_TRACE(HI_DBG_ERR, "Invalid enStaticDPType!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDPCalibrate->u8StartThresh == 0) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8StartThresh!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
...
HI_S32 HI_MPI_ISP_SetDPStaticAttr(VI_PIPE ViPipe, const ISP_DP_STATIC_ATTR_S *pstDPStaticAttr)
{
    ...
    if (pstDPStaticAttr->u16BrightCount > u16StaticCountMax) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16BrightCount!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstDPStaticAttr->u16DarkCount > u16StaticCountMax) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16DarkCount!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    for (i = 0; i < u16StaticCountMax; i++) {
        if (pstDPStaticAttr->au32BrightTable[i] > 0x1FFF1FFF || pstDPStaticAttr->au32DarkTable[i] > 0x1FFF1FFF) {
            ISP_TRACE(HI_DBG_ERR, "u32DarkTable and au32BrightTable should be less than 0x1FFF1FFF!\n");
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
    }

    pu32DefectPixelTable = (HI_U32 *)ISP_MALLOC(sizeof(HI_U32) * u16StaticCountMax);

    if (pu32DefectPixelTable == HI_NULL) {
        ISP_TRACE(HI_DBG_ERR, "Malloc defectPixelTable Memory failure!\n");
        return HI_ERR_ISP_NOMEM;
    }
    ...
    while ((i < pstDPStaticAttr->u16BrightCount) && (j < pstDPStaticAttr->u16DarkCount)) {
        if (m >= u16StaticCountMax) {
            ISP_TRACE(HI_DBG_ERR, "The size of merging DP table(BrightTable and DarkTable) is larger than %d!\n",
                      u16StaticCountMax);
...
HI_S32 HI_MPI_ISP_SetDPDynamicAttr(VI_PIPE ViPipe, const ISP_DP_DYNAMIC_ATTR_S *pstDPDynamicAttr)
{
    ...
    if (pstDPDynamicAttr->stManual.u16Strength > 255) {
        ISP_TRACE(HI_DBG_ERR, "Invalid Strength!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstDPDynamicAttr->stManual.u16BlendRatio > 0x80) {
        ISP_TRACE(HI_DBG_ERR, "Invalid BlendRatio!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstDPDynamicAttr->s8SoftThr > 0x80 || pstDPDynamicAttr->s8SoftThr < 0x0) {
        ISP_TRACE(HI_DBG_ERR, "Invalid s8SoftThr!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
...
HI_S32 HI_MPI_ISP_SetMeshShadingAttr(VI_PIPE ViPipe, const ISP_SHADING_ATTR_S *pstShadingAttr)
{
    ...
    if (pstShadingAttr->u16MeshStr > HI_ISP_LSC_MESHSTR_MAX) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16MeshStr!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    hi_ext_system_isp_mesh_shading_mesh_strength_write(ViPipe, pstShadingAttr->u16MeshStr);

    if (pstShadingAttr->u16BlendRatio > 256) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16BlendRatio!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
...
HI_S32 HI_MPI_ISP_SetMeshShadingGainLutAttr(VI_PIPE ViPipe, const ISP_SHADING_LUT_ATTR_S *pstShadingLutAttr)
{
    ...
    for (i = 0; i < HI_ISP_RLSC_POINTS; i++) {
        hi_ext_system_isp_bnr_shading_r_gain_write(ViPipe, i, pstShadingLutAttr->stBNRLscGainLut.au16RGain[i]);
        hi_ext_system_isp_bnr_shading_gr_gain_write(ViPipe, i, pstShadingLutAttr->stBNRLscGainLut.au16GrGain[i]);
        hi_ext_system_isp_bnr_shading_gb_gain_write(ViPipe, i, pstShadingLutAttr->stBNRLscGainLut.au16GbGain[i]);
        hi_ext_system_isp_bnr_shading_b_gain_write(ViPipe, i, pstShadingLutAttr->stBNRLscGainLut.au16BGain[i]);
    }
    u32Width  = hi_ext_system_be_total_width_read(ViPipe);
    u32Height = hi_ext_system_be_total_height_read(ViPipe);
    ...
    if ((u32XSum != (u32Width / 4)) || (u32YSum != (u32Height / 4))) {
        ISP_TRACE(HI_DBG_ERR, "Invalid block size u32XSum = %d, u32YSum = %d!\n", u32XSum, u32YSum);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    for (i = 0; i < (HI_ISP_LSC_GRID_COL - 1) / 2; i++) {
        if ((pstShadingLutAttr->au16XGridWidth[i] > HI_ISP_LSC_XGRID_WIDTH_MAX(u32Width)) ||
            (pstShadingLutAttr->au16XGridWidth[i] < 4)) {
            ISP_TRACE(HI_DBG_ERR, "Invalid au32XGridWidth[%d]!\n", i);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
    ...
    for (i = 0; i < (HI_ISP_LSC_GRID_ROW - 1) / 2; i++) {
        if ((pstShadingLutAttr->au16YGridWidth[i] > HI_ISP_LSC_YGRID_WIDTH_MAX(u32Height)) ||
            (pstShadingLutAttr->au16YGridWidth[i] < 4)) {
            ISP_TRACE(HI_DBG_ERR, "Invalid au32YGridWidth[%d]!\n", i);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
...
HI_S32 HI_MPI_ISP_GetMeshShadingGainLutAttr(VI_PIPE ViPipe, ISP_SHADING_LUT_ATTR_S *pstShadingLutAttr)
{
    ...
    for (i = 0; i < HI_ISP_RLSC_POINTS; i++) {
        pstShadingLutAttr->stBNRLscGainLut.au16RGain[i]  = hi_ext_system_isp_bnr_shading_r_gain_read(ViPipe, i);
        pstShadingLutAttr->stBNRLscGainLut.au16GrGain[i] = hi_ext_system_isp_bnr_shading_gr_gain_read(ViPipe, i);
        pstShadingLutAttr->stBNRLscGainLut.au16GbGain[i] = hi_ext_system_isp_bnr_shading_gb_gain_read(ViPipe, i);
        pstShadingLutAttr->stBNRLscGainLut.au16BGain[i]  = hi_ext_system_isp_bnr_shading_b_gain_read(ViPipe, i);
    }
                                         ...
                                         ISP_MESH_SHADING_TABLE_S *pstMLSCTable)
{
    ...
    if (pstMLSCCaliCfg->u16DstImgWidth % 4 != 0) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16DstImgWidth:%d, Width must be a muliple of 4!\n", pstMLSCCaliCfg->u16DstImgWidth);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstMLSCCaliCfg->u16DstImgHeight % 4 != 0) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16DstImgHeight:%d, Height must be a muliple of 4!\n", pstMLSCCaliCfg->u16DstImgHeight);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if ((pstMLSCCaliCfg->u16OffsetX % 2 != 0) || (pstMLSCCaliCfg->u16OffsetY % 2) != 0) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16OffsetX:%d/u16OffsetY:%d, Bayer Pattern of the cropped image does not match to the input image!\n",
    ...
    if (pstMLSCCaliCfg->u16DstImgWidth + pstMLSCCaliCfg->u16OffsetX > pstMLSCCaliCfg->u16ImgWidth) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16DstImgWidth:%d/u16OffsetX:%d, u16DstImgWidth + u16OffsetX > u16ImgWidth!\n",
...
HI_S32 HI_MPI_ISP_SetLocalCacAttr(VI_PIPE ViPipe, const ISP_LOCAL_CAC_ATTR_S *pstLocalCacAttr)
{
    ...
    if (pstLocalCacAttr->u16VarThr > 4095) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16VarThr!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstLocalCacAttr->u16PurpleDetRange > 410) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8PurpleDetRange!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    for (i = 0; i < ISP_EXP_RATIO_STRENGTH_NUM; i++) {
        if (pstLocalCacAttr->stAuto.au8DePurpleCrStr[i] > 8) {
            ISP_TRACE(HI_DBG_ERR, "Invalid au8DePurpleCrStr[%d]!\n", i);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
        if (pstLocalCacAttr->stAuto.au8DePurpleCbStr[i] > 8) {
            ISP_TRACE(HI_DBG_ERR, "Invalid au8DePurpleCbStr[%d]!\n", i);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
    ...
    if (pstLocalCacAttr->stManual.u8DePurpleCrStr > 8) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8DePurpleCrStr!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
...
HI_S32 HI_MPI_ISP_SetNRAttr(VI_PIPE ViPipe, const ISP_NR_ATTR_S *pstNRAttr)
{
    ...
    if (pstNRAttr->u8BnrLscMaxGain > 0xbf) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8BnrLscMaxGain %d!\n", pstNRAttr->u8BnrLscMaxGain);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    hi_ext_system_bayernr_lsc_max_gain_write(ViPipe, pstNRAttr->u8BnrLscMaxGain);

    if (pstNRAttr->u16BnrLscCmpStrength > 0x100) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16BnrLscCmpStrength %d!\n", pstNRAttr->u16BnrLscCmpStrength);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    hi_ext_system_bayernr_lsc_cmp_strength_write(ViPipe, pstNRAttr->u16BnrLscCmpStrength);
    ...
    for (j = 0; j < ISP_BAYER_CHN_NUM; j++) {
        ...
        hi_ext_system_bayernr_manual_chroma_strength_write(ViPipe, j, pstNRAttr->stManual.au8ChromaStr[j]);
        hi_ext_system_bayernr_manual_coarse_strength_write(ViPipe, j, pstNRAttr->stManual.au16CoarseStr[j]);
    }

    if (pstNRAttr->stManual.u8FineStr > 128) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8FineStr %d!\n", pstNRAttr->stManual.u8FineStr);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstNRAttr->stManual.u16CoringWgt > 3200) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16CoringWgt %d!\n", pstNRAttr->stManual.u16CoringWgt);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    ...
    for (i = 0; i < WDR_MAX_FRAME_NUM; i++) {
        if (pstNRAttr->stWdr.au8WDRFrameStr[i] > 80) {
            ISP_TRACE(HI_DBG_ERR, "Invalid au8WDRFrameStr[%d] %d!\n", i, pstNRAttr->stWdr.au8WDRFrameStr[i]);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
    ...
    for (i = 0; i < WDR_MAX_FRAME_NUM; i++) {
        if (pstNRAttr->stWdr.au8FusionFrameStr[i] > 80) {
            ISP_TRACE(HI_DBG_ERR, "Invalid au8FusionFrameStr[%d] %d!\n", i, pstNRAttr->stWdr.au8FusionFrameStr[i]);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
        hi_ext_system_bayernr_fusion_frame_strength_write(ViPipe, i, pstNRAttr->stWdr.au8FusionFrameStr[i]);
    }
...
HI_S32 HI_MPI_ISP_GetNRAttr(VI_PIPE ViPipe, ISP_NR_ATTR_S *pstNRAttr)
{
    ...
    pstNRAttr->u8BnrLscMaxGain      = hi_ext_system_bayernr_lsc_max_gain_read(ViPipe);
    pstNRAttr->u16BnrLscCmpStrength = hi_ext_system_bayernr_lsc_cmp_strength_read(ViPipe);
    ...
    for (i = 0; i < ISP_BAYER_CHN_NUM; i++) {
        pstNRAttr->stManual.au8ChromaStr[i]  = hi_ext_system_bayernr_manual_chroma_strength_read(ViPipe, i);
        pstNRAttr->stManual.au16CoarseStr[i] = hi_ext_system_bayernr_manual_coarse_strength_read(ViPipe, i);
    }
    ...
    for (i = 0; i < WDR_MAX_FRAME_NUM; i++) {
        ...
        pstNRAttr->stWdr.au8FusionFrameStr[i]  =  hi_ext_system_bayernr_fusion_frame_strength_read(ViPipe, i);
    }
    return HI_SUCCESS;
}
...
HI_S32 HI_MPI_ISP_SetDEAttr(VI_PIPE ViPipe, const ISP_DE_ATTR_S *pstDEAttr)
{
    ...
    if (pstDEAttr->enOpType >= OP_TYPE_BUTT) {
        ISP_TRACE(HI_DBG_ERR, "Invalid DE type %d!\n", pstDEAttr->enOpType);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    hi_ext_system_detail_manual_mode_write(ViPipe, pstDEAttr->enOpType);

    hi_ext_system_detail_enable_write(ViPipe, pstDEAttr->bEnable);
    ...
    for (i = 0; i < HI_ISP_DE_LUMA_GAIN_LUT_N; i++) {
        ...
        hi_ext_system_detail_luma_gain_lut_write(ViPipe, i, pstDEAttr->au16LumaGainLut[i]);
    }
    ...
    for (i = 0; i < ISP_AUTO_ISO_STRENGTH_NUM; i++) {
        ...
        hi_ext_system_detail_auto_global_gain_write(ViPipe, i, pstDEAttr->stAuto.au16GlobalGain[i]);

        if (pstDEAttr->stAuto.au16GainLF[i] > 0x20) {
            ISP_TRACE(HI_DBG_ERR, "Invalid au16GainLF[%d] Input!\n", i);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        hi_ext_system_detail_auto_gain_lf_write(ViPipe, i, pstDEAttr->stAuto.au16GainLF[i]);

        if (pstDEAttr->stAuto.au16GainHF[i] > 0x20) {
            ISP_TRACE(HI_DBG_ERR, "Invalid au16GainHF[%d] Input!\n", i);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        hi_ext_system_detail_auto_gain_hf_write(ViPipe, i, pstDEAttr->stAuto.au16GainHF[i]);
    }
    ...
    hi_ext_system_detail_manual_global_gain_write(ViPipe, pstDEAttr->stManual.u16GlobalGain);
    ...
    hi_ext_system_detail_manual_gain_lf_write(ViPipe, pstDEAttr->stManual.u16GainLF);
    ...
    hi_ext_system_detail_manual_gain_hf_write(ViPipe, pstDEAttr->stManual.u16GainHF);

    hi_ext_system_detail_attr_update_write(ViPipe, HI_TRUE);
...
HI_S32 HI_MPI_ISP_GetDEAttr(VI_PIPE ViPipe, ISP_DE_ATTR_S *pstDEAttr)
{
    ...
    pstDEAttr->bEnable  = hi_ext_system_detail_enable_read(ViPipe);
    pstDEAttr->enOpType = hi_ext_system_detail_manual_mode_read(ViPipe);

    for (i = 0; i < HI_ISP_DE_LUMA_GAIN_LUT_N; i++) {
        pstDEAttr->au16LumaGainLut[i] = hi_ext_system_detail_luma_gain_lut_read(ViPipe, i);
    }

    for (i = 0; i < ISP_AUTO_ISO_STRENGTH_NUM; i++) {
        pstDEAttr->stAuto.au16GlobalGain[i] = hi_ext_system_detail_auto_global_gain_read(ViPipe, i);
        pstDEAttr->stAuto.au16GainLF[i]     = hi_ext_system_detail_auto_gain_lf_read(ViPipe, i);
        pstDEAttr->stAuto.au16GainHF[i]     = hi_ext_system_detail_auto_gain_hf_read(ViPipe, i);
    }

    pstDEAttr->stManual.u16GlobalGain = hi_ext_system_detail_manual_global_gain_read(ViPipe);
    pstDEAttr->stManual.u16GainLF     = hi_ext_system_detail_manual_gain_lf_read(ViPipe);
    pstDEAttr->stManual.u16GainHF     = hi_ext_system_detail_manual_gain_hf_read(ViPipe);
...
HI_S32 HI_MPI_ISP_SetColorToneAttr(VI_PIPE ViPipe, const ISP_COLOR_TONE_ATTR_S *pstCTAttr)
{
    ...
    if ((pstCTAttr->u16RedCastGain < 0x100) || (pstCTAttr->u16RedCastGain > 0x180)) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16RedCastGain! Should in range of [0x100, 0x180]\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if ((pstCTAttr->u16GreenCastGain < 0x100) || (pstCTAttr->u16GreenCastGain > 0x180)) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16GreenCastGain! Should in range of [0x100, 0x180]\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if ((pstCTAttr->u16BlueCastGain < 0x100) || (pstCTAttr->u16BlueCastGain > 0x180)) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16BlueCastGain! Should in range of [0x100, 0x180]\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
...
HI_S32 HI_MPI_ISP_SetIspSharpenAttr(VI_PIPE ViPipe, const ISP_SHARPEN_ATTR_S *pstIspShpAttr)
{
    ...
    hi_ext_system_manual_Isp_sharpen_SkinUmax_write(ViPipe, pstIspShpAttr->u8SkinUmax);
    hi_ext_system_manual_Isp_sharpen_SkinVmax_write(ViPipe, pstIspShpAttr->u8SkinVmax);
    hi_ext_system_manual_Isp_sharpen_SkinUmin_write(ViPipe, pstIspShpAttr->u8SkinUmin);
    hi_ext_system_manual_Isp_sharpen_SkinVmin_write(ViPipe, pstIspShpAttr->u8SkinVmin);

    for (i = 0; i < ISP_AUTO_ISO_STRENGTH_NUM; i++) {
        for (j = 0; j < ISP_SHARPEN_GAIN_NUM; j++) {
            if (pstIspShpAttr->stAuto.au16TextureStr[j][i] > 4095) {
                ISP_TRACE(HI_DBG_ERR, "Invalid stAuto.au16TextureStr:%d! Value range:[0, 4095]\n",
                          pstIspShpAttr->stAuto.au16TextureStr[j][i]);
                return HI_ERR_ISP_ILLEGAL_PARAM;
            }
            if (pstIspShpAttr->stAuto.au16EdgeStr[j][i] > 4095) {
                ISP_TRACE(HI_DBG_ERR, "Invalid stAuto.au16EdgeStr:%d! Value range:[0, 4095]\n",
                          pstIspShpAttr->stAuto.au16EdgeStr[j][i]);
                return HI_ERR_ISP_ILLEGAL_PARAM;
            }
        }
        for (j = 0; j < ISP_SHARPEN_LUMA_NUM; j++) {
            if (pstIspShpAttr->stAuto.au8LumaWgt[j][i] > HI_ISP_SHARPEN_LUMAWGT_MAX) {
                ISP_TRACE(HI_DBG_ERR, "Invalid stAuto.au8LumaWgt:%d! Value range:[0, %d]\n", pstIspShpAttr->stAuto.au8LumaWgt[j][i],
        ...
        if (pstIspShpAttr->stAuto.au8EdgeFiltMaxCap[i] > HI_ISP_SHARPEN_EdgeFiltMaxCap_MAX) {
            ISP_TRACE(HI_DBG_ERR, "Invalid stAuto.au8EdgeFiltMaxCap:%d! Value range:[0, %d]\n", pstIspShpAttr->stAuto.au8EdgeFiltMaxCap[i],
                      HI_ISP_SHARPEN_EdgeFiltMaxCap_MAX);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstIspShpAttr->stAuto.au8RGain[i] > HI_ISP_SHARPEN_RGAIN_MAX) {
            ISP_TRACE(HI_DBG_ERR, "Invalid stAuto.au8RGain:%d! Value range:[0, %d]\n", pstIspShpAttr->stAuto.au8RGain[i],
                      HI_ISP_SHARPEN_RGAIN_MAX);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstIspShpAttr->stAuto.au8GGain[i] > HI_ISP_SHARPEN_GGAIN_MAX) {
            ISP_TRACE(HI_DBG_ERR, "Invalid stAuto.au8GGain:%d! Value range:[0, %d]\n", pstIspShpAttr->stAuto.au8GGain[i],
                      HI_ISP_SHARPEN_GGAIN_MAX);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        if (pstIspShpAttr->stAuto.au8BGain[i] > HI_ISP_SHARPEN_BGAIN_MAX) {
        ...
        if (pstIspShpAttr->stAuto.au8WeakDetailGain[i] > 0x7F) {
            ISP_TRACE(HI_DBG_ERR, "Invalid stAuto.au8WeakDetailGain:%d! Value range:[0, 0x7F]\n",
        ...
        hi_ext_system_Isp_sharpen_EdgeFiltMaxCap_write(ViPipe, i, pstIspShpAttr->stAuto.au8EdgeFiltMaxCap[i]);
        hi_ext_system_Isp_sharpen_RGain_write(ViPipe, i, pstIspShpAttr->stAuto.au8RGain[i]);
        hi_ext_system_Isp_sharpen_GGain_write(ViPipe, i, pstIspShpAttr->stAuto.au8GGain[i]);
        ...
        hi_ext_system_Isp_sharpen_ShootSupAdj_write(ViPipe, i, pstIspShpAttr->stAuto.au8ShootSupAdj[i]);
        hi_ext_system_Isp_sharpen_detailctrlThr_write(ViPipe, i, pstIspShpAttr->stAuto.au8DetailCtrlThr[i]);
        hi_ext_system_Isp_sharpen_MaxSharpGain_write(ViPipe, i, pstIspShpAttr->stAuto.au16MaxSharpGain[i]);
        hi_ext_system_Isp_sharpen_WeakDetailGain_write(ViPipe, i, pstIspShpAttr->stAuto.au8WeakDetailGain[i]);
    }
    for (j = 0; j < ISP_SHARPEN_GAIN_NUM; j++) {
    ...
    for (j = 0; j < ISP_SHARPEN_LUMA_NUM; j++) {
        if (pstIspShpAttr->stManual.au8LumaWgt[j] > HI_ISP_SHARPEN_LUMAWGT_MAX) {
            ISP_TRACE(HI_DBG_ERR, "Invalid stManual.au8LumaWgt:%d! Value range:[0, %d]\n", pstIspShpAttr->stManual.au8LumaWgt[j],
                      HI_ISP_SHARPEN_LUMAWGT_MAX);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
    }
    if (pstIspShpAttr->stManual.u16TextureFreq > 4095) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stManual.u16TextureFreq:%d! Value range:[0, 4095]\n",
                  pstIspShpAttr->stManual.u16TextureFreq);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstIspShpAttr->stManual.u16EdgeFreq > 4095) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stManual.u16EdgeFreq:%d! Value range:[0, 4095]\n", pstIspShpAttr->stManual.u16EdgeFreq);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstIspShpAttr->stManual.u8OverShoot > 127) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stManual.u8OverShoot:%d! Value range:[0, 127]\n", pstIspShpAttr->stManual.u8OverShoot);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstIspShpAttr->stManual.u8UnderShoot > 127) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stManual.u8UnderShoot:%d! Value range:[0, 127]\n", pstIspShpAttr->stManual.u8UnderShoot);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstIspShpAttr->stManual.u8EdgeFiltStr > 63) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stManual.u8EdgeFiltStr:%d! Value range:[0, 63]\n",
                  pstIspShpAttr->stManual.u8EdgeFiltStr);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstIspShpAttr->stManual.u8EdgeFiltMaxCap > HI_ISP_SHARPEN_EdgeFiltMaxCap_MAX) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stManual.u8EdgeFiltMaxCap:%d! Value range:[0, %d]\n", pstIspShpAttr->stManual.u8EdgeFiltMaxCap,
                  HI_ISP_SHARPEN_EdgeFiltMaxCap_MAX);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstIspShpAttr->stManual.u8RGain > HI_ISP_SHARPEN_RGAIN_MAX) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stManual.u8RGain:%d! Value range:[0, %d]\n", pstIspShpAttr->stManual.u8RGain,
                  HI_ISP_SHARPEN_RGAIN_MAX);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstIspShpAttr->stManual.u8GGain > HI_ISP_SHARPEN_GGAIN_MAX) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stManual.u8GGain:%d! Value range:[0, %d]\n", pstIspShpAttr->stManual.u8GGain,
                  HI_ISP_SHARPEN_GGAIN_MAX);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstIspShpAttr->stManual.u8BGain > HI_ISP_SHARPEN_BGAIN_MAX) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stManual.u8BGain:%d! Value range:[0, %d]\n", pstIspShpAttr->stManual.u8BGain,
                  HI_ISP_SHARPEN_BGAIN_MAX);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstIspShpAttr->stManual.u8SkinGain > 31) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stManual.u8SkinGain:%d! Value range:[0, 31]\n", pstIspShpAttr->stManual.u8SkinGain);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstIspShpAttr->stManual.u8ShootSupAdj > 15) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stManual.u8ShootSupAdj:%d! Value range:[0, 15]\n",
                  pstIspShpAttr->stManual.u8ShootSupAdj);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstIspShpAttr->stManual.u16MaxSharpGain > 0x7FF) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stManual.u16MaxSharpGain:%d! Value range:[0, 0x7FF]\n",
                  pstIspShpAttr->stManual.u16MaxSharpGain);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstIspShpAttr->stManual.u8WeakDetailGain > 0x7F) {
        ISP_TRACE(HI_DBG_ERR, "Invalid stManual.u8WeakDetailGain:%d! Value range:[0, 0x7F]\n",
    ...
    hi_ext_system_manual_Isp_sharpen_EdgeFiltMaxCap_write(ViPipe, pstIspShpAttr->stManual.u8EdgeFiltMaxCap);
    hi_ext_system_manual_Isp_sharpen_RGain_write(ViPipe, pstIspShpAttr->stManual.u8RGain);
    hi_ext_system_manual_Isp_sharpen_GGain_write(ViPipe, pstIspShpAttr->stManual.u8GGain);
    ...
    hi_ext_system_manual_Isp_sharpen_ShootSupAdj_write(ViPipe, pstIspShpAttr->stManual.u8ShootSupAdj);
    hi_ext_system_manual_Isp_sharpen_MaxSharpGain_write(ViPipe, pstIspShpAttr->stManual.u16MaxSharpGain);
    hi_ext_system_manual_Isp_sharpen_detailctrlThr_write(ViPipe, pstIspShpAttr->stManual.u8DetailCtrlThr);
    hi_ext_system_manual_Isp_sharpen_WeakDetailGain_write(ViPipe, pstIspShpAttr->stManual.u8WeakDetailGain);
...
HI_S32 HI_MPI_ISP_GetIspSharpenAttr(VI_PIPE ViPipe, ISP_SHARPEN_ATTR_S *pstIspShpAttr)
{
    ...
    pstIspShpAttr->u8SkinUmax = hi_ext_system_manual_Isp_sharpen_SkinUmax_read(ViPipe);
    pstIspShpAttr->u8SkinVmax = hi_ext_system_manual_Isp_sharpen_SkinVmax_read(ViPipe);
    pstIspShpAttr->u8SkinUmin = hi_ext_system_manual_Isp_sharpen_SkinUmin_read(ViPipe);
    pstIspShpAttr->u8SkinVmin = hi_ext_system_manual_Isp_sharpen_SkinVmin_read(ViPipe);
    ...
    for (i = 0; i < ISP_AUTO_ISO_STRENGTH_NUM; i++) {
        ...
        pstIspShpAttr->stAuto.au8EdgeFiltMaxCap[i] = hi_ext_system_Isp_sharpen_EdgeFiltMaxCap_read(ViPipe, i);
        pstIspShpAttr->stAuto.au8RGain[i]         = hi_ext_system_Isp_sharpen_RGain_read(ViPipe, i);
        pstIspShpAttr->stAuto.au8GGain[i]         = hi_ext_system_Isp_sharpen_GGain_read(ViPipe, i);
        ...
        pstIspShpAttr->stAuto.au8ShootSupAdj[i]   = hi_ext_system_Isp_sharpen_ShootSupAdj_read(ViPipe, i);
        pstIspShpAttr->stAuto.au16MaxSharpGain[i] = hi_ext_system_Isp_sharpen_MaxSharpGain_read(ViPipe, i);
        pstIspShpAttr->stAuto.au8DetailCtrlThr[i] = hi_ext_system_Isp_sharpen_detailctrlThr_read(ViPipe, i);
        pstIspShpAttr->stAuto.au8WeakDetailGain[i] = hi_ext_system_Isp_sharpen_WeakDetailGain_read(ViPipe, i);
    }
    ...
    pstIspShpAttr->stManual.u8EdgeFiltMaxCap = hi_ext_system_manual_Isp_sharpen_EdgeFiltMaxCap_read(ViPipe);
    pstIspShpAttr->stManual.u8RGain        = hi_ext_system_manual_Isp_sharpen_RGain_read(ViPipe);
    pstIspShpAttr->stManual.u8GGain        = hi_ext_system_manual_Isp_sharpen_GGain_read(ViPipe);
    ...
    pstIspShpAttr->stManual.u8ShootSupAdj   = hi_ext_system_manual_Isp_sharpen_ShootSupAdj_read(ViPipe);
    pstIspShpAttr->stManual.u16MaxSharpGain = hi_ext_system_manual_Isp_sharpen_MaxSharpGain_read(ViPipe);
    pstIspShpAttr->stManual.u8DetailCtrlThr = hi_ext_system_manual_Isp_sharpen_detailctrlThr_read(ViPipe);
    pstIspShpAttr->stManual.u8WeakDetailGain = hi_ext_system_manual_Isp_sharpen_WeakDetailGain_read(ViPipe);
...
HI_S32 HI_MPI_ISP_SetIspEdgeMarkAttr(VI_PIPE ViPipe, const ISP_EDGEMARK_ATTR_S *pstIspEdgeMarkAttr)
{
    ...
    if (pstIspEdgeMarkAttr->u32Color > 0xFFFFFF) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u32Color:%d! Value range:[0, 0xFFFFFF]\n", pstIspEdgeMarkAttr->u32Color);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
...
HI_S32 HI_MPI_ISP_SetCrosstalkAttr(VI_PIPE ViPipe, const ISP_CR_ATTR_S *pstCRAttr)
{
    ...
    if (pstCRAttr->u8Slope > HI_ISP_CR_SLOPE_MAX) {
        ISP_TRACE(HI_DBG_ERR, "Invalid slope %d!\n", pstCRAttr->u8Slope);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstCRAttr->u8SensiSlope > HI_ISP_CR_SLOPE_MAX) {
        ISP_TRACE(HI_DBG_ERR, "Invalid Sensitivity %d!\n", pstCRAttr->u8SensiSlope);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    if (pstCRAttr->u16SensiThr > HI_ISP_CR_THR_MAX) {
        ISP_TRACE(HI_DBG_ERR, "Invalid SensiThreshold %d!\n", pstCRAttr->u16SensiThr);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    ...
    for (i = 0; i < ISP_AUTO_ISO_STRENGTH_NUM; i++) {
        if (pstCRAttr->au16Strength[i] > 0x100) {
            ISP_TRACE(HI_DBG_ERR, "Invalid Strength %d!\n", pstCRAttr->au16Strength[i]);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
    ...
    for (i = 0; i < ISP_AUTO_ISO_STRENGTH_NUM; i++) {
        if (pstCRAttr->au16NpOffset[i] > HI_ISP_CR_NPOFFSET_MAX || pstCRAttr->au16NpOffset[i] < HI_ISP_CR_NPOFFSET_MIN) {
            ISP_TRACE(HI_DBG_ERR, "Invalid NpOffset %d!\n", pstCRAttr->au16NpOffset[i]);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
    ...
    for (i = 0; i < ISP_AUTO_ISO_STRENGTH_NUM; i++) {
        if (pstCRAttr->au16Threshold[i] > HI_ISP_CR_THR_MAX) {
            ISP_TRACE(HI_DBG_ERR, "Invalid Threshold %d!\n", pstCRAttr->au16Threshold[i]);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
...
HI_S32 HI_MPI_ISP_SetAntiFalseColorAttr(VI_PIPE ViPipe, const ISP_ANTIFALSECOLOR_ATTR_S *pstAntiFalseColor)
{
    ...
    if (pstAntiFalseColor->enOpType >= OP_TYPE_BUTT) {
        ISP_TRACE(HI_DBG_ERR, "Invalid enOpType %d!\n", pstAntiFalseColor->enOpType);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
...
HI_S32 HI_MPI_ISP_SetDemosaicAttr(VI_PIPE ViPipe, const ISP_DEMOSAIC_ATTR_S *pstDemosaicAttr)
{
    ...
    for (i = 0; i < ISP_AUTO_ISO_STRENGTH_NUM; i++) {
        if (pstDemosaicAttr->stAuto.au8NonDirMFDetailEhcStr[i] > HI_ISP_DEMOSAIC_NONDIR_MFDETALEHC_STR_MAX) {
        ...
        if ((pstDemosaicAttr->stAuto.au8DetailSmoothRange[i] > HI_ISP_DEMOSAIC_DETAIL_SMOOTH_RANGE_MAX) ||
            (pstDemosaicAttr->stAuto.au8DetailSmoothRange[i] < HI_ISP_DEMOSAIC_DETAIL_SMOOTH_RANGE_MIN)) {
        ...
        if (pstDemosaicAttr->stAuto.au16DetailSmoothStr[i] > 0x100) {
            ISP_TRACE(HI_DBG_ERR, "Invalid au16DetailSmoothStr %d!\n", pstDemosaicAttr->stAuto.au16DetailSmoothStr[i]);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }

        hi_ext_system_demosaic_auto_nondirection_strength_write(ViPipe, i, pstDemosaicAttr->stAuto.au8NonDirStr[i]);
        hi_ext_system_demosaic_auto_nondirection_midfreq_detailenhance_strength_write(ViPipe, i, pstDemosaicAttr->stAuto.au8NonDirMFDetailEhcStr[i]);
        hi_ext_system_demosaic_auto_nondirection_higfreq_detailenhance_strength_write(ViPipe, i, pstDemosaicAttr->stAuto.au8NonDirHFDetailEhcStr[i]);
    ...
    if (pstDemosaicAttr->stManual.u8NonDirMFDetailEhcStr > HI_ISP_DEMOSAIC_NONDIR_MFDETALEHC_STR_MAX) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8NonDirMFDetailEhcStr %d!\n", pstDemosaicAttr->stManual.u8NonDirMFDetailEhcStr);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstDemosaicAttr->stManual.u8NonDirHFDetailEhcStr > 0x10) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8NonDirHFDetailEhcStr %d!\n", pstDemosaicAttr->stManual.u8NonDirHFDetailEhcStr);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if ((pstDemosaicAttr->stManual.u8DetailSmoothRange > HI_ISP_DEMOSAIC_DETAIL_SMOOTH_RANGE_MAX) ||
        (pstDemosaicAttr->stManual.u8DetailSmoothRange < HI_ISP_DEMOSAIC_DETAIL_SMOOTH_RANGE_MIN)) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u8DetailSmoothRange %d!\n", pstDemosaicAttr->stManual.u8DetailSmoothRange);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstDemosaicAttr->stManual.u16DetailSmoothStr > 0x100) {
        ISP_TRACE(HI_DBG_ERR, "Invalid u16DetailSmoothStr %d!\n", pstDemosaicAttr->stManual.u16DetailSmoothStr);
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }

    hi_ext_system_demosaic_manual_nondirection_strength_write(ViPipe, pstDemosaicAttr->stManual.u8NonDirStr);
    hi_ext_system_demosaic_manual_nondirection_midfreq_detailenhance_strength_write(ViPipe, pstDemosaicAttr->stManual.u8NonDirMFDetailEhcStr);
    hi_ext_system_demosaic_manual_nondirection_higfreq_detailenhance_strength_write(ViPipe, pstDemosaicAttr->stManual.u8NonDirHFDetailEhcStr);
...
HI_S32 HI_MPI_ISP_GetDemosaicAttr(VI_PIPE ViPipe, ISP_DEMOSAIC_ATTR_S *pstDemosaicAttr)
{
    ...
    for (i = 0; i < ISP_AUTO_ISO_STRENGTH_NUM; i++) {
        ...
        pstDemosaicAttr->stAuto.au8NonDirMFDetailEhcStr[i] = hi_ext_system_demosaic_auto_nondirection_midfreq_detailenhance_strength_read(ViPipe, i);
        pstDemosaicAttr->stAuto.au8NonDirHFDetailEhcStr[i] = hi_ext_system_demosaic_auto_nondirection_higfreq_detailenhance_strength_read(ViPipe, i);
    ...
    pstDemosaicAttr->stManual.u8NonDirMFDetailEhcStr = hi_ext_system_demosaic_manual_nondirection_midfreq_detailenhance_strength_read(ViPipe);
    pstDemosaicAttr->stManual.u8NonDirHFDetailEhcStr = hi_ext_system_demosaic_manual_nondirection_higfreq_detailenhance_strength_read(ViPipe);
...
HI_S32 HI_MPI_ISP_SetCAAttr(VI_PIPE ViPipe, const ISP_CA_ATTR_S *pstCAAttr)
{
    ...
    if (pstCAAttr->eCaCpEn >= ISP_CA_BUTT) {
        ISP_TRACE(HI_DBG_ERR, "Invalid eCaCpEn!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    ...
    for (i = 0; i < HI_ISP_CA_YRATIO_LUT_LENGTH; i++) {
        ...
        if (pstCAAttr->stCA.au32YRatioLut[i] > 2047) {
            ISP_TRACE(HI_DBG_ERR, "Invalid au32YRatioLut[%d]!\n", i);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
    ...
    for (i = 0; i < ISP_AUTO_ISO_STRENGTH_NUM; i++) {
        if (pstCAAttr->stCA.as32ISORatio[i] > 2047) {
            ISP_TRACE(HI_DBG_ERR, "Invalid as32ISORatio[%d]!\n", i);
            return HI_ERR_ISP_ILLEGAL_PARAM;
        }
...
HI_S32 HI_MPI_ISP_GetCAAttr(VI_PIPE ViPipe, ISP_CA_ATTR_S *pstCAAttr)
{
    ...
    for (i = 0; i < HI_ISP_CA_YRATIO_LUT_LENGTH; i++) {
        pstCAAttr->stCP.au8CPLutY[i] = (hi_ext_system_ca_cp_lut_read(ViPipe, i) >> 16) & 0x000000FF;
...
HI_S32 HI_MPI_ISP_SetBlackLevelAttr(VI_PIPE ViPipe, const ISP_BLACK_LEVEL_S *pstBlackLevel)
{
    ...
    hi_ext_system_black_level_manual_mode_write(ViPipe, pstBlackLevel->enOpType);
...
HI_S32 HI_MPI_ISP_GetDngImageStaticInfo(VI_PIPE ViPipe, DNG_IMAGE_STATIC_INFO_S *pstDngImageStaticInfo)
{
    ...
    if (bValidDngImageStaticInfo == HI_FALSE) {
        ISP_TRACE(HI_DBG_ERR, "DngImageStaticInfo have not been set in xxx_Cmos.x!\n");
        return HI_SUCCESS;
    }

    if (ioctl(g_as32IspFd[ViPipe], ISP_DNG_INFO_GET, pstDngImageStaticInfo) != HI_SUCCESS) {
        return HI_ERR_ISP_NOMEM;
    }
...
HI_S32 HI_MPI_ISP_SetDngColorParam(VI_PIPE ViPipe, const ISP_DNG_COLORPARAM_S *pstDngColorParam)
{
    ...
    if (pstDngColorParam->stWbGain1.u16Bgain > 0xFFF) {
        ISP_TRACE(HI_DBG_ERR, "stWbGain1.u16Bgain can't bigger than 0xFFF!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstDngColorParam->stWbGain1.u16Ggain > 0xFFF) {
        ISP_TRACE(HI_DBG_ERR, "stWbGain1.u16Ggain can't bigger than 0xFFF!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstDngColorParam->stWbGain1.u16Rgain > 0xFFF) {
        ISP_TRACE(HI_DBG_ERR, "stWbGain1.u16Rgain can't bigger than 0xFFF!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstDngColorParam->stWbGain2.u16Bgain > 0xFFF) {
        ISP_TRACE(HI_DBG_ERR, "stWbGain2.u16Bgain can't bigger than 0xFFF!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstDngColorParam->stWbGain2.u16Ggain > 0xFFF) {
        ISP_TRACE(HI_DBG_ERR, "stWbGain2.u16Ggain can't bigger than 0xFFF!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
    if (pstDngColorParam->stWbGain2.u16Rgain > 0xFFF) {
        ISP_TRACE(HI_DBG_ERR, "stWbGain2.u16Rgain can't bigger than 0xFFF!\n");
        return HI_ERR_ISP_ILLEGAL_PARAM;
    }
