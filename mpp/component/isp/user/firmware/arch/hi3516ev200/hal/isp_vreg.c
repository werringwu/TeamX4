...
static inline HI_BOOL VREG_CHECK_ISP_VREG_BASE(HI_U32 u32BaseAddr)
{
    ...
    return (HI_BOOL)ISP_CHECK_REG_BASE(GET_ISP_VREG_BASE(u32BaseAddr), ISP_VREG_BASE, ISP_VIR_REG_BASE(1));
}
...
static inline HI_BOOL VREG_CHECK_ISP_AE_VREG_BASE_EX(HI_U32 u32BaseAddr)
{
...
static inline HI_BOOL VREG_CHECK_ISP_AWB_VREG_BASE_EX(HI_U32 u32BaseAddr)
{
...
{
    HI_U32 vRegMask = 0xFFFFFFFF - (ISP_VREG_SIZE - 1);
    if (VREG_CHECK_AE_VREG_BASE(u32BaseAddr)) {
...
{
    HI_U32 vRegMask = (ISP_VREG_SIZE - 1);
    ...
    if ((VREG_CHECK_ISPFE_BASE(u32BaseAddr))\
        ...
        return ((HI_U8 *)pVirtAddr + (u32BaseAddr & vRegMask));
    } else if (VREG_CHECK_AE_VREG_BASE(u32BaseAddr)) {
...
HI_U32 IO_READ32(HI_U32 u32Addr)
{
    ...
    pu32Addr = (HI_U32 *)(HI_UINTPTR_T)((HI_UINTPTR_T)pVirtAddr & IO_MASK_BITXX);
