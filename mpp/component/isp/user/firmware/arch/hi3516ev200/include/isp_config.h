...
#define HI_ISP_FE_FIX_TIMING_STAT                     (0x40)
...
#define HI_ISP_DMNR_DITHER_ROUND_DEFAULT              2
#define HI_ISP_DMNR_DITHER_SPATIAL_MODE_DEFAULT       1
#define HI_ISP_DMNR_DITHER_OUT_BITS_DEFAULT           (10)
#define HI_ISP_ACM_DITHER_ROUND_DEFAULT               2
#define HI_ISP_ACM_DITHER_SPATIAL_MODE_DEFAULT        1
#define HI_ISP_ACM_DITHER_OUT_BITS_DEFAULT            (8)
#define HI_ISP_DRC_DITHER_ROUND_DEFAULT               (2)
#define HI_ISP_DRC_DITHER_SPATIAL_MODE_DEFAULT        (1)
#define HI_ISP_DRC_DITHER_OUT_BITS_DEFAULT            (12)
#define HI_ISP_SQRT1_DITHER_OUT_BITS_DEFAULT          (12)
#define HI_ISP_BLK_B_HBLANK_DEFAULT                   0x20
#define HI_ISP_BLK_F_HBLANK_DEFAULT                   0x18
#define HI_ISP_BLK_B_VBLANK_DEFAULT                   0x0
#define HI_ISP_BLK_F_VBLANK_DEFAULT                   0x0
#define HI_ISP_AE_FOUR_PLANE_MODE_DISABLE             (0)
#define HI_ISP_AE_FOUR_PLANE_MODE_ENABLE              (1)
#define HI_ISP_AE_FOUR_PLANE_MODE_DISABLE             (0)
#define HI_ISP_AE_FOUR_PLANE_MODE_ENABLE              (1)
#define HI_ISP_AE_WEI_COMBIN_COUNT                    4
#define HI_ISP_BE_AF_LPF_EN_DEFAULT                   (0)
#define HI_ISP_BE_AF_LPF_EN_DATASIZE                  (1)
#define HI_ISP_BE_AF_IIR0_DS_EN_DEFAULT               (0x1)
#define HI_ISP_BE_AF_IIR0_DS_EN_DATASIZE              (1)
#define HI_ISP_BE_AF_IIR1_DS_EN_DEFAULT               (0x1)
#define HI_ISP_BE_AF_IIR1_DS_EN_DATASIZE              (1)
#define HI_ISP_BE_AF_FIR0_LPF_EN_DEFAULT              (0x1)
#define HI_ISP_BE_AF_FIR0_LPF_EN_DATASIZE             (1)
#define HI_ISP_BE_AF_FIR1_LPF_EN_DEFAULT              (0x1)
#define HI_ISP_BE_AF_FIR1_LPF_EN_DATASIZE             (1)
#define HI_ISP_BE_AF_GAMMA_DEFAULT                    0x3
#define HI_ISP_BE_AF_IIR0_PLG_DEFAULT                 (0x96)
#define HI_ISP_BE_AF_IIR0_PLG_DATASIZE                (8)
#define HI_ISP_BE_AF_IIR0_PLS_DEFAULT                 (0x3)
#define HI_ISP_BE_AF_IIR0_PLS_DATASIZE                (3)
#define HI_ISP_BE_AF_IIR1_PLG_DEFAULT                 (0x99)
#define HI_ISP_BE_AF_IIR1_PLG_DATASIZE                (8)
#define HI_ISP_BE_AF_IIR1_PLS_DEFAULT                 (0x3)
#define HI_ISP_BE_AF_IIR1_PLS_DATASIZE                (3)
#define ISP_AF_CNT_SHIFT0_V_DEFAULT                   (0x2)
#define HI_ISP_BE_AF_IIR0_DILATE_DEFAULT              (0x0)
#define HI_ISP_BE_AF_IIR0_DILATE_DATASIZE             (3)
#define HI_ISP_BE_AF_IIR1_DILATE_DEFAULT              (0x0)
#define HI_ISP_BE_AF_IIR1_DILATE_DATASIZE             (3)
...
#define HI_ISP_GE_NPOFFSET_DEFAULT                    (16383)
#define HI_ISP_GE_SENSITHR_DEFAULT                    (4800)
#define HI_ISP_GE_THRESHOLD_DEFAULT                   (4800)
#define HI_ISP_GE_SENSISLOPE_DEFAULT                  (13)
#define HI_ISP_GE_SLOPE_DEFAULT                       (13)
#define HI_ISP_GE_STRENGTH_DEFAULT                    (128)
#define HI_ISP_GE_BIT_DEPTH_DEFAULT                   (0)
#define HI_ISP_DPC_DEFAULT_ALPHA                      (0)
#define HI_ISP_DPC_DEFAULT_MODE                       (0x23)
#define HI_ISP_DPC_DEFAULT_OUTPUT_MODE                (0x3)
#define HI_ISP_DPC_DEFAULT_SET_USE                    (0x1)
#define HI_ISP_DPC_DEFAULT_METHODS_SET_1              (0x1F1F)
#define HI_ISP_DPC_DEFAULT_METHODS_SET_2              (0x707)
#define HI_ISP_DPC_DEFAULT_METHODS_SET_3              (0x1F1F)
#define HI_ISP_DPC_DEFAULT_LINE_THRESH_1              (0x5454)
#define HI_ISP_DPC_DEFAULT_LINE_MAD_FAC_1             (0x1B1B)
#define HI_ISP_DPC_DEFAULT_PG_FAC_1                   (0x0808)
#define HI_ISP_DPC_DEFAULT_RND_THRESH_1               (0x0A0A)
#define HI_ISP_DPC_DEFAULT_RG_FAC_1                   (0x2626)
#define HI_ISP_DPC_DEFAULT_LINE_THRESH_2              (0x2121)
#define HI_ISP_DPC_DEFAULT_LINE_MAD_FAC_2             (0x1810)
#define HI_ISP_DPC_DEFAULT_PG_FAC_2                   (0x0B0B)
#define HI_ISP_DPC_DEFAULT_RND_THRESH_2               (0x0808)
#define HI_ISP_DPC_DEFAULT_RG_FAC_2                   (0x0808)
#define HI_ISP_DPC_DEFAULT_LINE_THRESH_3              (0x2020)
#define HI_ISP_DPC_DEFAULT_LINE_MAD_FAC_3             (0x404)
#define HI_ISP_DPC_DEFAULT_PG_FAC_3                   (0x0a0a)
#define HI_ISP_DPC_DEFAULT_RND_THRESH_3               (0x0806)
#define HI_ISP_DPC_DEFAULT_RG_FAC_3                   (0x0404)
#define HI_ISP_DPC_DEFAULT_RO_LIMITS                  (0x09a5)
#define HI_ISP_DPC_DEFAULT_RND_OFFS                   (0x0aaa)
#define HI_ISP_DPCC_BPDATA_DEFAULT                    (16383)
#define HI_ISP_DPC_DEFAULT_BPT_CTRL                   (0x3FFF0330)
#define HI_ISP_DPC_DEFAULT_BPT_NUMBER                 (0)
#define HI_ISP_DPC_DEFAULT_BPT_THRESH                 (0xff800080)
#define HI_ISP_DPC_DEFAULT_SOFT_THR_MIN               (-15)
#define HI_ISP_DPC_DEFAULT_SOFT_THR_MAX               (6)
#define HI_ISP_DPC_DEFAULT_HARD_THR_ENABLE            (1)
#define HI_ISP_DPC_DEFAULT_SOFT_RAKE_RATIO            (24)
#define HI_ISP_DPC_DEFAULT_LINE_AVER_FAC_1            (128)
#define HI_ISP_DPC_DEFAULT_LINE_DIFF_THR_1            (36)
#define HI_ISP_DPC_DEFAULT_LINE_STD_THR_1             (80)
#define HI_ISP_DPC_DEFAULT_LINE_AVER_FAC_2            (128)
#define HI_ISP_DPC_DEFAULT_LINE_DIFF_THR_2            (36)
#define HI_ISP_DPC_DEFAULT_LINE_STD_THR_2             (80)
#define HI_ISP_DPC_DEFAULT_LINE_AVER_FAC_3            (128)
#define HI_ISP_DPC_DEFAULT_LINE_DIFF_THR_3            (36)
#define HI_ISP_DPC_DEFAULT_LINE_STD_THR_3             (80)
#define HI_ISP_DPC_DEFAULT_LINE_AVER_FAC_4            (128)
#define HI_ISP_DPC_DEFAULT_LINE_DIFF_THR_4            (36)
#define HI_ISP_DPC_DEFAULT_LINE_STD_THR_4             (80)
#define HI_ISP_DPC_DEFAULT_LINE_AVER_FAC_5            (128)
#define HI_ISP_DPC_DEFAULT_LINE_DIFF_THR_5            (36)
#define HI_ISP_DPC_DEFAULT_LINE_STD_THR_5             (80)
#define HI_ISP_DPC_DEFAULT_LINE_KERDIFF_FAC           (64)
#define HI_ISP_DPC_DEFAULT_BLEND_MODE                 (0)
#define HI_ISP_DPC_DEFAULT_BIT_DEPTH_SEL              (0)
#define HI_ISP_DPC_DEFAULT_POS_LINEAR                 (1)
#define HI_ISP_DPC_DEFAULT_POS_WDR                    (0)
#define HI_ISP_DEMOSAIC_AND_EN_DEFAULT                1
#define HI_ISP_GCAC_BLEND_SELECTION_DEFAULT           0
#define HI_ISP_DEMOSAIC_FCR_EN_DEFAULT                1
#define HI_ISP_DEMOSAIC_DE_FAKE_EN_DEFAULT            1
#define HI_ISP_DEMOSAIC_DESAT_ENABLE_DEFAULT          (1)
#define HI_ISP_DEMOSAIC_BLENDLIMIT2_DEFAULT           (40)
#define HI_ISP_DEMOSAIC_BLENDLIMIT1_DEFAULT           (24)
#define HI_ISP_DEMOSAIC_FCR_LIMIT2_DEFAULT            0xA0
#define HI_ISP_DEMOSAIC_FCR_LIMIT1_DEFAULT            0x10
...
#define HI_ISP_DEMOSAIC_FCR_THR_DEFAULT               0x1
#define HI_ISP_DEMOSAIC_HV_RATIO_DEFAULT              16
#define HI_ISP_DEMOSAIC_FCR_RATIO_DEFAULT             8
...
#define HI_ISP_DEMOSAIC_LPF_F0_DEFAULT                0xF
#define HI_ISP_DEMOSAIC_LPF_F1_DEFAULT                0x7
#define HI_ISP_DEMOSAIC_LPF_F2_DEFAULT                0x14
#define HI_ISP_DEMOSAIC_LPF_F3_DEFAULT                0x0
#define HI_ISP_DEMOSAIC_G_CLIP_SFT_BIT_DEFAULT        1
#define HI_ISP_DEMOSAIC_G_INTP_CONTROL_DEFAULT        0x1
#define HI_ISP_DEMOSAIC_CBCR_AVG_THLD_DEFAULT         0x96
#define HI_ISP_DEMOSAIC_CC_HF_MIN_RATIO_DEFAULT       0x0
#define HI_ISP_DEMOSAIC_CC_HF_MAX_RATIO_DEFAULT       0x8
#define HI_ISP_DEMOSAIC_GCAC_BLEND_THR_DEFAULT        130
#define HI_ISP_LCAC_SATU_THR_DEFAULT                  128
#define HI_ISP_DEMOSAIC_FCR_GRAY_RATIO_DEFAULT        0x4
#define HI_ISP_DEMOSAIC_FCR_DETG_SEL_DEFAULT          0x4
#define HI_ISP_DEMOSAIC_FCR_CMAX_SEL_DEFAULT          0x4
#define HI_ISP_DEMOSAIC_CC_VAR_THRESH_DEFAULT         (-1)
#define HI_ISP_DEMOSAIC_HF_INPT_BLUR_TH_LOW_DEFAULT   0X0
#define HI_ISP_DEMOSAIC_HF_INPT_BLUR_TH_HIGH_DEFAULT  0X40
#define HI_ISP_DEMOSAIC_HF_INPT_BLUR_RATIO_DEFAULT    (0)
#define HI_ISP_DEMOSAIC_CB_THR_DEFAULT                (400)
#define HI_ISP_DEMOSAIC_LUMA_THR_DEFAULT              (1500)
#define HI_ISP_DEMOSAIC_CAC_LUMA_HIGH_CNT_THR_DEFAULT (1)
#define HI_ISP_DEMOSAIC_CAC_CB_CNT_LOW_THR_DEFAULT    (55)
#define HI_ISP_DEMOSAIC_CAC_CB_CNT_HIGH_THR_DEFAULT   (68)
#define HI_ISP_DEMOSAIC_DEFCOLOR_CR_DEFAULT           (8)
#define HI_ISP_DEMOSAIC_DEFCOLOR_CB_DEFAULT           (8)
#define HI_ISP_DEMOSAIC_CAC_BLD_AVG_CUR_DEFAULT       (8)
#define HI_ISP_DEMOSAIC_FCR_HF_THRESH_LOW_DEFAULT     (48)
#define HI_ISP_DEMOSAIC_FCR_HF_THRESH_HIGH_DEFAULT    (128)
#define HI_ISP_DEMOSAIC_DESAT_THRESH1_DEFAULT         (96)
#define HI_ISP_DEMOSAIC_DESAT_THRESH2_DEFAULT         (192)
#define HI_ISP_DEMOSAIC_DESAT_HIG_DEFAULT             (256)
#define HI_ISP_DEMOSAIC_DESAT_LOW_DEFAULT             (166)
#define HI_ISP_DEMOSAIC_DESAT_RATIO_DEFAULT           (-15)
#define HI_ISP_DEMOSAIC_DESAT_PROTECT_SL_DEFAULT      (180)
#define HI_ISP_DEMOSAIC_DESAT_PROTECT_TH_DEFAULT      (128)
#define HI_ISP_NDDM_GF_TH_LOW_DEFAULT                 0
#define HI_ISP_NDDM_GF_TH_HIGH_DEFAULT                272
#define HI_ISP_NDDM_AWB_GF_GN_LOW_DEFAULT             0x0
#define HI_ISP_NDDM_AWB_GF_GN_HIGH_DEFAULT            0x0
#define HI_ISP_NDDM_AWB_GF_GN_MAX_DEFAULT             0x0
#define HI_ISP_NDDM_FCR_GF_GAIN_DEFAULT               0x4
#define HI_ISP_NDDM_FCR_DET_LOW_DEFAULT               150
#define HI_ISP_NDDM_CAC_BLEND_RATE_DEFAULT            256
#define HI_ISP_NDDM_EHC_GRAY_DEFAULT                  0x10
#define HI_ISP_DITHER_MASK_DEFAULT                    0x1f
#define HI_ISP_DITHER_RATIO_DEFAULT                   0x80
#define HI_ISP_DITH_MAX_DEFAULT                       0x0
#define HI_ISP_NDDM_COEF_K_DEFAULT                    (0x80)
#define HI_ISP_NDDM_COEF_B_DEFAULT                    (0x10)
#define HI_ISP_BNR_DEFAULT_C_RATIO_R                  0
#define HI_ISP_BNR_DEFAULT_C_RATIO_GR                 0
#define HI_ISP_BNR_DEFAULT_C_RATIO_GB                 0
#define HI_ISP_BNR_DEFAULT_C_RATIO_B                  0
#define HI_ISP_BNR_DEFAULT_AMED_MODE_R                0
#define HI_ISP_BNR_DEFAULT_AMED_MODE_GR               0
#define HI_ISP_BNR_DEFAULT_AMED_MODE_GB               0
#define HI_ISP_BNR_DEFAULT_AMED_MODE_B                0
#define HI_ISP_BNR_DEFAULT_AMED_LEVEL_R               1
#define HI_ISP_BNR_DEFAULT_AMED_LEVEL_GR              0
#define HI_ISP_BNR_DEFAULT_AMED_LEVEL_GB              0
#define HI_ISP_BNR_DEFAULT_AMED_LEVEL_B               1
#define HI_ISP_BNR_DEFAULT_JNLM_CORING_HIGH           0x300
#define HI_ISP_BNR_DEFAULT_JNLM_GAIN                  0x52
#define HI_ISP_BNR_DEFAULT_JNLM_SEL                   0x3
#define HI_ISP_BNR_DEFAULT_JNLM_MAX_WT_COEF           0x80
#define HI_ISP_BNR_DEFAULT_LUMA_SEL                   0x1
#define HI_ISP_BNR_DEFAULT_JNLM_SYMCOEF_LINEAR        64
#define HI_ISP_BNR_DEFAULT_JNLM_SYMCOEF_WDR           64
#define HI_ISP_BNR_DEFAULT_RLMT_BLC                   0x10
#define HI_ISP_BNR_DEFAULT_RLMT_RGAIN                 0x100
#define HI_ISP_BNR_DEFAULT_RLMT_BGAIN                 0x100
#define HI_ISP_BNR_DE_NEGCLIP_DEFAULT                 (0x7F)
#define HI_ISP_BNR_DE_POSCLIP_DEFAULT                 (0x7F)
#define HI_ISP_BNR_DEFAULT_LINEAR_WDRMAP_FLTMODE      (0x0)
#define HI_ISP_BNR_DEFAULT_WDR_WDRMAP_FLTMODE         (0x1)
#define HI_ISP_BNR_DEFAULT_LINEAR_WDRMAP_GAIN         (0x0)
#define HI_ISP_BNR_DEFAULT_WDR_WDRMAP_GAIN            (0x3)
#define HI_ISP_BNR_DEFAULT_SAD_WINSIZE_SEL            0x0
#define HI_ISP_BNR_DEFAULT_SHOT_RATIO                 0x146
#define HI_ISP_BNR_DEFAULT_EDGE_DET_THRESHOLD_LINEAR  0x0
#define HI_ISP_BNR_DEFAULT_EDGE_DET_THRESHOLD_WDR     0x800
#define HI_ISP_BNR_DEFAULT_ENABLE_POST_PROC           (3)
#define HI_ISP_BNR_DEFAULT_SYMMSAD                    (1)
#define HI_ISP_BNR_DEFAULT_IMPLS_NR_STRENGTH          (0x40)
#define HI_ISP_BNR_DEFAULT_IMPLS_NR_ENABLE3           (1)
#define HI_ISP_BNR_DEFAULT_IMPLS_NR_ENABLE2           (1)
#define HI_ISP_BNR_DEFAULT_IMPLS_NR_ENABLE1           (1)
#define HI_ISP_BNR_DEFAULT_GAIN_SAD                   (0x40)
#define HI_ISP_BNR_DEFAULT_PATTERN_NOISE_REDUCTION    (1)
#define HI_ISP_BNR_DEFAULT_WINDOW_SIZE_SEL            (3)
#define HI_ISP_BNR_DEFAULT_NLIMIT_GAIN_BLT            (200)
#define HI_ISP_BNR_DEFAULT_BILATERAL_ENABLE           (2)
#define HI_ISP_WDR_FUSION_DATA_MODE                   (0x2)
#define HI_ISP_FUSION_MODE_DEFAULT                    0
#define HI_ISP_WDR_EROSION_EN_DEFAULT                 (1)
#define HI_ISP_WDR_MDT_EN_DEFAULT                     (1)
#define HI_ISP_WDR_GRAYSCALE_DEFAULT                  0
#define HI_ISP_WDR_SAVE_BLC_EN_DEFAULT                1
#define HI_ISP_WDR_SATURATE_THR_DEFAULT               3777
#define HI_ISP_WDR_STILL_THR0_DEFAULT                 0
#define HI_ISP_WDR_MDTL_BLD_DEFAULT                   (0)
#define HI_ISP_WDR_MDT_FULL_THR_DEFAULT               250
#define HI_ISP_WDR_MDT_STILL_THR_DEFAULT              (20)
#define HI_ISP_WDR_FORCELONG_HIGH_THD_DEFAULT         (1600)
#define HI_ISP_WDR_FORCELONG_LOW_THD_DEFAULT          (1024)
#define HI_ISP_WDR_FORCELONG_SMOOTH_EN                (0x1)
#define HI_ISP_WDR_FORCELONG_EN_DEFAULT               (0)
#define HI_ISP_WDR_FORCELONG_SLOPE_DEFAULT            (0x51)
#define HI_ISP_WDR_MDT_NOSF_HIG_THR_DEFAULT           (0xbd)
#define HI_ISP_WDR_MDT_NOSF_LOW_THR_DEFAULT           (0x7e)
#define HI_ISP_WDR_GAIN_SUM_HIG_THR_DEFAULT           (0x3)
#define HI_ISP_WDR_GAIN_SUM_LOW_THR_DEFAULT           (0x2)
#define ISP_WDR_SHORTCHK_THD_DEFAULT                  (12)
#define HI_ISP_WDR_SHORT_EXPO_CHK_DEFAULT             (1)
#define HI_ISP_WDR_PIXEL_AVG_MAX_DIFF_DEFAULT         (70)
#define HI_ISP_WDR_MASK_SIMILAR_CNT_DEFAULT           (3)
#define HI_ISP_WDR_MASK_SIMILAR_THR_DEFAULT           (20)
#define HI_ISP_WDR_BLDRLHFIDX_DEFAULT                 (4)
#define HI_ISP_WDR_LONG_THR_DEFAULT                   (3008)
#define HI_ISP_WDR_SHORT_THR_DEFAULT                  (4032)
#define HI_ISP_WDR_DFTWGT_FL_DEFAULT                  (256)
#define HI_ISP_WDR_WGT_SLOPE_DEFAULT                  (0x10)
#define HI_ISP_WDR_FUSION_F0_THR_R                    (3500)
#define HI_ISP_WDR_FUSION_F1_THR_B                    (3000)
#define HI_ISP_WDR_FUSION_F0_THR_B                    (3500)
#define HI_ISP_WDR_FUSION_F1_THR_G                    (3000)
#define HI_ISP_WDR_FUSION_F0_THR_G                    (3500)
#define HI_ISP_WDR_FUSION_SATURATE_THD                (0xed1)
...
#define HI_ISP_NDDM_CFG_EN_DEFAULT                    1
#define HI_ISP_DEHAZE_LUT_WIDTH_WORD_DEFAULT          (160) // 640/4
#define HI_ISP_GAMMA_LUT_WIDTH_WORD_DEFAULT           (65)   // 257/4
#define HI_ISP_SHARPEN_LUT_WIDTH_WORD_DEFAULT         (32) // 128/4
#define HI_ISP_MLSC_LUT_WIDTH_WORD_DEFAULT            (289) // 1156/4
#define HI_ISP_LDCI_LUT_WIDTH_WORD_DEFAULT            (65)
#define HI_ISP_CA_LUT_WIDTH_WORD_DEFAULT              (32)
#define HI_ISP_BNR_LUT_WIDTH_WORD_DEFAULT             (65)
...
*******************************************************************************
******************************************************************************/
static __inline HI_VOID isp_fe_user_define0_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_user_define0)
{
    pstFeReg->ISP_FE_USER_DEFINE0.u32 = uisp_fe_user_define0;
}
static __inline  HI_VOID isp_fe_user_define1_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_user_define1)
{
    pstFeReg->ISP_FE_USER_DEFINE1.u32 = uisp_fe_user_define1;
}
static __inline  HI_VOID isp_fe_format_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_format)
{
    pstFeReg->ISP_FE_FORMAT.u32 = uisp_fe_format;
}
static __inline  HI_VOID isp_fe_int_mask_fstart_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_int_mask_fstart)
{
...
static __inline  HI_VOID isp_fe_int_mask_update_cfg_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_int_mask_update_cfg)
{
    U_ISP_FE_INT_MASK o_isp_fe_int_mask;
    o_isp_fe_int_mask.u32 = pstFeReg->ISP_FE_INT_MASK.u32;
...
static __inline  HI_VOID isp_fe_int_mask_cfg_loss_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_int_mask_cfg_loss)
{
    U_ISP_FE_INT_MASK o_isp_fe_int_mask;
    o_isp_fe_int_mask.u32 = pstFeReg->ISP_FE_INT_MASK.u32;
...
static __inline  HI_VOID isp_fe_int_mask_int_delay_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_int_mask_int_delay)
{
    U_ISP_FE_INT_MASK o_isp_fe_int_mask;
    o_isp_fe_int_mask.u32 = pstFeReg->ISP_FE_INT_MASK.u32;
...
static __inline  HI_VOID isp_fe_int_mask_ae1_int_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_int_mask_ae1_int)
{
    U_ISP_FE_INT_MASK o_isp_fe_int_mask;
    o_isp_fe_int_mask.u32 = pstFeReg->ISP_FE_INT_MASK.u32;
...
static __inline  HI_VOID isp_fe_int_mask_af1_int_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_int_mask_af1_int)
{
    U_ISP_FE_INT_MASK o_isp_fe_int_mask;
    o_isp_fe_int_mask.u32 = pstFeReg->ISP_FE_INT_MASK.u32;
...
static __inline  HI_VOID isp_fe_int_mask_dis1_int_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_int_mask_dis1_int)
{
    U_ISP_FE_INT_MASK o_isp_fe_int_mask;
    o_isp_fe_int_mask.u32 = pstFeReg->ISP_FE_INT_MASK.u32;
...
static __inline  HI_VOID isp_fe_colorbar_en_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_colorbar_en)
{
...
static __inline  HI_VOID isp_fe_crop_en_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_crop_en)
{
    U_ISP_FE_CTRL o_isp_fe_ctrl;
    o_isp_fe_ctrl.u32 = pstFeReg->ISP_FE_CTRL.u32;
...
static __inline  HI_VOID isp_fe_blc1_en_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_blc1_en)
{
    U_ISP_FE_CTRL o_isp_fe_ctrl;
    o_isp_fe_ctrl.u32 = pstFeReg->ISP_FE_CTRL.u32;
...
static __inline  HI_VOID isp_fe_rc_en_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_rc_en)
{
    U_ISP_FE_CTRL o_isp_fe_ctrl;
    o_isp_fe_ctrl.u32 = pstFeReg->ISP_FE_CTRL.u32;
...
static __inline  HI_VOID isp_fe_hrs_en_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_hrs_en)
{
    U_ISP_FE_CTRL o_isp_fe_ctrl;
    o_isp_fe_ctrl.u32 = pstFeReg->ISP_FE_CTRL.u32;
...
static __inline  HI_VOID isp_fe_rlsc1_en_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_rlsc1_en)
{
    U_ISP_FE_CTRL o_isp_fe_ctrl;
    o_isp_fe_ctrl.u32 = pstFeReg->ISP_FE_CTRL.u32;
...
static __inline  HI_VOID isp_fe_dg2_en_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_dg2_en)
{
    U_ISP_FE_CTRL o_isp_fe_ctrl;
    o_isp_fe_ctrl.u32 = pstFeReg->ISP_FE_CTRL.u32;
...
static __inline  HI_VOID isp_fe_dis1_en_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_dis1_en)
{
    U_ISP_FE_CTRL o_isp_fe_ctrl;
    o_isp_fe_ctrl.u32 = pstFeReg->ISP_FE_CTRL.u32;
...
static __inline  HI_VOID isp_fe_af1_en_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_af1_en)
{
    U_ISP_FE_CTRL o_isp_fe_ctrl;
    o_isp_fe_ctrl.u32 = pstFeReg->ISP_FE_CTRL.u32;
...
static __inline  HI_VOID isp_fe_wb1_en_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_wb1_en)
{
    U_ISP_FE_CTRL o_isp_fe_ctrl;
    o_isp_fe_ctrl.u32 = pstFeReg->ISP_FE_CTRL.u32;
...
static __inline  HI_VOID isp_fe_drcs_en_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_drcs_en)
{
    U_ISP_FE_CTRL o_isp_fe_ctrl;
    o_isp_fe_ctrl.u32 = pstFeReg->ISP_FE_CTRL.u32;
...
static __inline  HI_VOID isp_fe_ae1_en_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_ae1_en)
{
    U_ISP_FE_CTRL o_isp_fe_ctrl;
    o_isp_fe_ctrl.u32 = pstFeReg->ISP_FE_CTRL.u32;
...
static __inline  HI_VOID isp_fe_loglut1_en_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_loglut1_en)
{
    U_ISP_FE_CTRL o_isp_fe_ctrl;
    o_isp_fe_ctrl.u32 = pstFeReg->ISP_FE_CTRL.u32;
...
static __inline  HI_VOID isp_fe_hsync_mode_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_hsync_mode)
{
...
static __inline  HI_VOID isp_fe_vsync_mode_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_vsync_mode)
{
    U_ISP_FE_ADAPTER_CFG o_isp_fe_adapter_cfg;
...
static __inline  HI_VOID isp_fe_delay_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_delay)
{
    pstFeReg->ISP_FE_FSTART_DELAY.u32 = uisp_fe_delay;
}
static __inline  HI_VOID isp_fe_rggb_cfg_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_rggb_cfg)
{
...
static __inline  HI_VOID isp_fe_update_mode_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_update_mode)
{
...
#define HI_ISP_FE_FIX_TIMING_STAT                     (0x40)
static __inline  HI_VOID isp_fe_fix_timing_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_fix_timing)
{
...
static __inline  HI_VOID isp_fe_update_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_update)
{
...
static __inline  HI_VOID isp_fe_width_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_width)
{
...
static __inline  HI_VOID isp_fe_height_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_height)
{
    U_ISP_FE_SIZE o_isp_fe_size;
    o_isp_fe_size.u32 = pstFeReg->ISP_FE_SIZE.u32;
...
static __inline  HI_VOID isp_fe_blk_f_hblank_write(S_ISPFE_REGS_TYPE *pstFeReg, HI_U32 uisp_fe_blk_f_hblank)
{
...
static __inline  HI_VOID isp_blc1_ofset1_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_blc1_ofset1)
{
    pstFeReg->ISP_BLC1_OFFSET1.u32 = uisp_blc1_ofset1;
}

static __inline  HI_VOID isp_blc1_ofset2_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_blc1_ofset2)
{
    pstFeReg->ISP_BLC1_OFFSET2.u32 = uisp_blc1_ofset2;
}

static __inline  HI_VOID isp_dg2_en_in_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_dg2_en_in)
{
...
static __inline  HI_VOID isp_dg2_en_out_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_dg2_en_out)
{
    U_ISP_DG2_BLC_CFG o_isp_dg2_blc_cfg;
    o_isp_dg2_blc_cfg.u32 = pstFeReg->ISP_DG2_BLC_CFG.u32;
...
static __inline  HI_VOID isp_dg2_grgain_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_dg2_grgain)
{
...
static __inline  HI_VOID isp_dg2_rgain_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_dg2_rgain)
{
    U_ISP_DG2_GAIN1 o_isp_dg2_gain1;
    o_isp_dg2_gain1.u32 = pstFeReg->ISP_DG2_GAIN1.u32;
...
static __inline  HI_VOID isp_dg2_gbgain_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_dg2_gbgain)
{
...
static __inline  HI_VOID isp_dg2_bgain_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_dg2_bgain)
{
    U_ISP_DG2_GAIN2 o_isp_dg2_gain2;
    o_isp_dg2_gain2.u32 = pstFeReg->ISP_DG2_GAIN2.u32;
...
static __inline  HI_VOID isp_dg2_ofsgr_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_dg2_ofsgr)
{
...
static __inline  HI_VOID isp_dg2_ofsr_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_dg2_ofsr)
{
    U_ISP_DG2_BLC_OFFSET1 o_isp_dg2_blc_offset1;
    o_isp_dg2_blc_offset1.u32 = pstFeReg->ISP_DG2_BLC_OFFSET1.u32;
...
static __inline  HI_VOID isp_dg2_ofsgb_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_dg2_ofsgb)
{
...
static __inline  HI_VOID isp_dg2_ofsb_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_dg2_ofsb)
{
    U_ISP_DG2_BLC_OFFSET2 o_isp_dg2_blc_offset2;
    o_isp_dg2_blc_offset2.u32 = pstFeReg->ISP_DG2_BLC_OFFSET2.u32;
...
static __inline  HI_VOID isp_dg2_clip_value_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_dg2_clip_value)
{
...
static __inline  HI_VOID isp_wb1_en_in_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_wb1_en_in)
{
...
static __inline  HI_VOID isp_wb1_en_out_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_wb1_en_out)
{
    U_ISP_WB1_BLC_CFG o_isp_wb1_blc_cfg;
    o_isp_wb1_blc_cfg.u32 = pstFeReg->ISP_WB1_BLC_CFG.u32;
...
static __inline  HI_VOID isp_wb1_grgain_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_wb1_grgain)
{
...
static __inline  HI_VOID isp_wb1_rgain_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_wb1_rgain)
{
    U_ISP_WB1_GAIN1 o_isp_wb1_gain1;
    o_isp_wb1_gain1.u32 = pstFeReg->ISP_WB1_GAIN1.u32;
...
static __inline  HI_VOID isp_wb1_gbgain_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_wb1_gbgain)
{
...
static __inline  HI_VOID isp_wb1_bgain_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_wb1_bgain)
{
    U_ISP_WB1_GAIN2 o_isp_wb1_gain2;
    o_isp_wb1_gain2.u32 = pstFeReg->ISP_WB1_GAIN2.u32;
...
static __inline  HI_VOID isp_wb1_ofsgr_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_wb1_ofsgr)
{
...
static __inline  HI_VOID isp_wb1_ofsr_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_wb1_ofsr)
{
    U_ISP_WB1_BLC_OFFSET1 o_isp_wb1_blc_offset1;
    o_isp_wb1_blc_offset1.u32 = pstFeReg->ISP_WB1_BLC_OFFSET1.u32;
...
static __inline  HI_VOID isp_wb1_ofsgb_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_wb1_ofsgb)
{
...
static __inline  HI_VOID isp_wb1_ofsb_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_wb1_ofsb)
{
    U_ISP_WB1_BLC_OFFSET2 o_isp_wb1_blc_offset2;
    o_isp_wb1_blc_offset2.u32 = pstFeReg->ISP_WB1_BLC_OFFSET2.u32;
...
static __inline  HI_VOID isp_wb1_clip_value_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_wb1_clip_value)
{
...
static __inline  HI_VOID isp_ae1_hnum_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_hnum)
{
...
static __inline  HI_VOID isp_ae1_vnum_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_vnum)
{
    U_ISP_AE1_ZONE o_isp_ae1_zone;
    o_isp_ae1_zone.u32 = pstFeReg->ISP_AE1_ZONE.u32;
...
static __inline  HI_VOID isp_ae1_skip_x_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_skip_x)
{
...
static __inline  HI_VOID isp_ae1_offset_x_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_offset_x)
{
    U_ISP_AE1_SKIP_CRG o_isp_ae1_skip_crg;
    o_isp_ae1_skip_crg.u32 = pstFeReg->ISP_AE1_SKIP_CRG.u32;
...
static __inline  HI_VOID isp_ae1_skip_y_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_skip_y)
{
    U_ISP_AE1_SKIP_CRG o_isp_ae1_skip_crg;
    o_isp_ae1_skip_crg.u32 = pstFeReg->ISP_AE1_SKIP_CRG.u32;
...
static __inline  HI_VOID isp_ae1_offset_y_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_offset_y)
{
    U_ISP_AE1_SKIP_CRG o_isp_ae1_skip_crg;
    o_isp_ae1_skip_crg.u32 = pstFeReg->ISP_AE1_SKIP_CRG.u32;
...
static __inline  HI_VOID isp_ae1_bitmove_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_bitmove)
{
...
static __inline  HI_VOID isp_ae1_blc_en_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_blc_en)
{
    U_ISP_AE1_BITMOVE o_isp_ae1_bitmove;
    o_isp_ae1_bitmove.u32 = pstFeReg->ISP_AE1_BITMOVE.u32;
...
static __inline  HI_VOID isp_ae1_offset_r_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_offset_r)
{
...
static __inline  HI_VOID isp_ae1_offset_gr_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_offset_gr)
{
    U_ISP_AE1_OFFSET_R_GR o_isp_ae1_offset_r_gr;
    o_isp_ae1_offset_r_gr.u32 = pstFeReg->ISP_AE1_OFFSET_R_GR.u32;
...
static __inline  HI_VOID isp_ae1_offset_gb_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_offset_gb)
{
...
static __inline  HI_VOID isp_ae1_offset_b_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_offset_b)
{
    U_ISP_AE1_OFFSET_GB_B o_isp_ae1_offset_gb_b;
    o_isp_ae1_offset_gb_b.u32 = pstFeReg->ISP_AE1_OFFSET_GB_B.u32;
...
static __inline  HI_VOID isp_ae1_lut_update_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_lut_update)
{
...
static __inline  HI_VOID isp_ae1_stt_size_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_stt_size)
{
...
static __inline  HI_VOID isp_ae1_stt_bst_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_stt_bst)
{
    U_ISP_AE1_STT_BST o_isp_ae1_stt_bst;
    o_isp_ae1_stt_bst.u32 = pstFeReg->ISP_AE1_STT_BST.u32;
...
static __inline  HI_VOID isp_ae1_stt_en_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_stt_en)
{
    U_ISP_AE1_STT_BST o_isp_ae1_stt_bst;
    o_isp_ae1_stt_bst.u32 = pstFeReg->ISP_AE1_STT_BST.u32;
...
static __inline  HI_VOID isp_ae1_crop_pos_x_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_crop_pos_x)
{
...
static __inline  HI_VOID isp_ae1_crop_pos_y_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_crop_pos_y)
{
    U_ISP_AE1_CROP_POS o_isp_ae1_crop_pos;
    o_isp_ae1_crop_pos.u32 = pstFeReg->ISP_AE1_CROP_POS.u32;
...
static __inline  HI_VOID isp_ae1_crop_out_width_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_crop_out_width)
{
...
static __inline  HI_VOID isp_ae1_crop_out_height_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_crop_out_height)
{
    U_ISP_AE1_CROP_OUTSIZE o_isp_ae1_crop_outsize;
    o_isp_ae1_crop_outsize.u32 = pstFeReg->ISP_AE1_CROP_OUTSIZE.u32;
...
static __inline  HI_VOID isp_ae1_hist_raddr_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_hist_raddr)
{
    pstFeReg->ISP_AE1_HIST_RADDR.u32 = uisp_ae1_hist_raddr;
}
static __inline  HI_VOID isp_ae1_wei_waddr_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_wei_waddr)
{
    pstFeReg->ISP_AE1_WEIGHT_WADDR.u32 = uisp_ae1_wei_waddr;
}
static __inline  HI_VOID isp_ae1_wei_wdata_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_ae1_wei_wdata)
{
    pstFeReg->ISP_AE1_WEIGHT_WDATA.u32 = uisp_ae1_wei_wdata;
}
static __inline  HI_VOID isp_rc_blc_in_en_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_rc_blc_in_en)
{
...
static __inline  HI_VOID isp_rc_blc_out_en_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_rc_blc_out_en)
{
    U_ISP_RC_BLCEN o_isp_rc_blcen;
    o_isp_rc_blcen.u32 = pstFeReg->ISP_RC_BLCEN.u32;
...
static __inline  HI_VOID isp_rc_blc_r_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_rc_blc_r)
{
...
static __inline  HI_VOID isp_rc_blc_gr_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_rc_blc_gr)
{
    U_ISP_RC_BLC0 o_isp_rc_blc0;
    o_isp_rc_blc0.u32 = pstFeReg->ISP_RC_BLC0.u32;
...
static __inline  HI_VOID isp_rc_blc_b_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_rc_blc_b)
{
...
static __inline  HI_VOID isp_rc_blc_gb_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_rc_blc_gb)
{
    U_ISP_RC_BLC1 o_isp_rc_blc1;
    o_isp_rc_blc1.u32 = pstFeReg->ISP_RC_BLC1.u32;
...
static __inline  HI_VOID isp_rc_sqradius_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_rc_sqradius)
{
    pstFeReg->ISP_RC_SQRADIUS.u32 = uisp_rc_sqradius;
}
static __inline  HI_VOID isp_rc_cenhor_coor_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_rc_cenhor_coor)
{
...
static __inline  HI_VOID isp_rc_cenver_coor_write(S_ISPFE_REGS_TYPE *pstFeReg,  HI_U32 uisp_rc_cenver_coor)
{
    U_ISP_RC_CENTER_COOR o_isp_rc_center_coor;
    o_isp_rc_center_coor.u32 = pstFeReg->ISP_RC_CENTER_COOR.u32;
...
******************************************************************************
******************************************************************************/
static __inline HI_U32 Isp_GetBeFcnt(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->ISP_BE_STARTUP.u32;
}

static __inline  HI_VOID isp_ae_sel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_sel)
{
...
static __inline  HI_VOID isp_awb_sel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_awb_sel)
{
    U_ISP_BE_MODULE_POS o_isp_be_module_pos;
    o_isp_be_module_pos.u32 = pstBeReg->ISP_BE_MODULE_POS.u32;
...
static __inline  HI_VOID isp_af_sel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_af_sel)
{
    U_ISP_BE_MODULE_POS o_isp_be_module_pos;
    o_isp_be_module_pos.u32 = pstBeReg->ISP_BE_MODULE_POS.u32;
...
static __inline  HI_VOID isp_dis_sel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dis_sel)
{
    U_ISP_BE_MODULE_POS o_isp_be_module_pos;
    o_isp_be_module_pos.u32 = pstBeReg->ISP_BE_MODULE_POS.u32;
...
static __inline  HI_VOID isp_clut_sel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_clut_sel)
{
    U_ISP_BE_MODULE_POS o_isp_be_module_pos;
    o_isp_be_module_pos.u32 = pstBeReg->ISP_BE_MODULE_POS.u32;
...
static __inline  HI_VOID isp_dcg_sel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dcg_sel)
{
    U_ISP_BE_MODULE_POS o_isp_be_module_pos;
    o_isp_be_module_pos.u32 = pstBeReg->ISP_BE_MODULE_POS.u32;
...
static __inline  HI_VOID isp_delay_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_delay)
{
    pstBeReg->ISP_BE_FSTART_DELAY.u32 = uisp_delay;
}
static __inline  HI_VOID isp_input0_sel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_input0_sel)
{
...
static __inline  HI_VOID isp_input1_sel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_input1_sel)
{
    U_ISP_BE_INPUT_MUX o_isp_be_input_mux;
    o_isp_be_input_mux.u32 = pstBeReg->ISP_BE_INPUT_MUX.u32;
...
static __inline  HI_VOID isp_input2_sel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_input2_sel)
{
    U_ISP_BE_INPUT_MUX o_isp_be_input_mux;
    o_isp_be_input_mux.u32 = pstBeReg->ISP_BE_INPUT_MUX.u32;
...
static __inline  HI_VOID isp_input3_sel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_input3_sel)
{
    U_ISP_BE_INPUT_MUX o_isp_be_input_mux;
    o_isp_be_input_mux.u32 = pstBeReg->ISP_BE_INPUT_MUX.u32;
...
static __inline  HI_VOID isp_input4_sel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_input4_sel)
{
    U_ISP_BE_INPUT_MUX o_isp_be_input_mux;
    o_isp_be_input_mux.u32 = pstBeReg->ISP_BE_INPUT_MUX.u32;
...
static __inline  HI_VOID isp_stt_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_stt_en)
{
...
static __inline  HI_VOID isp_user_define0_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_user_define0)
{
    pstBeReg->ISP_BE_USER_DEFINE0.u32 = uisp_user_define0;
}
static __inline  HI_VOID isp_user_define1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_user_define1)
{
    pstBeReg->ISP_BE_USER_DEFINE1.u32 = uisp_user_define1;
}
static __inline  HI_VOID isp_format_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_format)
{
...
static __inline  HI_VOID isp_clip_y_min_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_clip_y_min)
{
...
static __inline  HI_VOID isp_clip_y_max_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_clip_y_max)
{
    U_ISP_CLIP_Y_CFG o_isp_clip_y_cfg;
    o_isp_clip_y_cfg.u32 = pstBeReg->ISP_CLIP_Y_CFG.u32;
...
static __inline  HI_VOID isp_clip_c_min_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_clip_c_min)
{
...
static __inline  HI_VOID isp_clip_c_max_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_clip_c_max)
{
    U_ISP_CLIP_C_CFG o_isp_clip_c_cfg;
    o_isp_clip_c_cfg.u32 = pstBeReg->ISP_CLIP_C_CFG.u32;
...
static __inline  HI_VOID isp_csc_sum_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_csc_sum_en)
{
...
static __inline  HI_VOID isp_yuv444_sum_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_yuv444_sum_en)
{
...
static __inline  HI_VOID isp_yuv422_sum_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_yuv422_sum_en)
{
...
static __inline  HI_VOID isp_wdr_sum_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_wdr_sum_en)
{
...
static __inline  HI_VOID isp_demosaic_sum_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_sum_en)
{
...
static __inline  HI_VOID isp_dmnr_dither_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dmnr_dither_en)
{
...
static __inline  HI_VOID isp_dmnr_dither_round_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dmnr_dither_round)
{
    U_ISP_DMNR_DITHER o_isp_dmnr_dither;
    o_isp_dmnr_dither.u32 = pstBeReg->ISP_DMNR_DITHER.u32;
...
static __inline  HI_VOID isp_dmnr_dither_spatial_mode_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dmnr_dither_spatial_mode)
{
    U_ISP_DMNR_DITHER o_isp_dmnr_dither;
    o_isp_dmnr_dither.u32 = pstBeReg->ISP_DMNR_DITHER.u32;
...
static __inline  HI_VOID isp_dmnr_dither_out_bits_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dmnr_dither_out_bits)
{
    U_ISP_DMNR_DITHER o_isp_dmnr_dither;
    o_isp_dmnr_dither.u32 = pstBeReg->ISP_DMNR_DITHER.u32;
...
static __inline  HI_VOID isp_acm_dither_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_acm_dither_en)
{
...
static __inline  HI_VOID isp_acm_dither_round_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_acm_dither_round)
{
    U_ISP_ACM_DITHER o_isp_acm_dither;
    o_isp_acm_dither.u32 = pstBeReg->ISP_ACM_DITHER.u32;
...
static __inline  HI_VOID isp_acm_dither_spatial_mode_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_acm_dither_spatial_mode)
{
    U_ISP_ACM_DITHER o_isp_acm_dither;
    o_isp_acm_dither.u32 = pstBeReg->ISP_ACM_DITHER.u32;
...
static __inline  HI_VOID isp_acm_dither_out_bits_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_acm_dither_out_bits)
{
    U_ISP_ACM_DITHER o_isp_acm_dither;
    o_isp_acm_dither.u32 = pstBeReg->ISP_ACM_DITHER.u32;
...
static __inline  HI_VOID isp_drc_dither_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_drc_dither_en)
{
...
static __inline  HI_VOID isp_drc_dither_round_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_drc_dither_round)
{
    U_ISP_DRC_DITHER o_isp_drc_dither;
    o_isp_drc_dither.u32 = pstBeReg->ISP_DRC_DITHER.u32;
...
static __inline  HI_VOID isp_drc_dither_spatial_mode_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_drc_dither_spatial_mode)
{
    U_ISP_DRC_DITHER o_isp_drc_dither;
    o_isp_drc_dither.u32 = pstBeReg->ISP_DRC_DITHER.u32;
...
static __inline  HI_VOID isp_drc_dither_out_bits_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_drc_dither_out_bits)
{
    U_ISP_DRC_DITHER o_isp_drc_dither;
    o_isp_drc_dither.u32 = pstBeReg->ISP_DRC_DITHER.u32;
...
static __inline  HI_VOID isp_sqrt1_dither_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sqrt1_dither_en)
{
...
static __inline  HI_VOID isp_sqrt1_dither_round_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sqrt1_dither_round)
{
    U_ISP_SQRT1_DITHER o_isp_sqrt1_dither;
    o_isp_sqrt1_dither.u32 = pstBeReg->ISP_SQRT1_DITHER.u32;
...
static __inline  HI_VOID isp_sqrt1_dither_spatial_mode_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sqrt1_dither_spatial_mode)
{
    U_ISP_SQRT1_DITHER o_isp_sqrt1_dither;
    o_isp_sqrt1_dither.u32 = pstBeReg->ISP_SQRT1_DITHER.u32;
...
static __inline  HI_VOID isp_sqrt1_dither_out_bits_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sqrt1_dither_out_bits)
{
    U_ISP_SQRT1_DITHER o_isp_sqrt1_dither;
    o_isp_sqrt1_dither.u32 = pstBeReg->ISP_SQRT1_DITHER.u32;
...
static __inline  HI_VOID isp_blk_b_hblank_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_blk_b_hblank)
{
...
static __inline  HI_VOID isp_blk_f_hblank_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_blk_f_hblank)
{
    U_ISP_BLK_HBLANK o_isp_blk_hblank;
    o_isp_blk_hblank.u32 = pstBeReg->ISP_BLK_HBLANK.u32;
...
static __inline  HI_VOID isp_blk_b_vblank_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_blk_b_vblank)
{
...
static __inline  HI_VOID isp_blk_f_vblank_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_blk_f_vblank)
{
    U_ISP_BLK_VBLANK o_isp_blk_vblank;
    o_isp_blk_vblank.u32 = pstBeReg->ISP_BLK_VBLANK.u32;
...
static __inline  HI_VOID isp_dg_clip_value_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dg_clip_value)
{
...
static __inline  HI_VOID isp_cc_colortone_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_cc_colortone_en)
{
...
static __inline  HI_VOID isp_cc_recover_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_cc_recover_en)
{
    U_ISP_CC_CFG o_isp_cc_cfg;
    o_isp_cc_cfg.u32 = pstBeReg->ISP_CC_CFG.u32;
...
static __inline  HI_VOID isp_4dg0_clip_value_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_4dg0_clip_value)
{
...
static __inline  HI_VOID isp_4dg1_clip_value_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_4dg1_clip_value)
{
...
static __inline  HI_VOID isp_ae_hnum_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_hnum)
{
...
static __inline  HI_VOID isp_ae_vnum_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_vnum)
{
    U_ISP_AE_ZONE o_isp_ae_zone;
    o_isp_ae_zone.u32 = pstBeReg->ISP_AE_ZONE.u32;
...
static __inline  HI_VOID isp_ae_skip_x_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_skip_x)
{
...
static __inline  HI_VOID isp_ae_offset_x_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_offset_x)
{
    U_ISP_AE_SKIP_CRG o_isp_ae_skip_crg;
    o_isp_ae_skip_crg.u32 = pstBeReg->ISP_AE_SKIP_CRG.u32;
...
static __inline  HI_VOID isp_ae_skip_y_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_skip_y)
{
    U_ISP_AE_SKIP_CRG o_isp_ae_skip_crg;
    o_isp_ae_skip_crg.u32 = pstBeReg->ISP_AE_SKIP_CRG.u32;
...
static __inline  HI_VOID isp_ae_offset_y_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_offset_y)
{
    U_ISP_AE_SKIP_CRG o_isp_ae_skip_crg;
    o_isp_ae_skip_crg.u32 = pstBeReg->ISP_AE_SKIP_CRG.u32;
...
static __inline  HI_VOID isp_ae_bitmove_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_bitmove)
{
...
static __inline  HI_VOID isp_ae_hist_gamma_mode_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_hist_gamma_mode)
{
    U_ISP_AE_BITMOVE o_isp_ae_bitmove;
    o_isp_ae_bitmove.u32 = pstBeReg->ISP_AE_BITMOVE.u32;
...
static __inline  HI_VOID isp_ae_aver_gamma_mode_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_aver_gamma_mode)
{
    U_ISP_AE_BITMOVE o_isp_ae_bitmove;
    o_isp_ae_bitmove.u32 = pstBeReg->ISP_AE_BITMOVE.u32;
...
static __inline  HI_VOID isp_ae_blc_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_blc_en)
{
    U_ISP_AE_BITMOVE o_isp_ae_bitmove;
    o_isp_ae_bitmove.u32 = pstBeReg->ISP_AE_BITMOVE.u32;
...
static __inline  HI_VOID isp_ae_gamma_limit_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_gamma_limit)
{
    U_ISP_AE_BITMOVE o_isp_ae_bitmove;
    o_isp_ae_bitmove.u32 = pstBeReg->ISP_AE_BITMOVE.u32;
...
static __inline  HI_VOID isp_ae_four_plane_mode_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_fourplanemode)
{
    U_ISP_AE_BITMOVE o_isp_ae_bitmove;
    o_isp_ae_bitmove.u32 = pstBeReg->ISP_AE_BITMOVE.u32;
...
static __inline  HI_VOID isp_ae_lut_update_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_lut_update)
{
...
static __inline  HI_VOID isp_ae_stt_size_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_stt_size)
{
...
static __inline  HI_VOID isp_ae_stt_bst_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_stt_bst)
{
    U_ISP_AE_STT_BST o_isp_ae_stt_bst;
    o_isp_ae_stt_bst.u32 = pstBeReg->ISP_AE_STT_BST.u32;
...
static __inline  HI_VOID isp_ae_stt_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_stt_en)
{
    U_ISP_AE_STT_BST o_isp_ae_stt_bst;
    o_isp_ae_stt_bst.u32 = pstBeReg->ISP_AE_STT_BST.u32;
...
static __inline  HI_VOID isp_ae_crop_pos_x_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_crop_pos_x)
{
...
static __inline  HI_VOID isp_ae_crop_pos_y_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_crop_pos_y)
{
    U_ISP_AE_CROP_POS o_isp_ae_crop_pos;
    o_isp_ae_crop_pos.u32 = pstBeReg->ISP_AE_CROP_POS.u32;
...
static __inline  HI_VOID isp_ae_crop_out_width_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_crop_out_width)
{
...
static __inline  HI_VOID isp_ae_crop_out_height_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ae_crop_out_height)
{
    U_ISP_AE_CROP_OUTSIZE o_isp_ae_crop_outsize;
    o_isp_ae_crop_outsize.u32 = pstBeReg->ISP_AE_CROP_OUTSIZE.u32;
...
static __inline  HI_VOID isp_awb_stt_size_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_awb_stt_size)
{
...
static __inline  HI_VOID isp_awb_stt_bst_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_awb_stt_bst)
{
    U_ISP_AWB_STT_BST o_isp_awb_stt_bst;
    o_isp_awb_stt_bst.u32 = pstBeReg->ISP_AWB_STT_BST.u32;
...
static __inline  HI_VOID isp_awb_stt_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_awb_stt_en)
{
    U_ISP_AWB_STT_BST o_isp_awb_stt_bst;
    o_isp_awb_stt_bst.u32 = pstBeReg->ISP_AWB_STT_BST.u32;
...
static __inline  HI_VOID isp_af_stt_size_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_af_stt_size)
{
...
static __inline  HI_VOID isp_af_stt_bst_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_af_stt_bst)
{
    U_ISP_AF_STT_BST o_isp_af_stt_bst;
    o_isp_af_stt_bst.u32 = pstBeReg->ISP_AF_STT_BST.u32;
...
static __inline  HI_VOID isp_af_stt_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_af_stt_en)
{
    U_ISP_AF_STT_BST o_isp_af_stt_bst;
    o_isp_af_stt_bst.u32 = pstBeReg->ISP_AF_STT_BST.u32;
...
static __inline  HI_VOID isp_la_hnum_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_la_hnum)
{
...
static __inline  HI_VOID isp_la_vnum_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_la_vnum)
{
    U_ISP_LA_ZONE o_isp_la_zone;
    o_isp_la_zone.u32 = pstBeReg->ISP_LA_ZONE.u32;
...
static __inline  HI_VOID isp_la_bitmove_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_la_bitmove)
{
...
static __inline  HI_VOID isp_la_gamma_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_la_gamma_en)
{
    U_ISP_LA_BITMOVE o_isp_la_bitmove;
    o_isp_la_bitmove.u32 = pstBeReg->ISP_LA_BITMOVE.u32;
...
static __inline  HI_VOID isp_la_blc_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_la_blc_en)
{
    U_ISP_LA_BITMOVE o_isp_la_bitmove;
    o_isp_la_bitmove.u32 = pstBeReg->ISP_LA_BITMOVE.u32;
...
static __inline  HI_VOID isp_la_gamma_limit_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_la_gamma_limit)
{
...
static __inline  HI_VOID isp_la_crop_pos_x_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_la_crop_pos_x)
{
...
static __inline  HI_VOID isp_la_crop_pos_y_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_la_crop_pos_y)
{
    U_ISP_LA_CROP_POS o_isp_la_crop_pos;
    o_isp_la_crop_pos.u32 = pstBeReg->ISP_LA_CROP_POS.u32;
...
static __inline  HI_VOID isp_la_crop_out_width_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_la_crop_out_width)
{
...
static __inline  HI_VOID isp_la_crop_out_height_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_la_crop_out_height)
{
    U_ISP_LA_CROP_OUTSIZE o_isp_la_crop_outsize;
    o_isp_la_crop_outsize.u32 = pstBeReg->ISP_LA_CROP_OUTSIZE.u32;
...
static __inline  HI_VOID isp_la_stt_size_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_la_stt_size)
{
...
static __inline  HI_VOID isp_la_stt_bst_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_la_stt_bst)
{
    U_ISP_LA_STT_BST o_isp_la_stt_bst;
    o_isp_la_stt_bst.u32 = pstBeReg->ISP_LA_STT_BST.u32;
...
static __inline  HI_VOID isp_la_stt_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_la_stt_en)
{
    U_ISP_LA_STT_BST o_isp_la_stt_bst;
    o_isp_la_stt_bst.u32 = pstBeReg->ISP_LA_STT_BST.u32;
...
static __inline  HI_VOID isp_lsc_mesh_str_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_lsc_mesh_str)
{
...
static __inline  HI_VOID isp_lsc_mesh_scale_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_lsc_mesh_scale)
{
    U_ISP_LSC_MESH o_isp_lsc_mesh;
    o_isp_lsc_mesh.u32 = pstBeReg->ISP_LSC_MESH.u32;
...
static __inline  HI_VOID isp_mlsc_mesh_str_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 isp_mlsc_mesh_str)
{
...
static __inline  HI_VOID isp_fpn_strength0_write(VI_PIPE ViPipe, BLK_DEV BlkDev, HI_U32 uisp_fpn_strength0)
{
...
static __inline  HI_VOID isp_fpn_overflowthr_write(VI_PIPE ViPipe, BLK_DEV BlkDev, HI_U32 uisp_fpn_overflowthr)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_VOID isp_dpc_line_aver_fac_1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_line_aver_fac_1)
{
...
static __inline  HI_VOID isp_dpc_line_diff_thr_1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_line_diff_thr_1)
{
    U_ISP_DPC_LCH_THR_1 o_isp_dpc_lch_thr_1;
    o_isp_dpc_lch_thr_1.u32 = pstBeReg->ISP_DPC_LCH_THR_1.u32;
...
static __inline  HI_VOID isp_dpc_line_std_thr_1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_line_std_thr_1)
{
    U_ISP_DPC_LCH_THR_1 o_isp_dpc_lch_thr_1;
    o_isp_dpc_lch_thr_1.u32 = pstBeReg->ISP_DPC_LCH_THR_1.u32;
...
static __inline  HI_VOID isp_dpc_line_aver_fac_2_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_line_aver_fac_2)
{
...
static __inline  HI_VOID isp_dpc_line_diff_thr_2_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_line_diff_thr_2)
{
    U_ISP_DPC_LCH_THR_2 o_isp_dpc_lch_thr_2;
    o_isp_dpc_lch_thr_2.u32 = pstBeReg->ISP_DPC_LCH_THR_2.u32;
...
static __inline  HI_VOID isp_dpc_line_std_thr_2_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_line_std_thr_2)
{
    U_ISP_DPC_LCH_THR_2 o_isp_dpc_lch_thr_2;
    o_isp_dpc_lch_thr_2.u32 = pstBeReg->ISP_DPC_LCH_THR_2.u32;
...
static __inline  HI_VOID isp_dpc_line_aver_fac_3_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_line_aver_fac_3)
{
...
static __inline  HI_VOID isp_dpc_line_diff_thr_3_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_line_diff_thr_3)
{
    U_ISP_DPC_LCH_THR_3 o_isp_dpc_lch_thr_3;
    o_isp_dpc_lch_thr_3.u32 = pstBeReg->ISP_DPC_LCH_THR_3.u32;
...
static __inline  HI_VOID isp_dpc_line_std_thr_3_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_line_std_thr_3)
{
    U_ISP_DPC_LCH_THR_3 o_isp_dpc_lch_thr_3;
    o_isp_dpc_lch_thr_3.u32 = pstBeReg->ISP_DPC_LCH_THR_3.u32;
...
static __inline  HI_VOID isp_dpc_line_aver_fac_4_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_line_aver_fac_4)
{
...
static __inline  HI_VOID isp_dpc_line_diff_thr_4_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_line_diff_thr_4)
{
    U_ISP_DPC_LCH_THR_4 o_isp_dpc_lch_thr_4;
    o_isp_dpc_lch_thr_4.u32 = pstBeReg->ISP_DPC_LCH_THR_4.u32;
...
static __inline  HI_VOID isp_dpc_line_std_thr_4_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_line_std_thr_4)
{
    U_ISP_DPC_LCH_THR_4 o_isp_dpc_lch_thr_4;
    o_isp_dpc_lch_thr_4.u32 = pstBeReg->ISP_DPC_LCH_THR_4.u32;
...
static __inline  HI_VOID isp_dpc_line_aver_fac_5_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_line_aver_fac_5)
{
...
static __inline  HI_VOID isp_dpc_line_diff_thr_5_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_line_diff_thr_5)
{
    U_ISP_DPC_LCH_THR_5 o_isp_dpc_lch_thr_5;
    o_isp_dpc_lch_thr_5.u32 = pstBeReg->ISP_DPC_LCH_THR_5.u32;
...
static __inline  HI_VOID isp_dpc_line_std_thr_5_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_line_std_thr_5)
{
    U_ISP_DPC_LCH_THR_5 o_isp_dpc_lch_thr_5;
    o_isp_dpc_lch_thr_5.u32 = pstBeReg->ISP_DPC_LCH_THR_5.u32;
...
static __inline  HI_VOID isp_dpc_line_kerdiff_fac_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_line_kerdiff_fac)
{
...
static __inline  HI_VOID isp_dpc_blend_mode_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_blend_mode)
{
...
static __inline  HI_VOID isp_dpc_bit_depth_sel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_bit_depth_sel)
{
...
static __inline  HI_VOID isp_dpc_output_mode_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U8 uisp_dpc_output_mode)
{
    pstBeReg->ISP_DPC_OUTPUT_MODE.u32 = uisp_dpc_output_mode & 0xF;
}
static __inline  HI_VOID isp_dpc_set_use_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U8 uisp_dpc_set_use)
{
    pstBeReg->ISP_DPC_SET_USE.u32 = uisp_dpc_set_use & 0xF;
}
static __inline  HI_VOID isp_dpc_bpt_ctrl_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_bpt_ctrl)
{
    pstBeReg->ISP_DPC_BPT_CTRL.u32 = uisp_dpc_bpt_ctrl;
}
static __inline  HI_VOID isp_dpc_mode_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U16  uisp_dpc_mode)
{
    pstBeReg->ISP_DPC_MODE.u32 = uisp_dpc_mode & 0x3FF;
}
static __inline  HI_VOID isp_dpc_methods_set_1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U16 uisp_dpc_method_set_1)
{
    pstBeReg->ISP_DPC_METHODS_SET_1.u32 = uisp_dpc_method_set_1 & 0x1F1F;
}
static __inline  HI_VOID isp_dpc_methods_set_2_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U16 uisp_dpc_method_set_2)
{
    pstBeReg->ISP_DPC_METHODS_SET_2.u32 = uisp_dpc_method_set_2 & 0x1F1F;
}
static __inline  HI_VOID isp_dpc_methods_set_3_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U16 uisp_dpc_method_set_3)
{
    pstBeReg->ISP_DPC_METHODS_SET_3.u32 = uisp_dpc_method_set_3 & 0x1F1F;
}
static __inline  HI_VOID isp_dpc_line_thresh_1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U16 uisp_dpc_line_thresh_1)
{
    pstBeReg->ISP_DPC_LINE_THRESH_1.u32 = uisp_dpc_line_thresh_1 & 0xFFFF;
}
static __inline  HI_VOID isp_dpc_line_mad_fac_1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U16 uisp_dpc_line_mad_fac_1)
{
...
static __inline  HI_VOID isp_dpc_pg_fac_1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U16 uisp_dpc_pg_fac_1)
{
...
static __inline  HI_VOID isp_dpc_rnd_thresh_1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U16 uisp_dpc_rnd_thresh_1)
{
    pstBeReg->ISP_DPC_RND_THRESH_1.u32 = uisp_dpc_rnd_thresh_1 & 0xFFFF;
}
static __inline  HI_VOID isp_dpc_rg_fac_1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_rg_fac_1)
{
...
static __inline  HI_VOID isp_dpc_line_thresh_2_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U16 uisp_dpc_line_thresh_2)
{
...
static __inline  HI_VOID isp_dpc_line_mad_fac_2_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U16 uisp_dpc_line_mad_fac_2)
{
...
static __inline  HI_VOID isp_dpc_pg_fac_2_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U16 uisp_dpc_pg_fac_2)
{
...
static __inline  HI_VOID isp_dpc_rnd_thresh_2_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U16 uisp_dpc_rnd_thresh_2)
{
...
static __inline  HI_VOID isp_dpc_rg_fac_2_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_rg_fac_2)
{
...
static __inline  HI_VOID isp_dpc_line_thresh_3_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U16 uisp_dpc_line_thresh_3)
{
...
*****************************************************/
#define HI_ISP_DPC_DEFAULT_LINE_MAD_FAC_3             (0x404)
static __inline  HI_VOID isp_dpc_line_mad_fac_3_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U16 uisp_dpc_line_mad_fac_3)
{
...
static __inline  HI_VOID isp_dpc_pg_fac_3_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U16 uisp_dpc_pg_fac_3)
{
...
static __inline  HI_VOID isp_dpc_rnd_thresh_3_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U16 uisp_dpc_rnd_thresh_3)
{
...
static __inline  HI_VOID isp_dpc_rg_fac_3_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_rg_fac_3)
{
...
static __inline  HI_VOID isp_dpc_rnd_thresh_1_mtp_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_rnd_thresh_1_mtp)
{
...
static __inline  HI_VOID isp_dpc_rnd_thresh_2_mtp_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_rnd_thresh_2_mtp)
{
...
static __inline  HI_VOID isp_dpc_rnd_thresh_3_mtp_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_rnd_thresh_3_mtp)
{
...
static __inline  HI_VOID isp_dpc_rg_fac_1_mtp_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_rg_fac_1_mtp)
{
...
static __inline  HI_VOID isp_dpc_rg_fac_2_mtp_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_rg_fac_2_mtp)
{
...
static __inline  HI_VOID isp_dpc_rg_fac_3_mtp_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_rg_fac_3_mtp)
{
...
static __inline  HI_VOID isp_dpc_ro_limits_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_ro_limits)
{
    pstBeReg->ISP_DPC_RO_LIMITS.u32 = uisp_dpc_ro_limits & 0xFFF;
}
static __inline  HI_VOID isp_dpc_rnd_offs_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_rnd_offs)
{
    pstBeReg->ISP_DPC_RND_OFFS.u32 = uisp_dpc_rnd_offs & 0xFFF;
}
static __inline  HI_VOID isp_dpc_blend_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dpc_alpha)
{
    pstBeReg->ISP_DPC_ALPHA.u32 = uisp_dpc_alpha;
}
static __inline  HI_VOID isp_demosaic_ahd_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_ahd_en)
{
...
static __inline  HI_VOID isp_demosaic_local_cac_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_local_cac_en)
{
    U_ISP_DEMOSAIC_CFG1 o_isp_demosaic_cfg1;
    o_isp_demosaic_cfg1.u32 = pstBeReg->ISP_DEMOSAIC_CFG1.u32;
...
static __inline  HI_VOID isp_demosaic_fcr_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_fcr_en)
{
    U_ISP_DEMOSAIC_CFG1 o_isp_demosaic_cfg1;
    o_isp_demosaic_cfg1.u32 = pstBeReg->ISP_DEMOSAIC_CFG1.u32;
...
static __inline  HI_VOID isp_demosaic_cac_cor_mode_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_cac_cor_mode)
{
    U_ISP_DEMOSAIC_CFG1 o_isp_demosaic_cfg1;
    o_isp_demosaic_cfg1.u32 = pstBeReg->ISP_DEMOSAIC_CFG1.u32;
...
static __inline  HI_VOID isp_demosaic_de_fake_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_de_fake_en)
{
    U_ISP_DEMOSAIC_CFG1 o_isp_demosaic_cfg1;
    o_isp_demosaic_cfg1.u32 = pstBeReg->ISP_DEMOSAIC_CFG1.u32;
...
static __inline  HI_VOID isp_demosaic_desat_enable_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_desat_enable)
{
    U_ISP_DEMOSAIC_CFG1 o_isp_demosaic_cfg1;
    o_isp_demosaic_cfg1.u32 = pstBeReg->ISP_DEMOSAIC_CFG1.u32;
...
static __inline  HI_VOID isp_demosaic_lpf_f0_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_lpf_f0)
{
...
static __inline  HI_VOID isp_demosaic_lpf_f1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_lpf_f1)
{
    U_ISP_DEMOSAIC_LPF_COEF o_isp_demosaic_lpf_coef;
    o_isp_demosaic_lpf_coef.u32 = pstBeReg->ISP_DEMOSAIC_LPF_COEF.u32;
...
static __inline  HI_VOID isp_demosaic_lpf_f2_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_lpf_f2)
{
    U_ISP_DEMOSAIC_LPF_COEF o_isp_demosaic_lpf_coef;
    o_isp_demosaic_lpf_coef.u32 = pstBeReg->ISP_DEMOSAIC_LPF_COEF.u32;
...
static __inline  HI_VOID isp_demosaic_lpf_f3_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_lpf_f3)
{
    U_ISP_DEMOSAIC_LPF_COEF o_isp_demosaic_lpf_coef;
    o_isp_demosaic_lpf_coef.u32 = pstBeReg->ISP_DEMOSAIC_LPF_COEF.u32;
...
static __inline  HI_VOID isp_demosaic_cbcr_ratio_low_limit_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_cbcr_ratio_low_limit)
{
...
static __inline  HI_VOID isp_demosaic_cbcr_ratio_high_limit_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_cbcr_ratio_high_limit)
{
    U_ISP_DEMOSAIC_CBCR_RATIO_LIMIT o_isp_demosaic_cbcr_ratio_limit;
    o_isp_demosaic_cbcr_ratio_limit.u32 = pstBeReg->ISP_DEMOSAIC_CBCR_RATIO_LIMIT.u32;
...
static __inline  HI_VOID isp_demosaic_cb_thr_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_cb_thr)
{
...
static __inline  HI_VOID isp_demosaic_luma_thr_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_luma_thr)
{
    U_ISP_DEMOSAIC_CAC_CBCR_THR o_isp_demosaic_cac_cbcr_thr;
    o_isp_demosaic_cac_cbcr_thr.u32 = pstBeReg->ISP_DEMOSAIC_CAC_CBCR_THR.u32;
...
static __inline  HI_VOID isp_demosaic_desat_hig_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_desat_hig)
{
...
static __inline  HI_VOID isp_demosaic_desat_low_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_desat_low)
{
    U_ISP_DEMOSAIC_DESAT_BLDR o_isp_demosaic_desat_bldr;
    o_isp_demosaic_desat_bldr.u32 = pstBeReg->ISP_DEMOSAIC_DESAT_BLDR.u32;
...
static __inline  HI_VOID isp_demosaic_desat_protect_sl_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_desat_protect_sl)
{
...
static __inline  HI_VOID isp_demosaic_desat_protect_th_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_desat_protect_th)
{
    U_ISP_DEMOSAIC_DESAT_PROTECT o_isp_demosaic_desat_protect;
    o_isp_demosaic_desat_protect.u32 = pstBeReg->ISP_DEMOSAIC_DESAT_PROTECT.u32;
...
static __inline  HI_VOID isp_demosaic_depurplut_update_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_demosaic_depurplut_update)
{
...
static __inline  HI_VOID isp_rgbir_blc_in_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_rgbir_blc_in_en)
{
...
static __inline  HI_VOID isp_rgbir_blc_out_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_rgbir_blc_out_en)
{
    U_ISP_RGBIR_CFG o_isp_rgbir_cfg;
    o_isp_rgbir_cfg.u32 = pstBeReg->ISP_RGBIR_CFG.u32;
...
static __inline  HI_VOID isp_rgbir_ir_pattern_in_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_rgbir_ir_pattern_in)
{
    U_ISP_RGBIR_CFG o_isp_rgbir_cfg;
    o_isp_rgbir_cfg.u32 = pstBeReg->ISP_RGBIR_CFG.u32;
...
static __inline  HI_VOID isp_rgbir_pattern_out_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_rgbir_pattern_out)
{
    U_ISP_RGBIR_CFG o_isp_rgbir_cfg;
    o_isp_rgbir_cfg.u32 = pstBeReg->ISP_RGBIR_CFG.u32;
...
static __inline  HI_VOID isp_sharpen_benlumactrl_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_benlumactrl)
{
...
static __inline  HI_VOID isp_sharpen_vcds_filterv_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_vcds_filterv)
{
    U_ISP_SHARPEN_CTRL o_isp_sharpen_ctrl;
    o_isp_sharpen_ctrl.u32 = pstBeReg->ISP_SHARPEN_CTRL.u32;
...
static __inline  HI_VOID isp_sharpen_benshtvar_sel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_benshtvar_sel)
{
    U_ISP_SHARPEN_CTRL o_isp_sharpen_ctrl;
    o_isp_sharpen_ctrl.u32 = pstBeReg->ISP_SHARPEN_CTRL.u32;
...
static __inline  HI_VOID isp_sharpen_benshtctrlbyvar_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_benshtctrlbyvar)
{
    U_ISP_SHARPEN_CTRL o_isp_sharpen_ctrl;
    o_isp_sharpen_ctrl.u32 = pstBeReg->ISP_SHARPEN_CTRL.u32;
...
static __inline  HI_VOID isp_sharpen_benskinctrl_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_benskinctrl)
{
    U_ISP_SHARPEN_CTRL o_isp_sharpen_ctrl;
    o_isp_sharpen_ctrl.u32 = pstBeReg->ISP_SHARPEN_CTRL.u32;
...
static __inline  HI_VOID isp_sharpen_weakdetailadj_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_weakdetailadj)
{
    U_ISP_SHARPEN_CTRL o_isp_sharpen_ctrl;
    o_isp_sharpen_ctrl.u32 = pstBeReg->ISP_SHARPEN_CTRL.u32;
...
static __inline  HI_VOID isp_sharpen_benchrctrl_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_benchrctrl)
{
    U_ISP_SHARPEN_CTRL o_isp_sharpen_ctrl;
    o_isp_sharpen_ctrl.u32 = pstBeReg->ISP_SHARPEN_CTRL.u32;
...
static __inline  HI_VOID isp_sharpen_detailthd_sel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_detailthd_sel)
{
    U_ISP_SHARPEN_CTRL o_isp_sharpen_ctrl;
    o_isp_sharpen_ctrl.u32 = pstBeReg->ISP_SHARPEN_CTRL.u32;
...
static __inline  HI_VOID isp_sharpen_bendetailctrl_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_bendetailctrl)
{
    U_ISP_SHARPEN_CTRL o_isp_sharpen_ctrl;
    o_isp_sharpen_ctrl.u32 = pstBeReg->ISP_SHARPEN_CTRL.u32;
...
static __inline  HI_VOID isp_sharpen_ben8dir_sel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_ben8dir_sel)
{
    U_ISP_SHARPEN_CTRL o_isp_sharpen_ctrl;
    o_isp_sharpen_ctrl.u32 = pstBeReg->ISP_SHARPEN_CTRL.u32;
...
static __inline  HI_VOID isp_sharpen_mhfthdsftd_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_mhfthdsftd)
{
...
static __inline  HI_VOID isp_sharpen_mhfthdseld_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_mhfthdseld)
{
    U_ISP_SHARPEN_MHFTHD o_isp_sharpen_mhfthd;
    o_isp_sharpen_mhfthd.u32 = pstBeReg->ISP_SHARPEN_MHFTHD.u32;
...
static __inline  HI_VOID isp_sharpen_mhfthdsftud_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_mhfthdsftud)
{
    U_ISP_SHARPEN_MHFTHD o_isp_sharpen_mhfthd;
    o_isp_sharpen_mhfthd.u32 = pstBeReg->ISP_SHARPEN_MHFTHD.u32;
...
static __inline  HI_VOID isp_sharpen_mhfthdselud_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_mhfthdselud)
{
    U_ISP_SHARPEN_MHFTHD o_isp_sharpen_mhfthd;
    o_isp_sharpen_mhfthd.u32 = pstBeReg->ISP_SHARPEN_MHFTHD.u32;
...
static __inline  HI_VOID isp_sharpen_dirrlythrlow_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_dirrlythrlow)
{
...
static __inline  HI_VOID isp_sharpen_dirrlythrhih_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_dirrlythrhih)
{
    U_ISP_SHARPEN_WEAKDETAIL o_isp_sharpen_weakdetail;
    o_isp_sharpen_weakdetail.u32 = pstBeReg->ISP_SHARPEN_WEAKDETAIL.u32;
...
static __inline  HI_VOID isp_sharpen_weakdetailgain_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_weakdetailgain)
{
    U_ISP_SHARPEN_WEAKDETAIL o_isp_sharpen_weakdetail;
    o_isp_sharpen_weakdetail.u32 = pstBeReg->ISP_SHARPEN_WEAKDETAIL.u32;
...
static __inline  HI_VOID isp_sharpen_dirvarsft_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_dirvarsft)
{
...
static __inline  HI_VOID isp_sharpen_dirvarscale_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_dirvarscale)
{
    U_ISP_SHARPEN_DIRVAR o_isp_sharpen_dirvar;
    o_isp_sharpen_dirvar.u32 = pstBeReg->ISP_SHARPEN_DIRVAR.u32;
...
static __inline  HI_VOID isp_sharpen_dirrly0_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_dirrly0)
{
    U_ISP_SHARPEN_DIRVAR o_isp_sharpen_dirvar;
    o_isp_sharpen_dirvar.u32 = pstBeReg->ISP_SHARPEN_DIRVAR.u32;
...
static __inline  HI_VOID isp_sharpen_dirrly1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_dirrly1)
{
    U_ISP_SHARPEN_DIRVAR o_isp_sharpen_dirvar;
    o_isp_sharpen_dirvar.u32 = pstBeReg->ISP_SHARPEN_DIRVAR.u32;
...
static __inline  HI_VOID isp_sharpen_dirdiffsft_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_dirdiffsft)
{
...
static __inline  HI_VOID isp_sharpen_dirrt0_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_dirrt0)
{
    U_ISP_SHARPEN_DIRDIFF o_isp_sharpen_dirdiff;
    o_isp_sharpen_dirdiff.u32 = pstBeReg->ISP_SHARPEN_DIRDIFF.u32;
...
static __inline  HI_VOID isp_sharpen_dirrt1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_dirrt1)
{
    U_ISP_SHARPEN_DIRDIFF o_isp_sharpen_dirdiff;
    o_isp_sharpen_dirdiff.u32 = pstBeReg->ISP_SHARPEN_DIRDIFF.u32;
...
static __inline  HI_VOID isp_sharpen_selpixwgt_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_selpixwgt)
{
...
static __inline  HI_VOID isp_sharpen_oshtamt_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_oshtamt)
{
    U_ISP_SHARPEN_SHOOT_AMT o_isp_sharpen_shoot_amt;
    o_isp_sharpen_shoot_amt.u32 = pstBeReg->ISP_SHARPEN_SHOOT_AMT.u32;
...
static __inline  HI_VOID isp_sharpen_ushtamt_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_ushtamt)
{
    U_ISP_SHARPEN_SHOOT_AMT o_isp_sharpen_shoot_amt;
    o_isp_sharpen_shoot_amt.u32 = pstBeReg->ISP_SHARPEN_SHOOT_AMT.u32;
...
static __inline  HI_VOID isp_sharpen_shtvarsft_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_shtvarsft)
{
...
static __inline  HI_VOID isp_sharpen_shtvar5x5_sft_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_shtvar5x5_sft)
{
    U_ISP_SHARPEN_SHTVAR o_isp_sharpen_shtvar;
    o_isp_sharpen_shtvar.u32 = pstBeReg->ISP_SHARPEN_SHTVAR.u32;
...
static __inline  HI_VOID isp_sharpen_shtbldrt_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_shtbldrt)
{
    U_ISP_SHARPEN_SHTVAR o_isp_sharpen_shtvar;
    o_isp_sharpen_shtvar.u32 = pstBeReg->ISP_SHARPEN_SHTVAR.u32;
...
static __inline  HI_VOID isp_sharpen_shtvarthd0_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_shtvarthd0)
{
...
static __inline  HI_VOID isp_sharpen_shtvarthd1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_shtvarthd1)
{
    U_ISP_SHARPEN_OSHTVAR o_isp_sharpen_oshtvar;
    o_isp_sharpen_oshtvar.u32 = pstBeReg->ISP_SHARPEN_OSHTVAR.u32;
...
static __inline  HI_VOID isp_sharpen_shtvarwgt0_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_shtvarwgt0)
{
    U_ISP_SHARPEN_OSHTVAR o_isp_sharpen_oshtvar;
    o_isp_sharpen_oshtvar.u32 = pstBeReg->ISP_SHARPEN_OSHTVAR.u32;
...
static __inline  HI_VOID isp_sharpen_shtvarwgt1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_shtvarwgt1)
{
    U_ISP_SHARPEN_OSHTVAR o_isp_sharpen_oshtvar;
    o_isp_sharpen_oshtvar.u32 = pstBeReg->ISP_SHARPEN_OSHTVAR.u32;
...
static __inline  HI_VOID isp_sharpen_shtvarmul_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_shtvarmul)
{
...
static __inline  HI_VOID isp_sharpen_shtvardiffmul_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_shtvardiffmul)
{
    U_ISP_SHARPEN_SHTVAR_MUL o_isp_sharpen_shtvar_mul;
    o_isp_sharpen_shtvar_mul.u32 = pstBeReg->ISP_SHARPEN_SHTVAR_MUL.u32;
...
static __inline  HI_VOID isp_sharpen_shtvardiffthd0_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_shtvardiffthd0)
{
...
static __inline  HI_VOID isp_sharpen_shtvardiffthd1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_shtvardiffthd1)
{
    U_ISP_SHARPEN_OSHTVARDIFF o_isp_sharpen_oshtvardiff;
    o_isp_sharpen_oshtvardiff.u32 = pstBeReg->ISP_SHARPEN_OSHTVARDIFF.u32;
...
static __inline  HI_VOID isp_sharpen_shtvardiffwgt0_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_shtvardiffwgt0)
{
    U_ISP_SHARPEN_OSHTVARDIFF o_isp_sharpen_oshtvardiff;
    o_isp_sharpen_oshtvardiff.u32 = pstBeReg->ISP_SHARPEN_OSHTVARDIFF.u32;
...
static __inline  HI_VOID isp_sharpen_shtvardiffwgt1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_shtvardiffwgt1)
{
    U_ISP_SHARPEN_OSHTVARDIFF o_isp_sharpen_oshtvardiff;
    o_isp_sharpen_oshtvardiff.u32 = pstBeReg->ISP_SHARPEN_OSHTVARDIFF.u32;
...
static __inline  HI_VOID isp_sharpen_skinedgesft_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_skinedgesft)
{
...
static __inline  HI_VOID isp_sharpen_skinedgemul_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_skinedgemul)
{
    U_ISP_SHARPEN_SKIN_EDGE o_isp_sharpen_skin_edge;
    o_isp_sharpen_skin_edge.u32 = pstBeReg->ISP_SHARPEN_SKIN_EDGE.u32;
...
static __inline  HI_VOID isp_sharpen_skinedgethd0_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_skinedgethd0)
{
...
static __inline  HI_VOID isp_sharpen_skinedgethd1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_skinedgethd1)
{
    U_ISP_SHARPEN_SKIN_EDGETHD o_isp_sharpen_skin_edgethd;
    o_isp_sharpen_skin_edgethd.u32 = pstBeReg->ISP_SHARPEN_SKIN_EDGETHD.u32;
...
static __inline  HI_VOID isp_sharpen_skinedgewgt0_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_skinedgewgt0)
{
    U_ISP_SHARPEN_SKIN_EDGETHD o_isp_sharpen_skin_edgethd;
    o_isp_sharpen_skin_edgethd.u32 = pstBeReg->ISP_SHARPEN_SKIN_EDGETHD.u32;
...
static __inline  HI_VOID isp_sharpen_skinedgewgt1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_skinedgewgt1)
{
    U_ISP_SHARPEN_SKIN_EDGETHD o_isp_sharpen_skin_edgethd;
    o_isp_sharpen_skin_edgethd.u32 = pstBeReg->ISP_SHARPEN_SKIN_EDGETHD.u32;
...
static __inline  HI_VOID isp_sharpen_chrrgain_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_chrrgain)
{
...
static __inline  HI_VOID isp_sharpen_rmfscale_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_rmfscale)
{
    U_ISP_SHARPEN_CHRR_GAIN o_isp_sharpen_chrr_gain;
    o_isp_sharpen_chrr_gain.u32 = pstBeReg->ISP_SHARPEN_CHRR_GAIN.u32;
...
static __inline  HI_VOID isp_sharpen_chrrmul_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_chrrmul)
{
    U_ISP_SHARPEN_CHRR_GAIN o_isp_sharpen_chrr_gain;
    o_isp_sharpen_chrr_gain.u32 = pstBeReg->ISP_SHARPEN_CHRR_GAIN.u32;
...
static __inline  HI_VOID isp_sharpen_chrbgain_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_chrbgain)
{
...
static __inline  HI_VOID isp_sharpen_bmfscale_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_bmfscale)
{
    U_ISP_SHARPEN_CHRB_GAIN o_isp_sharpen_chrb_gain;
    o_isp_sharpen_chrb_gain.u32 = pstBeReg->ISP_SHARPEN_CHRB_GAIN.u32;
...
static __inline  HI_VOID isp_sharpen_chrbmul_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_chrbmul)
{
    U_ISP_SHARPEN_CHRB_GAIN o_isp_sharpen_chrb_gain;
    o_isp_sharpen_chrb_gain.u32 = pstBeReg->ISP_SHARPEN_CHRB_GAIN.u32;
...
static __inline  HI_VOID isp_sharpen_osht_dtl_thd0_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_osht_dtl_thd0)
{
...
static __inline  HI_VOID isp_sharpen_osht_dtl_thd1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_osht_dtl_thd1)
{
    U_ISP_SHARPEN_OSHT_DETAIL o_isp_sharpen_osht_detail;
    o_isp_sharpen_osht_detail.u32 = pstBeReg->ISP_SHARPEN_OSHT_DETAIL.u32;
...
static __inline  HI_VOID isp_sharpen_osht_dtl_wgt_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_osht_dtl_wgt)
{
    U_ISP_SHARPEN_OSHT_DETAIL o_isp_sharpen_osht_detail;
    o_isp_sharpen_osht_detail.u32 = pstBeReg->ISP_SHARPEN_OSHT_DETAIL.u32;
...
static __inline  HI_VOID isp_sharpen_max_var_clip_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_max_var_clip)
{
    U_ISP_SHARPEN_OSHT_DETAIL o_isp_sharpen_osht_detail;
    o_isp_sharpen_osht_detail.u32 = pstBeReg->ISP_SHARPEN_OSHT_DETAIL.u32;
...
static __inline  HI_VOID isp_sharpen_usht_dtl_thd0_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_usht_dtl_thd0)
{
...
static __inline  HI_VOID isp_sharpen_usht_dtl_thd1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_usht_dtl_thd1)
{
    U_ISP_SHARPEN_USHT_DETAIL o_isp_sharpen_usht_detail;
    o_isp_sharpen_usht_detail.u32 = pstBeReg->ISP_SHARPEN_USHT_DETAIL.u32;
...
static __inline  HI_VOID isp_sharpen_usht_dtl_wgt_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_usht_dtl_wgt)
{
    U_ISP_SHARPEN_USHT_DETAIL o_isp_sharpen_usht_detail;
    o_isp_sharpen_usht_detail.u32 = pstBeReg->ISP_SHARPEN_USHT_DETAIL.u32;
...
static __inline  HI_VOID isp_sharpen_dtl_thdsft_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_dtl_thdsft)
{
    U_ISP_SHARPEN_USHT_DETAIL o_isp_sharpen_usht_detail;
    o_isp_sharpen_usht_detail.u32 = pstBeReg->ISP_SHARPEN_USHT_DETAIL.u32;
...
static __inline  HI_VOID isp_sharpen_stt2lut_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_stt2lut_en)
{
...
static __inline  HI_VOID isp_sharpen_stt2lut_regnew_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_sharpen_stt2lut_regnew)
{
...
static __inline  HI_VOID isp_nddm_dith_mask_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_nddm_dith_mask)
{
...
static __inline  HI_VOID isp_nddm_dith_ratio_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_nddm_dith_ratio)
{
    U_ISP_NDDM_DITHER_CFG o_isp_nddm_dither_cfg;
    o_isp_nddm_dither_cfg.u32 = pstBeReg->ISP_NDDM_DITHER_CFG.u32;
...
static __inline  HI_VOID isp_nddm_dith_max_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_nddm_dith_max)
{
    U_ISP_NDDM_DITHER_CFG o_isp_nddm_dither_cfg;
    o_isp_nddm_dither_cfg.u32 = pstBeReg->ISP_NDDM_DITHER_CFG.u32;
...
static __inline  HI_VOID isp_nddm_gf_lut_update_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_nddm_gf_lut_update)
{
...
static __inline  HI_VOID isp_bnr_jnlm_coringhig_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_jnlm_coringhig)
{
...
static __inline  HI_VOID isp_bnr_jnlm_gain_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_jnlm_gain)
{
    U_ISP_BNR_JNLM0 o_isp_bnr_jnlm0;
    o_isp_bnr_jnlm0.u32 = pstBeReg->ISP_BNR_JNLM0.u32;
...
static __inline  HI_VOID isp_bnr_jnlm_sel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_jnlm_sel)
{
    U_ISP_BNR_JNLM0 o_isp_bnr_jnlm0;
    o_isp_bnr_jnlm0.u32 = pstBeReg->ISP_BNR_JNLM0.u32;
...
static __inline  HI_VOID isp_bnr_lscbnrenable_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_lscbnrenable)
{
...
static __inline  HI_VOID isp_bnr_lscmaxgain_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_lscmaxgain)
{
    U_ISP_BNR_LSC_CTRL o_isp_bnr_lsc_ctrl;
    o_isp_bnr_lsc_ctrl.u32 = pstBeReg->ISP_BNR_LSC_CTRL.u32;
...
static __inline  HI_VOID isp_bnr_lsccmpstrength_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_lsccmpstrength)
{
    U_ISP_BNR_LSC_CTRL o_isp_bnr_lsc_ctrl;
    o_isp_bnr_lsc_ctrl.u32 = pstBeReg->ISP_BNR_LSC_CTRL.u32;
...
static __inline  HI_VOID isp_bnr_rlmt_blc_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_rlmt_blc)
{
...
static __inline  HI_VOID isp_bnr_rlmt_rgain_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_rlmt_rgain)
{
    U_ISP_BNR_CHROMA o_isp_bnr_chroma;
    o_isp_bnr_chroma.u32 = pstBeReg->ISP_BNR_CHROMA.u32;
...
static __inline  HI_VOID isp_bnr_rlmt_bgain_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_rlmt_bgain)
{
    U_ISP_BNR_CHROMA o_isp_bnr_chroma;
    o_isp_bnr_chroma.u32 = pstBeReg->ISP_BNR_CHROMA.u32;
...
static __inline  HI_VOID isp_bnr_windowsizesel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_windowsizesel)
{
...
static __inline  HI_VOID isp_bnr_pattern_noise_reduction_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_pattern_noise_reduction)
{
    U_ISP_BNR_LPFCTRL o_isp_bnr_lpfctrl;
    o_isp_bnr_lpfctrl.u32 = pstBeReg->ISP_BNR_LPFCTRL.u32;
...
static __inline  HI_VOID isp_bnr_gainsad_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_gainsad)
{
    U_ISP_BNR_LPFCTRL o_isp_bnr_lpfctrl;
    o_isp_bnr_lpfctrl.u32 = pstBeReg->ISP_BNR_LPFCTRL.u32;
...
static __inline  HI_VOID isp_bnr_implsnrenable1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_implsnrenable1)
{
    U_ISP_BNR_LPFCTRL o_isp_bnr_lpfctrl;
    o_isp_bnr_lpfctrl.u32 = pstBeReg->ISP_BNR_LPFCTRL.u32;
...
static __inline  HI_VOID isp_bnr_implsnrenable2_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_implsnrenable2)
{
    U_ISP_BNR_LPFCTRL o_isp_bnr_lpfctrl;
    o_isp_bnr_lpfctrl.u32 = pstBeReg->ISP_BNR_LPFCTRL.u32;
...
static __inline  HI_VOID isp_bnr_implsnrenable3_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_implsnrenable3)
{
    U_ISP_BNR_LPFCTRL o_isp_bnr_lpfctrl;
    o_isp_bnr_lpfctrl.u32 = pstBeReg->ISP_BNR_LPFCTRL.u32;
...
static __inline  HI_VOID isp_bnr_implsnrstrength_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_implsnrstrength)
{
    U_ISP_BNR_LPFCTRL o_isp_bnr_lpfctrl;
    o_isp_bnr_lpfctrl.u32 = pstBeReg->ISP_BNR_LPFCTRL.u32;
...
static __inline  HI_VOID isp_bnr_enablesymmsad_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_enablesymmsad)
{
    U_ISP_BNR_LPFCTRL o_isp_bnr_lpfctrl;
    o_isp_bnr_lpfctrl.u32 = pstBeReg->ISP_BNR_LPFCTRL.u32;
...
static __inline  HI_VOID isp_bnr_enablepostproc_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_enablepostproc)
{
    U_ISP_BNR_LPFCTRL o_isp_bnr_lpfctrl;
    o_isp_bnr_lpfctrl.u32 = pstBeReg->ISP_BNR_LPFCTRL.u32;
...
static __inline  HI_VOID isp_bnr_bilateral_enable_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_bilateral_enable)
{
    U_ISP_BNR_LPFCTRL o_isp_bnr_lpfctrl;
    o_isp_bnr_lpfctrl.u32 = pstBeReg->ISP_BNR_LPFCTRL.u32;
...
static __inline  HI_VOID isp_bnr_lumasel_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_lumasel)
{
    U_ISP_BNR_LPFCTRL o_isp_bnr_lpfctrl;
    o_isp_bnr_lpfctrl.u32 = pstBeReg->ISP_BNR_LPFCTRL.u32;
...
static __inline  HI_VOID isp_bnr_wdr_enable_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_wdr_enable)
{
...
static __inline  HI_VOID isp_bnr_wdr_enfusion_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_wdr_enfusion)
{
    U_ISP_BNR_WDRCTRL o_isp_bnr_wdrctrl;
    o_isp_bnr_wdrctrl.u32 = pstBeReg->ISP_BNR_WDRCTRL.u32;
...
static __inline  HI_VOID isp_bnr_wdr_mapfltmod_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_wdr_mapfltmod)
{
    U_ISP_BNR_WDRCTRL o_isp_bnr_wdrctrl;
    o_isp_bnr_wdrctrl.u32 = pstBeReg->ISP_BNR_WDRCTRL.u32;
...
static __inline  HI_VOID isp_bnr_wdr_mapgain_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_wdr_mapgain)
{
    U_ISP_BNR_WDRCTRL o_isp_bnr_wdrctrl;
    o_isp_bnr_wdrctrl.u32 = pstBeReg->ISP_BNR_WDRCTRL.u32;
...
static __inline  HI_VOID isp_bnr_stt2lut_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_stt2lut_en)
{
...
static __inline  HI_VOID isp_bnr_stt2lut_regnew_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_bnr_stt2lut_regnew)
{
...
static __inline  HI_VOID isp_mlsc_stt2lut_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_mlsc_stt2lut_en)
{
...
static __inline  HI_VOID isp_mlsc_stt2lut_regnew_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_mlsc_stt2lut_regnew)
{
...
static __inline  HI_VOID isp_mlsc_winx_info_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U8 index, HI_U16 uisp_mlsc_deltax, HI_U16 uisp_mlsc_invx)
{
...
static __inline  HI_VOID isp_mlsc_winy_info_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U8 index, HI_U16 uisp_mlsc_deltay, HI_U16 uisp_mlsc_invy)
{
...
static __inline  HI_VOID isp_mlsc_width_offset_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_mlsc_width_offset)
{
...
static __inline  HI_VOID isp_mlsc_mesh_scale_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_mlsc_mesh_scale)
{
    U_ISP_MLSC_MESH o_isp_mlsc_mesh;
    o_isp_mlsc_mesh.u32 = pstBeReg->ISP_MLSC_MESH.u32;
...
static __inline  HI_VOID isp_wdr_fusion_data_mode_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_wdr_fusion_data_mode)
{
...
static __inline  HI_VOID isp_wdr_erosion_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_wdr_erosion_en)
{
    U_ISP_WDR_CTRL o_isp_wdr_ctrl;
    o_isp_wdr_ctrl.u32 = pstBeReg->ISP_WDR_CTRL.u32;
...
static __inline  HI_VOID isp_wdr_grayscale_mode_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_wdr_grayscale_mode)
{
    U_ISP_WDR_CTRL o_isp_wdr_ctrl;
    o_isp_wdr_ctrl.u32 = pstBeReg->ISP_WDR_CTRL.u32;
...
static __inline  HI_VOID isp_wdr_outblc_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_wdr_outblc)
{
...
static __inline  HI_VOID isp_wdr_bsaveblc_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_wdr_bsaveblc)
{
    U_ISP_WDR_OUTBLC o_isp_wdr_outblc;
    o_isp_wdr_outblc.u32 = pstBeReg->ISP_WDR_OUTBLC.u32;
...
static __inline  HI_VOID isp_wdr_forcelong_high_thd_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_wdr_forcelong_high_thd)
{
...
static __inline  HI_VOID isp_wdr_forcelong_low_thd_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_wdr_forcelong_low_thd)
{
    U_ISP_WDR_FORCELONG_PARA o_isp_wdr_forcelong_para;
    o_isp_wdr_forcelong_para.u32 = pstBeReg->ISP_WDR_FORCELONG_PARA.u32;
...
static __inline  HI_VOID isp_wdr_forcelong_smooth_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_wdr_forcelong_smooth_en)
{
    U_ISP_WDR_FORCELONG_PARA o_isp_wdr_forcelong_para;
    o_isp_wdr_forcelong_para.u32 = pstBeReg->ISP_WDR_FORCELONG_PARA.u32;
...
static __inline  HI_VOID isp_wdr_forcelong_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_wdr_forcelong_en)
{
    U_ISP_WDR_FORCELONG_PARA o_isp_wdr_forcelong_para;
    o_isp_wdr_forcelong_para.u32 = pstBeReg->ISP_WDR_FORCELONG_PARA.u32;
...
static __inline  HI_VOID isp_wdr_shortchk_thd_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_wdr_shortchk_thd)
{
...
static __inline  HI_VOID isp_wdr_shortexpo_chk_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_wdr_shortexpo_chk)
{
    U_ISP_WDR_SHORTEXPO_CHK o_isp_wdr_shortexpo_chk;
    o_isp_wdr_shortexpo_chk.u32 = pstBeReg->ISP_WDR_SHORTEXPO_CHK.u32;
...
static __inline HI_VOID isp_wdr_mdt_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_wdr_mdt_en)
{
    U_ISP_WDR_CTRL o_isp_wdr_ctrl;
    o_isp_wdr_ctrl.u32 = pstBeReg->ISP_WDR_CTRL.u32;
...
static __inline HI_VOID isp_wdr_fusionmode_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_wdr_fusionmode)
{
    U_ISP_WDR_CTRL o_isp_wdr_ctrl;
    o_isp_wdr_ctrl.u32 = pstBeReg->ISP_WDR_CTRL.u32;
...
static __inline  HI_VOID isp_dehaze_stt_size_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dehaze_stt_size)
{
...
static __inline  HI_VOID isp_dehaze_stt_bst_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dehaze_stt_bst)
{
    U_ISP_DEHAZE_STT_BST o_isp_dehaze_stt_bst;
    o_isp_dehaze_stt_bst.u32 = pstBeReg->ISP_DEHAZE_STT_BST.u32;
...
static __inline  HI_VOID isp_dehaze_stt_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dehaze_stt_en)
{
    U_ISP_DEHAZE_STT_BST o_isp_dehaze_stt_bst;
    o_isp_dehaze_stt_bst.u32 = pstBeReg->ISP_DEHAZE_STT_BST.u32;
...
static __inline  HI_VOID isp_dehaze_stt2lut_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dehaze_stt2lut_en)
{
...
static __inline  HI_VOID isp_dehaze_stt2lut_regnew_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_dehaze_stt2lut_regnew)
{
...
static __inline  HI_VOID isp_gamma_stt2lut_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_gamma_stt2lut_en)
{
...
static __inline  HI_VOID isp_gamma_stt2lut_regnew_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_gamma_stt2lut_regnew)
{
...
static __inline  HI_VOID isp_ca_lumath_high_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ca_lumath_high)
{
    U_ISP_CA_LUMATH o_isp_ca_lumath;
    o_isp_ca_lumath.u32 = pstBeReg->ISP_CA_LUMATH.u32;
    o_isp_ca_lumath.bits.isp_ca_lumath_high = uisp_ca_lumath_high;
    pstBeReg->ISP_CA_LUMATH.u32 = o_isp_ca_lumath.u32;
}
static __inline  HI_VOID isp_ca_lumath_low_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ca_lumath_low)
{
    U_ISP_CA_LUMATH o_isp_ca_lumath;
    o_isp_ca_lumath.u32 = pstBeReg->ISP_CA_LUMATH.u32;
...
static __inline  HI_VOID isp_ca_lumaratio_high_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ca_lumaratio_high)
{
    U_ISP_CA_LLHC_RATIO o_isp_ca_llhc_ratio;
    o_isp_ca_llhc_ratio.u32 = pstBeReg->ISP_CA_LLHC_RATIO.u32;
    o_isp_ca_llhc_ratio.bits.isp_ca_lumaratio_high = uisp_ca_lumaratio_high;
    pstBeReg->ISP_CA_LLHC_RATIO.u32 = o_isp_ca_llhc_ratio.u32;
}
static __inline  HI_VOID isp_ca_lumaratio_low_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ca_lumaratio_low)
{
    U_ISP_CA_LLHC_RATIO o_isp_ca_llhc_ratio;
    o_isp_ca_llhc_ratio.u32 = pstBeReg->ISP_CA_LLHC_RATIO.u32;
...
static __inline  HI_VOID isp_ca_isoratio_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ca_isoratio)
{
...
static __inline  HI_VOID isp_ca_yraratio_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ca_yraratio)
{
...
static __inline  HI_VOID isp_ca_skin_betaratio_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ca_skin_betaratio)
{
...
static __inline  HI_VOID isp_ca_stt2lut_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ca_stt2lut_en)
{
...
static __inline  HI_VOID isp_ca_stt2lut_regnew_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ca_stt2lut_regnew)
{
...
static __inline HI_VOID isp_ldci_wrstat_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ldci_wrstat_en)
{
...
static __inline HI_VOID isp_ldci_rdstat_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ldci_rdstat_en)
{
    U_ISP_LDCI_CFG o_isp_ldci_cfg;
    o_isp_ldci_cfg.u32 = pstBeReg->ISP_LDCI_CFG.u32;
...
static __inline  HI_VOID isp_ldci_lpfstt_size_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ldci_lpfstt_size)
{
...
static __inline  HI_VOID isp_ldci_lpfstt_bst_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ldci_lpfstt_bst)
{
    U_ISP_LDCI_LPFSTT_BST o_isp_ldci_lpfstt_bst;
    o_isp_ldci_lpfstt_bst.u32 = pstBeReg->ISP_LDCI_LPFSTT_BST.u32;
...
static __inline  HI_VOID isp_ldci_lpfstt_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ldci_lpfstt_en)
{
    U_ISP_LDCI_LPFSTT_BST o_isp_ldci_lpfstt_bst;
    o_isp_ldci_lpfstt_bst.u32 = pstBeReg->ISP_LDCI_LPFSTT_BST.u32;
...
static __inline  HI_VOID isp_ldci_blc_ctrl_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ldci_blc_ctrl)
{
...
static __inline  HI_VOID isp_ldci_stt2lut_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ldci_stt2lut_en)
{
...
static __inline  HI_VOID isp_ldci_stt2lut_regnew_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_ldci_stt2lut_regnew)
{
...
static __inline  HI_VOID isp_drc_wrstat_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_drc_wrstat_en)
{
...
static __inline  HI_VOID isp_drc_rdstat_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_drc_rdstat_en)
{
    U_ISP_DRC_CFG o_isp_drc_cfg;
    o_isp_drc_cfg.u32 = pstBeReg->ISP_DRC_CFG.u32;
...
static __inline  HI_VOID isp_drc_vbiflt_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_drc_vbiflt_en)
{
    U_ISP_DRC_CFG o_isp_drc_cfg;
    o_isp_drc_cfg.u32 = pstBeReg->ISP_DRC_CFG.u32;
...
static __inline  HI_VOID isp_drc_color_corr_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_drc_color_corr_en)
{
    U_ISP_DRC_CFG o_isp_drc_cfg;
    o_isp_drc_cfg.u32 = pstBeReg->ISP_DRC_CFG.u32;
...
static __inline  HI_VOID isp_drc_mono_chroma_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_drc_mono_chroma_en)
{
    U_ISP_DRC_CFG o_isp_drc_cfg;
    o_isp_drc_cfg.u32 = pstBeReg->ISP_DRC_CFG.u32;
...
static __inline  HI_VOID isp_drc_pregamma_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_drc_pregamma_en)
{
    U_ISP_DRC_CFG o_isp_drc_cfg;
    o_isp_drc_cfg.u32 = pstBeReg->ISP_DRC_CFG.u32;
...
static __inline  HI_VOID isp_drc_dp_det_en_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_drc_dp_det_en)
{
    U_ISP_DRC_CFG o_isp_drc_cfg;
    o_isp_drc_cfg.u32 = pstBeReg->ISP_DRC_CFG.u32;
...
static __inline  HI_VOID isp_drc_lut_update0_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_drc_lut_update0)
{
...
static __inline  HI_VOID isp_drc_lut_update1_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_drc_lut_update1)
{
...
static __inline  HI_VOID isp_drc_strength_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 uisp_drc_strength)
{
...
static __inline  HI_VOID out0_crop_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uout0_crop_en)
{
...
static __inline  HI_VOID isp_be_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_be_en)
{
    U_ISP_VIPROC_CTRL0 o_viproc_ctrl0;
    o_viproc_ctrl0.u32 = pstViprocReg->VIPROC_CTRL0.u32;
...
static __inline  HI_VOID img_pro_mode_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uimg_pro_mode)
{
    U_ISP_VIPROC_CTRL0 o_viproc_ctrl0;
    o_viproc_ctrl0.u32 = pstViprocReg->VIPROC_CTRL0.u32;
...
static __inline  HI_VOID vcpin_sfifo_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uvcpin_sfifo_en)
{
    U_ISP_VIPROC_CTRL0 o_viproc_ctrl0;
    o_viproc_ctrl0.u32 = pstViprocReg->VIPROC_CTRL0.u32;
...
static __inline  HI_VOID wdr_fpn_mux_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uwdr_fpn_mux)
{
    U_ISP_VIPROC_CTRL0 o_viproc_ctrl0;
    o_viproc_ctrl0.u32 = pstViprocReg->VIPROC_CTRL0.u32;
...
static __inline  HI_VOID isp_dcg_fpn_sel_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 udcg_fpn_sel)
{
    U_ISP_VIPROC_CTRL0 o_viproc_ctrl0;
    o_viproc_ctrl0.u32 = pstViprocReg->VIPROC_CTRL0.u32;
...
static __inline  HI_VOID ch0_mux_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uch0_mux)
{
    U_ISP_VIPROC_CTRL0 o_viproc_ctrl0;
    o_viproc_ctrl0.u32 = pstViprocReg->VIPROC_CTRL0.u32;
...
static __inline  HI_VOID wdr_mode_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uwdr_mode)
{
    U_ISP_VIPROC_CTRL0 o_viproc_ctrl0;
    o_viproc_ctrl0.u32 = pstViprocReg->VIPROC_CTRL0.u32;
...
static __inline  HI_VOID video_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uvideo_en)
{
    U_ISP_VIPROC_CTRL0 o_viproc_ctrl0;
    o_viproc_ctrl0.u32 = pstViprocReg->VIPROC_CTRL0.u32;
...
static __inline  HI_VOID isp_be_reg_up_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 ureg_up)
{
...
static __inline  HI_VOID manual_reg_up_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 umanual_reg_up)
{
...
static __inline  HI_U32 viproc_reg_up_read(S_VIPROC_REGS_TYPE *pstViprocReg)
{
    return  pstViprocReg->VIPROC_REGUP.u32;
}

static __inline  HI_VOID isp_dpc_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_dpc_en)
{
...
static __inline  HI_VOID isp_dpc_stat_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_dpc_stat_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_ge_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_ge_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_4dg_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_4dg_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_wdr_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_wdr_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_expander_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_expander_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_bcom_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_bcom_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_bnr_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_bnr_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_bdec_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_bdec_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_lsc_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_lsc_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_dg_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_dg_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_af_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_af_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_awb_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_awb_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_ae_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_ae_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_wb_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_wb_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_blc_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_blc_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_pregamma_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_pregamma_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_drc_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_drc_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_la_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_la_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_sqrt_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_sqrt_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_dmnr_vhdm_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_dmnr_vhdm_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_dmnr_nddm_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_dmnr_nddm_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_rgbir_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_rgbir_en)
{
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    o_viproc_ispbe_ctrl0.u32 = pstViprocReg->VIPROC_ISPBE_CTRL0.u32;
...
static __inline  HI_VOID isp_sq_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_sq_en)
{
...
static __inline  HI_VOID isp_cc_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_cc_en)
{
    U_VIPROC_ISP_BE_CTRL1 o_viproc_ispbe_ctrl1;
    o_viproc_ispbe_ctrl1.u32 = pstViprocReg->VIPROC_ISPBE_CTRL1.u32;
...
static __inline  HI_VOID isp_sqrt1_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_sqrt1_en)
{
    U_VIPROC_ISP_BE_CTRL1 o_viproc_ispbe_ctrl1;
    o_viproc_ispbe_ctrl1.u32 = pstViprocReg->VIPROC_ISPBE_CTRL1.u32;
...
static __inline  HI_VOID isp_gamma_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_gamma_en)
{
    U_VIPROC_ISP_BE_CTRL1 o_viproc_ispbe_ctrl1;
    o_viproc_ispbe_ctrl1.u32 = pstViprocReg->VIPROC_ISPBE_CTRL1.u32;
...
static __inline  HI_VOID isp_dehaze_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_dehaze_en)
{
    U_VIPROC_ISP_BE_CTRL1 o_viproc_ispbe_ctrl1;
    o_viproc_ispbe_ctrl1.u32 = pstViprocReg->VIPROC_ISPBE_CTRL1.u32;
...
static __inline  HI_VOID isp_csc_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_csc_en)
{
    U_VIPROC_ISP_BE_CTRL1 o_viproc_ispbe_ctrl1;
    o_viproc_ispbe_ctrl1.u32 = pstViprocReg->VIPROC_ISPBE_CTRL1.u32;
...
static __inline  HI_VOID isp_sumy_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_sumy_en)
{
    U_VIPROC_ISP_BE_CTRL1 o_viproc_ispbe_ctrl1;
    o_viproc_ispbe_ctrl1.u32 = pstViprocReg->VIPROC_ISPBE_CTRL1.u32;
...
static __inline  HI_VOID isp_ldci_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_ldci_en)
{
    U_VIPROC_ISP_BE_CTRL1 o_viproc_ispbe_ctrl1;
    o_viproc_ispbe_ctrl1.u32 = pstViprocReg->VIPROC_ISPBE_CTRL1.u32;
...
static __inline  HI_VOID isp_ca_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_ca_en)
{
    U_VIPROC_ISP_BE_CTRL1 o_viproc_ispbe_ctrl1;
    o_viproc_ispbe_ctrl1.u32 = pstViprocReg->VIPROC_ISPBE_CTRL1.u32;
...
static __inline  HI_VOID isp_split_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_split_en)
{
    U_VIPROC_ISP_BE_CTRL1 o_viproc_ispbe_ctrl1;
    o_viproc_ispbe_ctrl1.u32 = pstViprocReg->VIPROC_ISPBE_CTRL1.u32;
...
static __inline  HI_VOID isp_sharpen_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_sharpen_en)
{
    U_VIPROC_ISP_BE_CTRL1 o_viproc_ispbe_ctrl1;
    o_viproc_ispbe_ctrl1.u32 = pstViprocReg->VIPROC_ISPBE_CTRL1.u32;
...
static __inline  HI_VOID isp_hcds_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_hcds_en)
{
    U_VIPROC_ISP_BE_CTRL1 o_viproc_ispbe_ctrl1;
    o_viproc_ispbe_ctrl1.u32 = pstViprocReg->VIPROC_ISPBE_CTRL1.u32;
...
static __inline  HI_VOID isp_vcds_en_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_vcds_en)
{
    U_VIPROC_ISP_BE_CTRL1 o_viproc_ispbe_ctrl1;
    o_viproc_ispbe_ctrl1.u32 = pstViprocReg->VIPROC_ISPBE_CTRL1.u32;
...
static __inline  HI_VOID isp_be_rggb_cfg_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_be_rggb_cfg)
{
...
static __inline  HI_VOID isp_be_timing_cfg_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_be_timing_cfg)
{
    U_VIPROC_ISP_BE_CFG o_viproc_ispbe_cfg;
    o_viproc_ispbe_cfg.u32 = pstViprocReg->VIPROC_ISPBE_CFG.u32;
...
static __inline  HI_VOID eof_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 ueof_mask)
{
...
static __inline  HI_VOID eof_end_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 ueof_end_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID timeout_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 utimeout_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID wbus_err_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uwbus_err_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID rbus_err_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 urbus_err_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID wrap_overflow_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uwrap_overflow_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID apb_err_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uapb_err_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID dcmp_err_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 udcmp_err_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID flow_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uflow_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID frm_err_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 ufrm_err_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID frm_start_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 ufrm_start_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID tunl_finish_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 utunl_finish_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID cfg_loss_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 ucfg_loss_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID load_lut_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uload_lut_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID ispbe_fstart_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uispbe_fstart_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID ispbe_update_cfg_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uispbe_update_cfg_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID ispbe_cfg_loss_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uispbe_cfg_loss_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID ispbe_ae_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uispbe_ae_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID ispbe_awb_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uispbe_awb_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID ispbe_af_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uispbe_af_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID ispbe_dis_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uispbe_dis_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID ispbe_ldci_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uispbe_ldci_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID ispbe_dehaze_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uispbe_dehaze_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID ispbe_flick_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uispbe_flick_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID ispbe_mg_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uispbe_mg_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID ispbe_drc_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uispbe_drc_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID ispbe_fpn_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uispbe_fpn_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID ispbe_dcg_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uispbe_dcg_mask)
{
    U_ISP_VIPROC_INTMASK o_viproc_intmask;
    o_viproc_intmask.u32 = pstViprocReg->VIPROC_INTMASK.u32;
...
static __inline  HI_VOID af_int_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uaf_int_mask)
{
...
static __inline  HI_VOID ae_int_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uae_int_mask)
{
    U_ISP_VIPROC_INT1MASK o_viproc_int1mask;
    o_viproc_int1mask.u32 = pstViprocReg->VIPROC_INT1MASK.u32;
...
static __inline  HI_VOID awb_int_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uawb_int_mask)
{
    U_ISP_VIPROC_INT1MASK o_viproc_int1mask;
    o_viproc_int1mask.u32 = pstViprocReg->VIPROC_INT1MASK.u32;
...
static __inline  HI_VOID dis_int_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 udis_int_mask)
{
    U_ISP_VIPROC_INT1MASK o_viproc_int1mask;
    o_viproc_int1mask.u32 = pstViprocReg->VIPROC_INT1MASK.u32;
...
static __inline  HI_VOID la_int_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 ula_int_mask)
{
    U_ISP_VIPROC_INT1MASK o_viproc_int1mask;
    o_viproc_int1mask.u32 = pstViprocReg->VIPROC_INT1MASK.u32;
...
static __inline  HI_VOID ge_int_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uge_int_mask)
{
    U_ISP_VIPROC_INT1MASK o_viproc_int1mask;
    o_viproc_int1mask.u32 = pstViprocReg->VIPROC_INT1MASK.u32;
...
static __inline  HI_VOID dehaze_int_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 udehaze_int_mask)
{
    U_ISP_VIPROC_INT1MASK o_viproc_int1mask;
    o_viproc_int1mask.u32 = pstViprocReg->VIPROC_INT1MASK.u32;
...
static __inline  HI_VOID flick_int_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uflick_int_mask)
{
    U_ISP_VIPROC_INT1MASK o_viproc_int1mask;
    o_viproc_int1mask.u32 = pstViprocReg->VIPROC_INT1MASK.u32;
...
static __inline  HI_VOID ldci_int_mask_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uldci_int_mask)
{
    U_ISP_VIPROC_INT1MASK o_viproc_int1mask;
    o_viproc_int1mask.u32 = pstViprocReg->VIPROC_INT1MASK.u32;
...
static __inline HI_VOID  viproc_para_drc_addr_low_write(S_VIPROC_REGS_TYPE *pstViProcReg, HI_U32 upara_drc_addr_low)
{
    pstViProcReg->PARA_DRC_ADDR_LOW.u32 = upara_drc_addr_low;
}

static __inline HI_VOID  viproc_para_dci_addr_low_write(S_VIPROC_REGS_TYPE *pstViProcReg, HI_U32 upara_dci_addr_low)
{
    pstViProcReg->PARA_DCI_ADDR_LOW.u32 = upara_dci_addr_low;
}

static __inline HI_VOID  viproc_out_para_drc_addr_low_write(S_VIPROC_REGS_TYPE *pstViProcReg, HI_U32 uout_para_drc_addr_low)
{
    pstViProcReg->OUT_PARA_DRC_ADDR_LOW.u32 = uout_para_drc_addr_low;
}

static __inline HI_VOID  viproc_out_para_dci_addr_low_write(S_VIPROC_REGS_TYPE *pstViProcReg, HI_U32 uout_para_dci_addr_low)
{
    pstViProcReg->OUT_PARA_DCI_ADDR_LOW.u32 = uout_para_dci_addr_low;
}

static __inline  HI_VOID isp_bnr_lut_addr_low_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_bnr_lut_addr_low)
{
    pstViprocReg->VIPROC_ISP_BNR_LUT_ADDR_LOW.u32 = uisp_bnr_lut_addr_low;
}
static __inline  HI_VOID isp_bnr_lut_width_word_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_bnr_lut_width_word)
{
...
static __inline  HI_VOID isp_lsc_lut_addr_low_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_lsc_lut_addr_low)
{
    pstViprocReg->VIPROC_ISP_LSC_LUT_ADDR_LOW.u32 = uisp_lsc_lut_addr_low;
}
static __inline  HI_VOID isp_lsc_lut_width_word_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_lsc_lut_width_word)
{
...
static __inline  HI_VOID isp_gamma_lut_addr_low_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_gamma_lut_addr_low)
{
    pstViprocReg->VIPROC_ISP_GAMMA_LUT_ADDR_LOW.u32 = uisp_gamma_lut_addr_low;
}
static __inline  HI_VOID isp_gamma_lut_width_word_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_gamma_lut_width_word)
{
...
static __inline  HI_VOID isp_dehaze_lut_addr_low_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_dehaze_lut_addr_low)
{
    pstViprocReg->VIPROC_ISP_DEHAZE_LUT_ADDR_LOW.u32 = uisp_dehaze_lut_addr_low;
}
static __inline  HI_VOID isp_dehaze_lut_width_word_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_dehaze_lut_width_word)
{
...
static __inline  HI_VOID isp_ldci_lut_addr_low_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_ldci_lut_addr_low)
{
    pstViprocReg->VIPROC_ISP_LDCI_LUT_ADDR_LOW.u32 = uisp_ldci_lut_addr_low;
}
static __inline  HI_VOID isp_ldci_lut_width_word_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_ldci_lut_width_word)
{
...
static __inline  HI_VOID isp_ca_lut_addr_low_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_ca_lut_addr_low)
{
    pstViprocReg->VIPROC_ISP_CA_LUT_ADDR_LOW.u32 = uisp_ca_lut_addr_low;
}
static __inline  HI_VOID isp_ca_lut_width_word_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_ca_lut_width_word)
{
...
static __inline  HI_VOID isp_sharpen_lut_addr_low_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_sharpen_lut_addr_low)
{
    pstViprocReg->VIPROC_ISP_SHARPEN_LUT_ADDR_LOW.u32 = uisp_sharpen_lut_addr_low;
}
static __inline  HI_VOID isp_sharpen_lut_width_word_write(S_VIPROC_REGS_TYPE *pstViprocReg, HI_U32 uisp_sharpen_lut_width_word)
{
...
static __inline  HI_U8 isp_fe_colorbar_en_read(VI_PIPE ViPipe)
{
...
static __inline  HI_U8 isp_fe_vsync_mode_read(VI_PIPE ViPipe)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
...
static __inline  HI_U8 isp_fe_rggb_cfg_read(VI_PIPE ViPipe)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
    U_ISP_FE_CTRL_F o_isp_fe_ctrl_f;
    ISP_CHECK_NULLPTR(pstFeReg);
...
static __inline  HI_U8 isp_fe_ae1_skip_x_read(VI_PIPE ViPipe)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
...
static __inline  HI_U8 isp_fe_ae1_offset_x_read(VI_PIPE ViPipe)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
    U_ISP_AE1_SKIP_CRG ISP_AE1_SKIP_CRG;
    ISP_CHECK_NULLPTR(pstFeReg);
...
static __inline  HI_U8 isp_fe_ae1_skip_y_read(VI_PIPE ViPipe)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
    U_ISP_AE1_SKIP_CRG ISP_AE1_SKIP_CRG;
    ISP_CHECK_NULLPTR(pstFeReg);
...
static __inline  HI_U8 isp_fe_ae1_offset_y_read(VI_PIPE ViPipe)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
    U_ISP_AE1_SKIP_CRG ISP_AE1_SKIP_CRG;
    ISP_CHECK_NULLPTR(pstFeReg);
...
static __inline  HI_U32 isp_fe_ae1_pixel_selected_count_read(HI_U8 ViPipe)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
...
static __inline  HI_U32 isp_fe_ae1_pixel_selected_weight_read(HI_U8 ViPipe)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
...
static __inline  HI_U32 isp_fe_ae1_hist_rdata_read(HI_U8 ViPipe)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
...
static __inline  HI_U32 isp_fe_ae1_aver_r_gr_rdata_read(HI_U8 ViPipe)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
...
static __inline  HI_U32 isp_fe_ae1_aver_gb_b_rdata_read(HI_U8 ViPipe)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
...
static __inline  HI_U32 isp_fe_ae1_wei_wdata_read(VI_PIPE ViPipe)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
    ISP_CHECK_NULLPTR(pstFeReg);
    return pstFeReg->ISP_AE1_WEIGHT_WDATA.u32;
}
static __inline  HI_U8 isp_fe_ae1_wei_raddr_write(VI_PIPE ViPipe, HI_U32 uisp_ae1_wei_raddr)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
    ISP_CHECK_NULLPTR(pstFeReg);
...
static __inline  HI_U32 isp_fe_ae1_wei_rdata_read(HI_U8 ViPipe)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
    ISP_CHECK_NULLPTR(pstFeReg);
    return pstFeReg->ISP_AE1_WEIGHT_RDATA.u32;
}
static __inline  HI_U16 isp_crop_width_out_read(VI_PIPE ViPipe)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
...
static __inline  HI_U16 isp_crop_height_out_read(VI_PIPE ViPipe)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
    U_ISP_CROP_SIZEOUT o_isp_crop_sizeout;
    ISP_CHECK_NULLPTR(pstFeReg);
...
static __inline  HI_U16 isp_crop_pos_x_read(VI_PIPE ViPipe)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
...
static __inline  HI_U16 isp_crop_pos_y_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPFE_REGS_TYPE *pstFeReg = (S_ISPFE_REGS_TYPE *)ISP_GetFeVirAddr(ViPipe);
    U_ISP_CROP_POS o_isp_crop_pos;
    ISP_CHECK_NULLPTR(pstFeReg);
...
static __inline  HI_U16 isp_wb_grgain_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U16 isp_wb_rgain_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
    U_ISP_WB_GAIN1 o_isp_wb_gain1;
    ISP_CHECK_NULLPTR(pstBeReg);
...
static __inline  HI_U16 isp_wb_gbgain_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U16 isp_wb_bgain_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
    U_ISP_WB_GAIN2 o_isp_wb_gain2;
    ISP_CHECK_NULLPTR(pstBeReg);
...
static __inline  HI_U16 isp_dg_ofsr_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U16 isp_dg_ofsb_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U8 isp_ae_skip_x_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U8 isp_ae_offset_x_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
    U_ISP_AE_SKIP_CRG ISP_AE_SKIP_CFG;
    ISP_CHECK_NULLPTR(pstBeReg);
...
static __inline  HI_U8 isp_ae_skip_y_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
    U_ISP_AE_SKIP_CRG ISP_AE_SKIP_CFG;
    ISP_CHECK_NULLPTR(pstBeReg);
...
static __inline  HI_U8 isp_ae_offset_y_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
    U_ISP_AE_SKIP_CRG ISP_AE_SKIP_CFG;
    ISP_CHECK_NULLPTR(pstBeReg);
...
static __inline  HI_U32 isp_ae_pixel_selected_count_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U32 isp_ae_pixel_selected_weight_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U32 isp_ae_total_r_aver_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U32 isp_ae_total_gr_aver_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U32 isp_ae_total_gb_aver_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U32 isp_ae_total_b_aver_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U8 isp_ae_four_plane_mode_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U32 isp_ae_hist_rdata_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U32 isp_ae_aver_r_gr_rdata_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U32 isp_ae_aver_gb_b_rdata_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U32 isp_ae_wei_wdata_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U32 isp_ae_wei_rdata_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U16 isp_awb_threshold_min_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U16 isp_awb_threshold_max_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U16 isp_awb_cr_ref_max_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U16 isp_awb_cr_ref_min_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
    U_ISP_AWB_CR_MM o_isp_awb_cr_mm;
    ISP_CHECK_NULLPTR(pstBeReg);
...
static __inline  HI_U16 isp_awb_cb_ref_max_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U16 isp_awb_cb_ref_min_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
    U_ISP_AWB_CB_MM o_isp_awb_cb_mm;
    ISP_CHECK_NULLPTR(pstBeReg);
...
static __inline  HI_U32 isp_awb_stat_rdata_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U16 isp_dpc_line_thresh_1_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
    ISP_CHECK_NULLPTR(pstBeReg);
    return (pstBeReg->ISP_DPC_LINE_THRESH_1.u32 & 0xFFFF);
}
static __inline  HI_U16 isp_dpc_line_mad_fac_1_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
    ISP_CHECK_NULLPTR(pstBeReg);
    return (pstBeReg->ISP_DPC_LINE_MAD_FAC_1.u32 & 0x3FFF);
}
static __inline  HI_U32 isp_dehaze_minstat_rdata_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U32 isp_dehaze_maxstat_rdata_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
...
static __inline  HI_U32 isp_dehaze_prestat_rdata_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
    ISP_CHECK_NULLPTR(pstBeReg);
    return pstBeReg->ISP_DEHAZE_PRESTAT_RDATA.u32;
}
static __inline  HI_U8 isp_drc_strength_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
    U_ISP_DRC_STRENGTH o_isp_drc_strength;
    ISP_CHECK_NULLPTR(pstBeReg);
...
static __inline  HI_U8 isp_fpn_en_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
...
static __inline  HI_U8 isp_dg_en_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_VIPROC_REGS_TYPE *pstViProcReg = (S_VIPROC_REGS_TYPE *)ISP_GetViProcVirAddr(ViPipe, BlkDev);
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    ISP_CHECK_NULLPTR(pstViProcReg);
...
static __inline  HI_U8 isp_drc_en_read(VI_PIPE ViPipe, BLK_DEV BlkDev)
{
    S_VIPROC_REGS_TYPE *pstViProcReg = (S_VIPROC_REGS_TYPE *)ISP_GetViProcVirAddr(ViPipe, BlkDev);
    U_VIPROC_ISP_BE_CTRL0 o_viproc_ispbe_ctrl0;
    ISP_CHECK_NULLPTR(pstViProcReg);
...
static __inline  HI_U32 isp_fpn_corr_gainoffset_read(VI_PIPE ViPipe, BLK_DEV BlkDev, HI_U8 index)
{
    S_ISPBE_REGS_TYPE *pstBeReg = (S_ISPBE_REGS_TYPE *)ISP_GetBeVirAddr(ViPipe, BlkDev);
    ISP_CHECK_NULLPTR(pstBeReg);
    switch (index) {
...
static __inline  HI_VOID isp_ae_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_ae_update_index)
{
    pstBeReg->reserved_0[0] = uisp_ae_update_index;
}
static __inline  HI_U32 isp_ae_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[0];
}
static __inline  HI_VOID isp_awb_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_awb_update_index)
{
    pstBeReg->reserved_0[1] = uisp_awb_update_index;
}
static __inline  HI_U32 isp_awb_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[1];
}
static __inline  HI_VOID isp_af_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_af_update_index)
{
    pstBeReg->reserved_0[2] = uisp_af_update_index;
}
static __inline  HI_U32 isp_af_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[2];
}
static __inline  HI_VOID isp_dpc_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_dpc_update_index)
{
    pstBeReg->reserved_0[3] = uisp_dpc_update_index;
}
static __inline  HI_U32 isp_dpc_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[3];
}
static __inline  HI_VOID isp_ge_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_ge_update_index)
{
    pstBeReg->reserved_0[4] = uisp_ge_update_index;
}
static __inline  HI_U32 isp_ge_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[4];
}
static __inline  HI_VOID isp_expander_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_expander_update_index)
{
    pstBeReg->reserved_0[5] = uisp_expander_update_index;
}
static __inline  HI_U32 isp_expander_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[5];
}
static __inline  HI_VOID isp_wdr_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_wdr_update_index)
{
    pstBeReg->reserved_0[6] = uisp_wdr_update_index;
}
static __inline  HI_U32 isp_wdr_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[6];
}
static __inline  HI_VOID isp_bayernr_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_bayernr_update_index)
{
    pstBeReg->reserved_0[7] = uisp_bayernr_update_index;
}
static __inline  HI_U32 isp_bayernr_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[7];
}
static __inline  HI_VOID isp_split_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_Split_update_index)
{
    pstBeReg->reserved_0[8] = uisp_Split_update_index;
}
static __inline  HI_U32 isp_split_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[8];
}
static __inline  HI_VOID isp_lsc_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_lsc_update_index)
{
    pstBeReg->reserved_0[9] = uisp_lsc_update_index;
}
static __inline  HI_U32 isp_lsc_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[9];
}
static __inline  HI_VOID isp_drc_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_drc_update_index)
{
    pstBeReg->reserved_0[10] = uisp_drc_update_index;
}
static __inline  HI_U32 isp_drc_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[10];
}
static __inline  HI_VOID isp_dehaze_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_dehaze_update_index)
{
    pstBeReg->reserved_0[11] = uisp_dehaze_update_index;
}
static __inline  HI_U32 isp_dehaze_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[11];
}
static __inline  HI_VOID isp_lcac_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_lcac_update_index)
{
    pstBeReg->reserved_0[12] = uisp_lcac_update_index;
}
static __inline  HI_U32 isp_lcac_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[12];
}
static __inline  HI_VOID isp_gcac_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_gcac_update_index)
{
    pstBeReg->reserved_0[13] = uisp_gcac_update_index;
}
static __inline  HI_U32 isp_gcac_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[13];
}
static __inline  HI_VOID isp_demosaic_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_demosaic_update_index)
{
    pstBeReg->reserved_0[14] = uisp_demosaic_update_index;
}
static __inline  HI_U32 isp_demosaic_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[14];
}
static __inline  HI_VOID isp_gamma_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_gamma_update_index)
{
    pstBeReg->reserved_0[15] = uisp_gamma_update_index;
}
static __inline  HI_U32 isp_gamma_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[15];
}
static __inline  HI_VOID isp_ca_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_ca_update_index)
{
    pstBeReg->reserved_0[16] = uisp_ca_update_index;
}
static __inline  HI_U32 isp_ca_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[16];
}
static __inline  HI_VOID isp_sharpen_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_sharpen_update_index)
{
    pstBeReg->reserved_0[17] = uisp_sharpen_update_index;
}
static __inline  HI_U32 isp_sharpen_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[17];
}
static __inline  HI_VOID isp_ldci_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_ldci_update_index)
{
    pstBeReg->reserved_0[18] = uisp_ldci_update_index;
}
static __inline  HI_U32 isp_ldci_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[18];
}
static __inline  HI_VOID isp_pregamma_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_pregamma_update_index)
{
    pstBeReg->reserved_0[19] = uisp_pregamma_update_index;
}
static __inline  HI_U32 isp_pregamma_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[19];
}
static __inline  HI_VOID isp_clut_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_clut_update_index)
{
    pstBeReg->reserved_0[20] = uisp_clut_update_index;
}
static __inline  HI_U32 isp_clut_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
    return pstBeReg->reserved_0[20];
}
static __inline  HI_VOID isp_rlsc_update_index_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32  uisp_rlsc_update_index)
{
    pstBeReg->reserved_0[21] = uisp_rlsc_update_index;
}
static __inline  HI_U32 isp_rlsc_update_index_read(S_ISPBE_REGS_TYPE *pstBeReg)
{
...
static __inline  HI_VOID hi_isp_slave_mode_configs_write(SLAVE_DEV SlaveDev, HI_U32 data)
{
    REG_BITS_MODIFY(IOWR_32DIRECT, IORD_32DIRECT, CAP_SLAVE_REG_BASE(SlaveDev) + 0x0, 31, 0, data);
}
static __inline  HI_U32 hi_isp_slave_mode_configs_read(SLAVE_DEV SlaveDev)
{
    return REG_BITS_READ(IOWR_32DIRECT, IORD_32DIRECT, CAP_SLAVE_REG_BASE(SlaveDev) + 0x0, 31, 0);
}
static __inline  HI_VOID hi_isp_slave_mode_vstime_low_write(SLAVE_DEV SlaveDev, HI_U32 data)
{
    REG_BITS_MODIFY(IOWR_32DIRECT, IORD_32DIRECT, CAP_SLAVE_REG_BASE(SlaveDev) + 0x8, 31, 0, data);
}
static __inline  HI_U32 hi_isp_slave_mode_vstime_low_read(SLAVE_DEV SlaveDev)
{
    return REG_BITS_READ(IOWR_32DIRECT, IORD_32DIRECT, CAP_SLAVE_REG_BASE(SlaveDev) + 0x8, 31, 0);
}
static __inline  HI_VOID hi_isp_slave_mode_vstime_high_write(SLAVE_DEV SlaveDev, HI_U32 data)
{
    REG_BITS_MODIFY(IOWR_32DIRECT, IORD_32DIRECT, CAP_SLAVE_REG_BASE(SlaveDev) + 0x4, 31, 0, data);
}
static __inline  HI_U32 hi_isp_slave_mode_vstime_high_read(SLAVE_DEV SlaveDev)
{
    return REG_BITS_READ(IOWR_32DIRECT, IORD_32DIRECT, CAP_SLAVE_REG_BASE(SlaveDev) + 0x4, 31, 0);
}
static __inline  HI_VOID hi_isp_slave_mode_hstime_write(SLAVE_DEV SlaveDev, HI_U32 data)
{
    REG_BITS_MODIFY(IOWR_32DIRECT, IORD_32DIRECT, CAP_SLAVE_REG_BASE(SlaveDev) + 0xc, 31, 0, data);
}
static __inline  HI_U32 hi_isp_slave_mode_hstime_read(SLAVE_DEV SlaveDev)
{
    return REG_BITS_READ(IOWR_32DIRECT, IORD_32DIRECT, CAP_SLAVE_REG_BASE(SlaveDev) + 0xc, 31, 0);
}
static __inline  HI_VOID hi_isp_slave_mode_vscyc_low_write(SLAVE_DEV SlaveDev, HI_U32 data)
{
    REG_BITS_MODIFY(IOWR_32DIRECT, IORD_32DIRECT, CAP_SLAVE_REG_BASE(SlaveDev) + 0x1c, 31, 0, data);
}
static __inline  HI_U32 hi_isp_slave_mode_vscyc_low_read(SLAVE_DEV SlaveDev)
{
    return REG_BITS_READ(IOWR_32DIRECT, IORD_32DIRECT, CAP_SLAVE_REG_BASE(SlaveDev) + 0x1c, 31, 0);
}
static __inline  HI_VOID hi_isp_slave_mode_vscyc_high_write(SLAVE_DEV SlaveDev, HI_U32 data)
{
    REG_BITS_MODIFY(IOWR_32DIRECT, IORD_32DIRECT, CAP_SLAVE_REG_BASE(SlaveDev) + 0x18, 31, 0, data);
}
static __inline  HI_U32 hi_isp_slave_mode_vscyc_high_read(SLAVE_DEV SlaveDev)
{
    return REG_BITS_READ(IOWR_32DIRECT, IORD_32DIRECT, CAP_SLAVE_REG_BASE(SlaveDev) + 0x18, 31, 0);
}
static __inline  HI_VOID hi_isp_slave_mode_hscyc_write(SLAVE_DEV SlaveDev, HI_U32 data)
{
    REG_BITS_MODIFY(IOWR_32DIRECT, IORD_32DIRECT, CAP_SLAVE_REG_BASE(SlaveDev) + 0x20, 31, 0, data);
}
static __inline  HI_U32 hi_isp_slave_mode_hscyc_read(SLAVE_DEV SlaveDev)
{
    return REG_BITS_READ(IOWR_32DIRECT, IORD_32DIRECT, CAP_SLAVE_REG_BASE(SlaveDev) + 0x20, 31, 0);
}
static __inline  HI_VOID hi_isp_slave_mode_time_cfg_select_write(SLAVE_DEV SlaveDev, HI_U32 data)
{
    switch (SlaveDev) {
        case 0:
...
static __inline  HI_U32 hi_isp_slave_mode_time_cfg_select_read(SLAVE_DEV SlaveDev)
{
    switch (SlaveDev) {
        case 0:
