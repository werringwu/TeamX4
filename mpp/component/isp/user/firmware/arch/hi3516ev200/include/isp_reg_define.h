...
typedef union {
    ...
    struct {
        ...
        unsigned int    isp_demosaic_cac_cb_cnt_high_thr : 7   ; /* [30..24]  */
        unsigned int    reserved_2            : 1   ; /* [31]  */
    } bits;
...
typedef struct {
    ...
    volatile U_ISP_DPC_RND_THRESH_1_MTP   ISP_DPC_RND_THRESH_1_MTP    ; /* 0x23c70 */
    volatile U_ISP_DPC_RND_THRESH_2_MTP   ISP_DPC_RND_THRESH_2_MTP    ; /* 0x23c74 */
    volatile U_ISP_DPC_RND_THRESH_3_MTP   ISP_DPC_RND_THRESH_3_MTP    ; /* 0x23c78 */
    ...
    volatile U_ISP_DEMOSAIC_PURPLE_VAR_THR   ISP_DEMOSAIC_PURPLE_VAR_THR ; /* 0x2402c */
    volatile U_ISP_DEMOSAIC_FAKE_CR_VAR_THR   ISP_DEMOSAIC_FAKE_CR_VAR_THR ; /* 0x24030 */
    volatile U_ISP_DEMOSAIC_DEPURPLECTR   ISP_DEMOSAIC_DEPURPLECTR    ; /* 0x24034 */
    volatile U_ISP_DEMOSAIC_LPF_COEF   ISP_DEMOSAIC_LPF_COEF          ; /* 0x24038 */
    volatile U_ISP_DEMOSAIC_G_INTP_CTRL   ISP_DEMOSAIC_G_INTP_CTRL    ; /* 0x2403c */
    volatile U_ISP_DEMOSAIC_CBCRAVGTHLD   ISP_DEMOSAIC_CBCRAVGTHLD    ; /* 0x24040 */
    volatile U_ISP_DEMOSAIC_CC_HF_RATIO   ISP_DEMOSAIC_CC_HF_RATIO    ; /* 0x24044 */
    volatile U_ISP_DEMOSAIC_GVAR_BLEND_THLD   ISP_DEMOSAIC_GVAR_BLEND_THLD ; /* 0x24048 */
    volatile U_ISP_DEMOSAIC_SATU_THR   ISP_DEMOSAIC_SATU_THR          ; /* 0x2404c */
    volatile U_ISP_DEMOSAIC_CBCR_RATIO_LIMIT   ISP_DEMOSAIC_CBCR_RATIO_LIMIT ; /* 0x24050 */
    volatile U_ISP_DEMOSAIC_FCR_GRAY_RATIO   ISP_DEMOSAIC_FCR_GRAY_RATIO ; /* 0x24054 */
    volatile U_ISP_DEMOSAIC_FCR_SEL   ISP_DEMOSAIC_FCR_SEL            ; /* 0x24058 */
    volatile U_ISP_DEMOSAIC_CC_VAR_THRESH   ISP_DEMOSAIC_CC_VAR_THRESH ; /* 0x2405c */
    volatile U_ISP_DEMOSAIC_HF_INTP_BLUR_TH   ISP_DEMOSAIC_HF_INTP_BLUR_TH ; /* 0x24060 */
    volatile U_ISP_DEMOSAIC_HF_INTP_BLUR_RATIO   ISP_DEMOSAIC_HF_INTP_BLUR_RATIO ; /* 0x24064 */
    volatile U_ISP_DEMOSAIC_CAC_CBCR_THR   ISP_DEMOSAIC_CAC_CBCR_THR  ; /* 0x24068 */
    volatile U_ISP_DEMOSAIC_CAC_LUMA_HIGH_CNT_THR   ISP_DEMOSAIC_CAC_LUMA_HIGH_CNT_THR ; /* 0x2406c */
    volatile U_ISP_DEMOSAIC_CAC_CNT_CFG   ISP_DEMOSAIC_CAC_CNT_CFG    ; /* 0x24070 */
    volatile U_ISP_DEMOSAIC_DEFCOLOR_COEF   ISP_DEMOSAIC_DEFCOLOR_COEF ; /* 0x24074 */
    volatile U_ISP_DEMOSAIC_CAC_BLD_AVG   ISP_DEMOSAIC_CAC_BLD_AVG    ; /* 0x24078 */
    ...
    volatile U_ISP_DEMOSAIC_DESAT_BLDR_RATIO   ISP_DEMOSAIC_DESAT_BLDR_RATIO ; /* 0x24108 */
    volatile U_ISP_DEMOSAIC_DESAT_PROTECT   ISP_DEMOSAIC_DESAT_PROTECT ; /* 0x2410c */
