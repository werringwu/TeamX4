...
static inline HI_VOID isp_bnr_lmt_even_wdata_u32_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 u32LutData)
{
...
static inline HI_VOID isp_bnr_lmt_odd_wdata_u32_write(S_ISPBE_REGS_TYPE *pstBeReg, HI_U32 lutData)
{
