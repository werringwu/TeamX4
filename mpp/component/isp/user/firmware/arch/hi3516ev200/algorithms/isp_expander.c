...
static HI_VOID ExpanderStaticRegsInitialize(VI_PIPE ViPipe, ISP_EXPANDER_STATIC_CFG_S *pstStaticRegCfg)
{
    ...
    if (pstSnsDft->unKey.bit1Expander) {
        ...
        memset(pstStaticRegCfg->au16Lut, 0, EXPANDER_NODE_NUM * sizeof(HI_U16));
    }
