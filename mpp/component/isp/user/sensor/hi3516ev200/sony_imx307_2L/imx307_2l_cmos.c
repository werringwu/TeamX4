...
******************************************************************************/
#if !defined(__IMX307_2L_CMOS_H_)
...
ISP_SNS_STATE_S *g_pastImx307_2l[ISP_MAX_PIPE_NUM] = {HI_NULL};

#define IMX307_2L_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastImx307_2l[dev])
#define IMX307_2L_SENSOR_SET_CTX(dev, pstCtx)   (g_pastImx307_2l[dev] = pstCtx)
#define IMX307_2L_SENSOR_RESET_CTX(dev)         (g_pastImx307_2l[dev] = HI_NULL)

ISP_SNS_COMMBUS_U g_aunImx307_2l_BusInfo[ISP_MAX_PIPE_NUM] = {
    [0] = { .s8I2cDev = 0},
...
typedef struct hiIMX307_2L_STATE_S {
    HI_U8       u8Hcg;
    HI_U32      u32BRL;
    HI_U32      u32RHS1_MAX;
    HI_U32      u32RHS2_MAX;
...
IMX307_2L_STATE_S g_astimx307_2l_State[ISP_MAX_PIPE_NUM] = {{0}};

/****************************************************************************
 * extern                                                                   *
 ****************************************************************************/
extern const unsigned int imx307_2l_i2c_addr;
extern unsigned int imx307_2l_addr_byte;
extern unsigned int imx307_2l_data_byte;
extern void imx307_2l_init(VI_PIPE ViPipe);
extern void imx307_2l_exit(VI_PIPE ViPipe);
extern void imx307_2l_standby(VI_PIPE ViPipe);
extern void imx307_2l_restart(VI_PIPE ViPipe);
extern int  imx307_2l_write_register(VI_PIPE ViPipe, int addr, int data);
extern int  imx307_2l_read_register(VI_PIPE ViPipe, int addr);
...
#define IMX307_INCREASE_LINES                  (1) /* make real fps less than stand fps because NVR require */
...
static HI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    IMX307_2L_SENSOR_GET_CTX(ViPipe, pstSnsState);
...
static HI_VOID cmos_fps_set(VI_PIPE ViPipe, HI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    switch (pstSnsState->u8ImgMode) {
        case IMX307_SENSOR_1080P_30FPS_2t1_WDR_MODE:
            if ((f32Fps <= 30) && (f32Fps >= 15.22)) {
                u32VMAX = IMX307_VMAX_1080P60TO30_WDR * 30 / DIV_0_TO_1_FLOAT(f32Fps);
            } else {
        ...
        case IMX307_SENSOR_1080P_30FPS_LINEAR_MODE:
            if ((f32Fps <= 30) && (f32Fps >= 0.12)) {
                u32VMAX = IMX307_VMAX_1080P30_LINEAR * 30 / DIV_0_TO_1_FLOAT(f32Fps);
            } else {
                ISP_TRACE(HI_DBG_ERR, "Not support Fps: %f\n", f32Fps);
                return;
            }
    ...
    if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
        ...
        pstSnsState->astRegsInfo[0].astI2cData[9].u32Data = HIGH_8BITS(u32VMAX);
        pstSnsState->astRegsInfo[0].astI2cData[10].u32Data = HIGHER_4BITS(u32VMAX);
    }
    ...
    if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
        ...
        */
        g_astimx307_2l_State[ViPipe].u32RHS1_MAX = (u32VMAX - g_astimx307_2l_State[ViPipe].u32BRL) * 2 - 21;
    } else {
                                       ...
                                       AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
        u32FullLines = (u32FullLines > 2 * IMX307_FULL_LINES_MAX_2TO1_WDR) ? 2 * IMX307_FULL_LINES_MAX_2TO1_WDR : u32FullLines;
        pstSnsState->au32FL[0] = (u32FullLines >> 1) << 1;
        g_astimx307_2l_State[ViPipe].u32RHS1_MAX = pstSnsState->au32FL[0] - g_astimx307_2l_State[ViPipe].u32BRL * 2 - 21;
    } else {
...
static HI_VOID cmos_inttime_update(VI_PIPE ViPipe, HI_U32 u32IntTime)
{
    ...
    if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
        if (bFirst[ViPipe]) { /* short exposure */
            ...
            pstSnsState->astRegsInfo[0].astI2cData[0].u32Data = LOW_8BITS(u32SHS1[ViPipe]);
            pstSnsState->astRegsInfo[0].astI2cData[1].u32Data = HIGH_8BITS(u32SHS1[ViPipe]);
            pstSnsState->astRegsInfo[0].astI2cData[2].u32Data = HIGHER_4BITS(u32SHS1[ViPipe]);

            pstSnsState->astRegsInfo[0].astI2cData[5].u32Data = LOW_8BITS(u32SHS2[ViPipe]);
            pstSnsState->astRegsInfo[0].astI2cData[6].u32Data = HIGH_8BITS(u32SHS2[ViPipe]);
            pstSnsState->astRegsInfo[0].astI2cData[7].u32Data = HIGHER_4BITS(u32SHS2[ViPipe]);
...
{
    ISP_SNS_STATE_S *pstSnsState = HI_NULL;
    HI_U32 u32HCG = g_astimx307_2l_State[ViPipe].u8Hcg;
    HI_U32 u32Tmp;
    ...
    if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
        ...
        */
        if (genFSWDRMode[ViPipe] == ISP_FSWDR_LONG_FRAME_MODE) {
            ...
            u32IntTimeMaxTmp = (u32IntTimeMaxTmp0 < u32IntTimeMaxTmp) ? u32IntTimeMaxTmp0 : u32IntTimeMaxTmp;
            u32IntTimeMaxTmp = (u32IntTimeMaxTmp > (g_astimx307_2l_State[ViPipe].u32RHS1_MAX - 3)) ? (g_astimx307_2l_State[ViPipe].u32RHS1_MAX - 3) : u32IntTimeMaxTmp;
...
static HI_S32 cmos_get_awb_default(VI_PIPE ViPipe, AWB_SENSOR_DEFAULT_S *pstAwbSnsDft)
{
    ...
    pstAwbSnsDft->au16GainOffset[0] = 0x1DF;
    pstAwbSnsDft->au16GainOffset[1] = 0x100;
    pstAwbSnsDft->au16GainOffset[2] = 0x100;
    pstAwbSnsDft->au16GainOffset[3] = 0x1DC;

    pstAwbSnsDft->as32WbPara[0] = -39;
    pstAwbSnsDft->as32WbPara[1] = 295;
    pstAwbSnsDft->as32WbPara[2] = 0;
    pstAwbSnsDft->as32WbPara[3] = 157585;
    pstAwbSnsDft->as32WbPara[4] = 128;
    pstAwbSnsDft->as32WbPara[5] = -105655;
...
static HI_VOID cmos_set_pixel_detect(VI_PIPE ViPipe, HI_BOOL bEnable)
{
    ...
    if (bEnable) { /* setup for ISP pixel calibration mode */
        imx307_2l_write_register(ViPipe, IMX307_GAIN_ADDR, 0x00);

        imx307_2l_write_register(ViPipe, IMX307_VMAX_ADDR, u32FullLines_5Fps & 0xFF);
        imx307_2l_write_register(ViPipe, IMX307_VMAX_ADDR + 1, (u32FullLines_5Fps & 0xFF00) >> 8);
        imx307_2l_write_register(ViPipe, IMX307_VMAX_ADDR + 2, (u32FullLines_5Fps & 0x30000) >> 16);

        imx307_2l_write_register(ViPipe, IMX307_SHS1_ADDR, u32MaxIntTime_5Fps & 0xFF);
        imx307_2l_write_register(ViPipe, IMX307_SHS1_ADDR + 1, (u32MaxIntTime_5Fps & 0xFF00) >> 8);
        imx307_2l_write_register(ViPipe, IMX307_SHS1_ADDR + 2, (u32MaxIntTime_5Fps & 0x30000) >> 16);

    } else { /* setup for ISP 'normal mode' */
        pstSnsState->u32FLStd = (pstSnsState->u32FLStd > 0x1FFFF) ? 0x1FFFF : pstSnsState->u32FLStd;
        imx307_2l_write_register(ViPipe, IMX307_VMAX_ADDR, pstSnsState->u32FLStd & 0xFF);
        imx307_2l_write_register(ViPipe, IMX307_VMAX_ADDR + 1, (pstSnsState->u32FLStd & 0xFF00) >> 8);
        imx307_2l_write_register(ViPipe, IMX307_VMAX_ADDR + 2, (pstSnsState->u32FLStd & 0x30000) >> 16);
...
static HI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_REGS_INFO_S *pstSnsRegsInfo)
{
    ...
    if ((pstSnsState->bSyncInit == HI_FALSE) || (pstSnsRegsInfo->bConfig == HI_FALSE)) {
        ...
        pstSnsState->astRegsInfo[0].unComBus.s8I2cDev = g_aunImx307_2l_BusInfo[ViPipe].s8I2cDev;
        ...
        for (i = 0; i < pstSnsState->astRegsInfo[0].u32RegNum; i++) {
            ...
            pstSnsState->astRegsInfo[0].astI2cData[i].u8DevAddr      = imx307_2l_i2c_addr;
            pstSnsState->astRegsInfo[0].astI2cData[i].u32AddrByteNum = imx307_2l_addr_byte;
            pstSnsState->astRegsInfo[0].astI2cData[i].u32DataByteNum = imx307_2l_data_byte;
        }
        ...
        pstSnsState->astRegsInfo[0].astI2cData[3].u32RegAddr = IMX307_GAIN_ADDR;  // gain
        ...
        if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
            ...
            pstSnsState->astRegsInfo[0].astI2cData[5].u8DelayFrmNum = 0;
            pstSnsState->astRegsInfo[0].astI2cData[5].u32RegAddr = IMX307_SHS2_ADDR;
            pstSnsState->astRegsInfo[0].astI2cData[6].u8DelayFrmNum = 0;
            pstSnsState->astRegsInfo[0].astI2cData[6].u32RegAddr = IMX307_SHS2_ADDR + 1;
            pstSnsState->astRegsInfo[0].astI2cData[7].u8DelayFrmNum = 0;
            pstSnsState->astRegsInfo[0].astI2cData[7].u32RegAddr = IMX307_SHS2_ADDR + 2;

            pstSnsState->astRegsInfo[0].astI2cData[8].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[8].u32RegAddr = IMX307_VMAX_ADDR;
            pstSnsState->astRegsInfo[0].astI2cData[9].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[9].u32RegAddr = IMX307_VMAX_ADDR + 1;
            pstSnsState->astRegsInfo[0].astI2cData[10].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[10].u32RegAddr = IMX307_VMAX_ADDR + 2;

            pstSnsState->astRegsInfo[0].astI2cData[11].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[11].u32RegAddr = IMX307_RHS1_ADDR;
            pstSnsState->astRegsInfo[0].astI2cData[12].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[12].u32RegAddr = IMX307_RHS1_ADDR + 1;
            pstSnsState->astRegsInfo[0].astI2cData[13].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[13].u32RegAddr = IMX307_RHS1_ADDR + 2;

            pstSnsState->astRegsInfo[0].astI2cData[14].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[14].u32RegAddr = IMX307_Y_OUT_SIZE_ADDR;
            pstSnsState->astRegsInfo[0].astI2cData[15].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[15].u32RegAddr = IMX307_Y_OUT_SIZE_ADDR + 1;
        }
    ...
    if (pstSensorImageMode->f32Fps <= 30) {
        if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
            ...
            if (IMX307_RES_IS_1080P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
                ...
                g_astimx307_2l_State[ViPipe].u32BRL = 1109;
                g_astimx307_2l_State[ViPipe].u8Hcg  = 0x1;
                pstSnsState->u32FLStd               = IMX307_VMAX_1080P60TO30_WDR * 2;
            } else {
                IMX307_2L_ERR_MODE_PRINT(pstSensorImageMode, pstSnsState);
                return HI_FAILURE;
            }
...
static HI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
    ...
    pstSensorExpFunc->pfn_cmos_sensor_init = imx307_2l_init;
    pstSensorExpFunc->pfn_cmos_sensor_exit = imx307_2l_exit;
...
static HI_S32 imx307_2l_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
    g_aunImx307_2l_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static HI_S32 sensor_ctx_init(VI_PIPE ViPipe)
{
    ...
    IMX307_2L_SENSOR_SET_CTX(ViPipe, pastSnsStateCtx);
...
static HI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
    ...
    s32Ret = HI_MPI_ISP_SensorUnRegCallBack(ViPipe, IMX307_ID);
    if (s32Ret != HI_SUCCESS) {
        ISP_TRACE(HI_DBG_ERR, "sensor unregister callback function failed!\n");
        return s32Ret;
    }

    s32Ret = HI_MPI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, IMX307_ID);
    if (s32Ret != HI_SUCCESS) {
        ISP_TRACE(HI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
        return s32Ret;
    }

    s32Ret = HI_MPI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, IMX307_ID);
    if (s32Ret != HI_SUCCESS) {
...
ISP_SNS_OBJ_S stSnsImx307_2l_Obj = {
    .pfnRegisterCallback    = sensor_register_callback,
    .pfnUnRegisterCallback  = sensor_unregister_callback,
    .pfnStandby             = imx307_2l_standby,
    .pfnRestart             = imx307_2l_restart,
    .pfnMirrorFlip          = HI_NULL,
    .pfnWriteReg            = imx307_2l_write_register,
    .pfnReadReg             = imx307_2l_read_register,
    .pfnSetBusInfo          = imx307_2l_set_bus_info,
