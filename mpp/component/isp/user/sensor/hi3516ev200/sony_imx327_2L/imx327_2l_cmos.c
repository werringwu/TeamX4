...
ISP_SNS_STATE_S *g_pastImx327_2l[ISP_MAX_PIPE_NUM] = {HI_NULL};

#define IMX327_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastImx327_2l[dev])
#define IMX327_SENSOR_SET_CTX(dev, pstCtx)   (g_pastImx327_2l[dev] = pstCtx)
#define IMX327_SENSOR_RESET_CTX(dev)         (g_pastImx327_2l[dev] = HI_NULL)

ISP_SNS_COMMBUS_U g_aunImx327_2l_BusInfo[ISP_MAX_PIPE_NUM] = {
    [0] = { .s8I2cDev = 0},
...
extern const unsigned int imx327_2l_i2c_addr;
extern unsigned int imx327_2l_addr_byte;
extern unsigned int imx327_2l_data_byte;
...
IMX327_STATE_S g_astimx327_2l_State[ISP_MAX_PIPE_NUM] = {{0}};
...
#define IMX327_2L_ERR_MODE_PRINT(pstSensorImageMode, pstSnsState)\
    do{\
...
static HI_VOID cmos_slow_framerate_set(VI_PIPE ViPipe, HI_U32 u32FullLines, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
        ...
        g_astimx327_2l_State[ViPipe].u32RHS1_MAX = pstSnsState->au32FL[0] - g_astimx327_2l_State[ViPipe].u32BRL * 2 - 21;
...
static HI_VOID cmos_inttime_update(VI_PIPE ViPipe, HI_U32 u32IntTime)
{
    ...
    if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
        if (bFirst[ViPipe]) { /* short exposure */
            ...
            if (pstSnsState->u8ImgMode == IMX327_SENSOR_1080P_30FPS_WDR_2to1_MODE) {
...
{
    ISP_SNS_STATE_S *pstSnsState = HI_NULL;
    HI_U32 u32HCG = g_astimx327_2l_State[ViPipe].u8Hcg;
    HI_U32 u32Tmp;
    ...
    if (pstSnsState->enWDRMode == WDR_MODE_2To1_FRAME) {
        ...
        */
        if (genFSWDRMode[ViPipe] == ISP_FSWDR_LONG_FRAME_MODE) {
            ...
            u32IntTimeMaxTmp  = (u32IntTimeMaxTmp0 < u32IntTimeMaxTmp) ? u32IntTimeMaxTmp0 : u32IntTimeMaxTmp;
            u32IntTimeMaxTmp  = (u32IntTimeMaxTmp > (g_astimx327_2l_State[ViPipe].u32RHS1_MAX - 3)) ? (g_astimx327_2l_State[ViPipe].u32RHS1_MAX - 3) : u32IntTimeMaxTmp;
...
static HI_VOID cmos_set_pixel_detect(VI_PIPE ViPipe, HI_BOOL bEnable)
{
    ...
    if (bEnable) { /* setup for ISP pixel calibration mode */
        imx327_2l_write_register(ViPipe, IMX327_GAIN_ADDR, 0x00);

        imx327_2l_write_register(ViPipe, IMX327_VMAX_ADDR, u32FullLines_5Fps & 0xFF);
        imx327_2l_write_register(ViPipe, IMX327_VMAX_ADDR + 1, (u32FullLines_5Fps & 0xFF00) >> 8);
        imx327_2l_write_register(ViPipe, IMX327_VMAX_ADDR + 2, (u32FullLines_5Fps & 0xF0000) >> 16);

        imx327_2l_write_register(ViPipe, IMX327_SHS1_ADDR, u32MaxIntTime_5Fps & 0xFF);
        imx327_2l_write_register(ViPipe, IMX327_SHS1_ADDR + 1, (u32MaxIntTime_5Fps & 0xFF00) >> 8);
        imx327_2l_write_register(ViPipe, IMX327_SHS1_ADDR + 2, (u32MaxIntTime_5Fps & 0xF0000) >> 16);

    } else { /* setup for ISP 'normal mode' */
        pstSnsState->u32FLStd = (pstSnsState->u32FLStd > 0x1FFFF) ? 0x1FFFF : pstSnsState->u32FLStd;
        imx327_2l_write_register(ViPipe, IMX327_VMAX_ADDR, pstSnsState->u32FLStd & 0xFF);
        imx327_2l_write_register(ViPipe, IMX327_VMAX_ADDR + 1, (pstSnsState->u32FLStd & 0xFF00) >> 8);
        imx327_2l_write_register(ViPipe, IMX327_VMAX_ADDR + 2, (pstSnsState->u32FLStd & 0xF0000) >> 16);
...
static HI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_REGS_INFO_S *pstSnsRegsInfo)
{
    ...
    if ((pstSnsState->bSyncInit == HI_FALSE) || (pstSnsRegsInfo->bConfig == HI_FALSE)) {
        ...
        pstSnsState->astRegsInfo[0].unComBus.s8I2cDev = g_aunImx327_2l_BusInfo[ViPipe].s8I2cDev;
        ...
        for (i = 0; i < pstSnsState->astRegsInfo[0].u32RegNum; i++) {
            ...
            pstSnsState->astRegsInfo[0].astI2cData[i].u8DevAddr = imx327_2l_i2c_addr;
            pstSnsState->astRegsInfo[0].astI2cData[i].u32AddrByteNum = imx327_2l_addr_byte;
            pstSnsState->astRegsInfo[0].astI2cData[i].u32DataByteNum = imx327_2l_data_byte;
        }
    ...
    if (pstSensorImageMode->f32Fps <= 30) {
        if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
            if (IMX327_RES_IS_1080P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
                ...
                g_astimx327_2l_State[ViPipe].u8Hcg = 0x2;
            } else {
                IMX327_2L_ERR_MODE_PRINT(pstSensorImageMode, pstSnsState);
                return HI_FAILURE;
            }
        } else if (pstSnsState->enWDRMode == WDR_MODE_2To1_FRAME) {
            if (IMX327_RES_IS_1080P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
            ...
            if (IMX327_RES_IS_1080P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
                ...
                g_astimx327_2l_State[ViPipe].u32BRL = 1109;
                g_astimx327_2l_State[ViPipe].u8Hcg  = 0x1;
                pstSnsState->u32FLStd               = IMX327_VMAX_1080P60TO30_WDR * 2;
            } else {
                IMX327_2L_ERR_MODE_PRINT(pstSensorImageMode, pstSnsState);
                return HI_FAILURE;
...
static HI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
    ...
    pstSensorExpFunc->pfn_cmos_sensor_init = imx327_2l_init;
    pstSensorExpFunc->pfn_cmos_sensor_exit = imx327_2l_exit;
...
{
    g_aunImx327_2l_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
ISP_SNS_OBJ_S stSnsImx327_2l_Obj = {
    .pfnRegisterCallback    = sensor_register_callback,
    .pfnUnRegisterCallback  = sensor_unregister_callback,
    .pfnStandby             = imx327_2l_standby,
    .pfnRestart             = imx327_2l_restart,
    .pfnMirrorFlip          = HI_NULL,
    .pfnWriteReg            = imx327_2l_write_register,
    .pfnReadReg             = imx327_2l_read_register,
