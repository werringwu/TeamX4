...
static HI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    switch (pstSnsState->enWDRMode) {
        ...
        case WDR_MODE_2To1_LINE:
            ...
            pstAeSnsDft->u32InitExposure = g_au32InitExposure[ViPipe] ? g_au32InitExposure[ViPipe] : 270762;
...
{
    ISP_SNS_STATE_S *pstSnsState = HI_NULL;
    HI_U32 u32HCG = g_astimx307State[ViPipe].u8Hcg;
    HI_U32 u32Tmp;
...
static HI_VOID cmos_get_inttime_max(VI_PIPE ViPipe, HI_U16 u16ManRatioEnable, HI_U32 *au32Ratio, HI_U32 *au32IntTimeMax, HI_U32 *au32IntTimeMin, HI_U32 *pu32LFMaxIntTime)
{
    ...
    u32ShortTimeMinLimit = (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) ? 2 : ((pstSnsState->enWDRMode == WDR_MODE_3To1_LINE) ? 3 : 2);
...
static HI_S32 imx307_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
