...
typedef struct hiISP_LDCI_STAT_S {
    HI_U32  au32GlobalMap[LDCI_STAT_WND_Y][LDCI_STAT_WND_X];
} ISP_LDCI_STAT_S;
...
typedef struct hiISP_AF_REG_CFG_S {
    ...
    HI_U16 u16OffsetGr;
    HI_U16 u16OffsetGb;
    HI_U16 u16InputVsize;
    HI_U16 u16InputHsize;
...
typedef struct hiISP_DRC_USR_CFG_S {
    ...
    HI_BOOL bDpDetectG2RB;
    HI_BOOL bDpDetectRB2RB;
    HI_BOOL bDpDetectReplCtr;
    HI_U8   u8DpDetectRngRatio;
...
#define HI_ISP_PREGAMMA_SEG_NUM         (12)
typedef struct hiISP_PREGAMMA_STATIC_CFG_S {
    HI_BOOL bStaticResh;
    HI_U16  au16SegMaxVal[HI_ISP_PREGAMMA_SEG_NUM];
    HI_U8   au8SegIdxBase[HI_ISP_PREGAMMA_SEG_NUM];
...
typedef struct hiISP_PREGAMMA_DYNA_CFG_S {
    ...
    HI_U8   u8BufId;
    HI_U32  u32UpdateIndex;
    HI_U16  au16PreGammaLUT[PREGAMMA_NODE_NUM];  // u16.0
...
typedef struct hiISP_DEHAZE_DYNA_CFG_S {
    ...
    HI_U16 u16DehazeThldR;
    HI_U16 u16DehazeThldG;
    HI_U16 u16DehazeThldB;
...
typedef struct hiISP_DPC_DYNA_CFG_S {
    ...
    HI_U16  au16DpccLineStdThr[5]; // u12.0
    ...
    HI_U32  au32DpccRndThrMtp[3];   // U32.0
    HI_U16  au16DpccRgFac[3];       // U14.0
    HI_U32  au32DpccRgFacMtp[3];    // U32.0
...
typedef struct hiISP_SHARPEN_DEFAULT_DYNA_REG_CFG_S {
    ...
    HI_U8    u8selPixWgt;
    HI_U8    u8shtVarWgt0;
    HI_U8    u8shtVarDiffThd[2];
    HI_U8    u8shtVarDiffWgt1;

    HI_U8    u8RmfGainScale;
    HI_U8    u8BmfGainScale;
    HI_S16   s16shtVarDiffMul;    // Convert division to multiplication.           // 12-bit signed integer   // S8.4
...
typedef struct hiISP_SHARPEN_MPI_DYNA_REG_CFG_S {
    ...
    HI_U16   u16shtVarMul;        // Convert division to multiplication.           // 11-bit unsigned integer // U7.4
...
typedef struct hiISP_GE_USR_CFG_S {
    HI_BOOL bResh;
    HI_U8   au8GeCtSlope1;   // u4.0    0x9
    HI_U8   au8GeCtSlope2;   // u4.0    0x9
    HI_U16  au16GeCtTh2;     // u14.0   0x200
} ISP_GE_USR_CFG_S;

typedef struct hiISP_GE_DYNA_CFG_S {
    HI_BOOL bResh;
    HI_U16  au16GeCtTh1;     // u14.0   0x400
    HI_U16  au16GeCtTh3;     // u14.0   0x200
...
typedef struct hiISP_EXPANDER_STATIC_CFG_S {
    ...
    HI_U8   u8BitDepthIn;
    HI_U8   u8BitDepthOut;
    HI_U16  au16Lut[EXPANDER_NODE_NUM];
...
typedef struct hiISP_FSWDR_DYNA_CFG_S {
    ...
    HI_U16      u16MdtNFLowThr;    // u11.0,[0,2047]
    HI_U16      u16MdtNFHighThr;  // u11.0,[0,2047]
    HI_U16      u16GainSumLowThr;   // u8.0,[0,255]
    HI_U16      u16GainSumHighThr; // u8.0,[0,255]

    HI_U16      u16ForceLongSlope;    // u10.4,[0,16383]
    HI_U16      u16WgtSlope;         // u8.4,[0,4095]
...
typedef struct hiISP_LOCAL_CAC_USR_CFG_S {
    ...
    HI_U8   u8DeFColorCr;
    HI_U8   u8DeFColorCb;
    HI_U16  u16CbCntRatio;       // u7.4, [0,1024]
...
typedef struct hiISP_CA_USR_CFG {
    ...
    HI_S16  s16CaLumaRatioHigh; // U1.10   High Lightness Thresh' Ratio in Y-Alpha
    HI_S16  s16CaLumaRatioLow;
    HI_U16  au16YRatioLUT[HI_ISP_CA_YRATIO_LUT_LENGTH]; // U1.10
    HI_S16  s16CaYLumaRatio;
    HI_S16  s16CaSkinBetaRatio;
    HI_U32  u32UpdateIndex;
} ISP_CA_USR_CFG_S;
...
typedef struct hiISP_CA_STATIC_CFG {
    ...
    HI_S16  s16CaLumaRatioLow;      // U1.10
...
typedef struct hiISP_BAYERNR_STATIC_CFG_S {
    ...
    HI_BOOL bLumaSel;                           // u1.0
    HI_U8    u8EnablePostProc;   // u8.0
    HI_U8    u8BilateralEnable;  // u8.0
    HI_BOOL bEnableSymmsad;  // u1.0
    HI_U8  u8ImplsnrStrength;  // u8.0
    HI_BOOL bImplsnrEnable3; // u1.0
    HI_BOOL bImplsnrEnable2; // u1.0
    HI_BOOL bImplsnrEnable1; // u1.0
    HI_U8   u8Gainsad; // u8.0
    HI_BOOL bPatternNoiseReduction; // u1.0
    HI_U8 u8WindowSizeSel; // u8.0
...
typedef struct hiISP_BAYERNR_DYNA_CFG_S {
    ...
    HI_U8   au8JnlmLimitEvenLut[HI_ISP_BAYERNR_LMTLUT_EVEN_NUM];      // u8.0
    HI_U8   au8JnlmLimitOddLut[HI_ISP_BAYERNR_LMTLUT_ODD_NUM];      // u8.0

    HI_U8   au8JnlmLimitSLut[HI_ISP_BAYERNR_LMTLUTNUM];     // u8.0
    HI_U8   au8JnlmLimitSEvenLut[HI_ISP_BAYERNR_LMTLUT_EVEN_NUM];     // u8.0
    HI_U8   au8JnlmLimitSOddLut[HI_ISP_BAYERNR_LMTLUT_ODD_NUM];     // u8.0

    HI_U16  au16JnlmCoringLowLut[HI_ISP_BAYERNR_LUT_LENGTH]; // u14.0
    HI_U16  au16JnlmCoringLowEvenLut[HI_ISP_BAYERNR_LUT_EVEN_LENGTH]; // u14.0
    HI_U16  au16JnlmCoringLowOddLut[HI_ISP_BAYERNR_LUT_ODD_LENGTH]; // u14.0

    HI_U8   au8GcoringLut[HI_ISP_BAYERNR_LUT_LENGTH];     // u8.0
    HI_U8   au8GcoringEvenLut[HI_ISP_BAYERNR_LUT_EVEN_LENGTH];     // u8.0
    HI_U8   au8GcoringOddLut[HI_ISP_BAYERNR_LUT_ODD_LENGTH];     // u8.0
...
typedef struct hiISP_RGBIR_USR_CFG_S {
    HI_BOOL bResh;
    ...
    HI_S16  s16Matrix[12];  // s15.0
    HI_U32  u32UpdateIndex;
} ISP_RGBIR_USR_CFG_S;

typedef struct hiISP_RGBIR_REG_CFG_S {
    HI_BOOL bEnable;
...
typedef struct ISP_BNR_LUT2STT_SYNC_REG_CFG_S {
    HI_U32    au32JnlmLimitMultGain[4];
    HI_U32    au32JnlmLimitMultGainS[4];
    HI_U8     u8JnlmGain;
...
typedef struct ISP_CA_LUT2STT_SYNC_REG_CFG_S {
    HI_S16  s16CaLumaRatioHigh;
    HI_S16  s16CaLumaRatioLow;
    HI_S16  s16CaYLumaRatio;
    HI_U16  u16CaIsoRatio;
...
typedef union hiISP_REG_CFG_KEY_U {
    ...
    struct {
        ...
        HI_U64  bit1RgbirCfg    : 1 ;   /* [44] */
        HI_U64  bit19Rsv        : 19;   /* [45:63] */
    };
} ISP_REG_CFG_KEY_U;
...
typedef struct hiISP_BE_SYNC_PARA_S {
    ...
    HI_U64  au64LdciWriteSttAddr[ISP_STRIPING_MAX_NUM];
    HI_U64  au64LdciReadSttAddr[ISP_STRIPING_MAX_NUM];
} ISP_BE_SYNC_PARA_S;
...
typedef struct hiISP_LDCI_BUF_S {
    HI_BOOL           bInit;
    HI_U8             u8BufIdx;
    HI_U8             u8BufNum;
...
typedef struct hiISP_LDCI_STT_ADDR_S {
    HI_U64 au64CurWriteSttAddr[ISP_STRIPING_MAX_NUM];
    HI_U64 au64ReadSttAddr[ISP_STRIPING_MAX_NUM];
    ISP_LDCI_STAT_S stLdciStat;
} ISP_LDCI_STT_ADDR_S;

typedef struct hiISP_LDCI_READ_STT_BUF_S {
    HI_U8  u8BufNum;
    HI_U8  u8BufIdx;
    HI_U64 u64HeadPhyAddr;
...
#define ISP_CHECK_BEBUF_INIT(pipe)\
    do{\
        if (g_astIspDrvCtx[pipe].stBeBufInfo.bInit != HI_TRUE)\
        {\
...
#define ISP_CHECK_TRANBUF_INIT(pipe)\
    do{\
        if (g_astIspDrvCtx[pipe].stTransInfo.bInit != HI_TRUE)\
        {\
