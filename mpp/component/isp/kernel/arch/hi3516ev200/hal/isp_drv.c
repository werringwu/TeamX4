...
static __inline HI_S32 ISP_DRV_SetWdrWgtSlope(S_ISPBE_REGS_TYPE *pstIspBeRegs, HI_U32 uisp_wdr_weight_slope)
{
...
HI_S32 ISP_DRV_FE_SwitchSttAddr(VI_PIPE ViPipeBind, HI_U8 u8WdrIndex, ISP_DRV_CTX_S *pstDrvCtx)
{
    ...
    if (pstDrvCtx->stFeSttAttr.stFeSttBuf[u8WdrIndex].bFirstFrame == HI_TRUE) {
...
HI_S32 ISP_DRV_BE_AE_OfflineStatisticsRead(ISP_STAT_S *pstStat, S_ISP_STT_REGS_TYPE *apstBeStt[],
                                           HI_U8 u8BlkNum)
{
    HI_U8  k;
    HI_U8  u8BlockOffset    = 0;
...
HI_S32 ISP_DRV_BE_AWB_OfflineStatisticsRead(VI_PIPE ViPipe, ISP_STAT_S *pstStat,  S_ISP_STT_REGS_TYPE *apstBeStt[], HI_U8 u8BlkNum, HI_U8 u8BlkDev, ISP_STAT_KEY_U unStatkey)
{
    ...
    HI_U32 u32Col, u32Row;
    ISP_DRV_CTX_S *pstDrvCtx = HI_NULL;
    ISP_SYNC_CFG_BUF_NODE_S *pstNode = HI_NULL;
    HI_U32 WbGainBfStat[ISP_BAYER_CHN_NUM] = {0x100, 0x100, 0x100, 0x100};
    HI_U16 RgainConv = 0x100;
    HI_U16 GgainConv = 0x100;
    HI_U16 BgainConv = 0x100;
...
HI_S32 ISP_DRV_Flicker_OfflineStatisticsRead(ISP_STAT_S *pstStat, S_ISP_STT_REGS_TYPE *apstBeStt[], HI_U8 u8BlkNum)
{

    return HI_SUCCESS;
}

HI_S32 ISP_DRV_LDCI_OfflineStatisticsRead(VI_PIPE ViPipe, ISP_STAT_S *pstStat)
{
    ISP_DRV_CTX_S *pstDrvCtx = HI_NULL;
...
HI_S32 ISP_DRV_FeSttBufExit(VI_PIPE ViPipe)
{
    ...
    if (pstDrvCtx->stWDRAttr.bMastPipe == HI_TRUE) {
        osal_spin_lock_irqsave(&g_stIspLock[ViPipe], &u32Flags);
...
HI_S32 ISP_DRV_UpdateLdciTprOfflineStat(VI_PIPE ViPipe, ISP_BE_WO_REG_CFG_S *pstBeCfg)
{
    HI_U8  i;
    HI_U64 u64PhyAddr;
    ISP_DRV_CTX_S *pstDrvCtx = HI_NULL;
...
HI_S32 ISP_DRV_UpdateLdciTprSttAddr(VI_PIPE ViPipe, ISP_BE_WO_REG_CFG_S *pstBeCfg)
{
    HI_U8  i;
    HI_U64 u64PhyAddr;
    ISP_DRV_CTX_S *pstDrvCtx = HI_NULL;
