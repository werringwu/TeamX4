...
// File name     :  VDP_c_union_define.h
...
// History       :  xxx 2019/01/22 10:48:29 Create file
// ******************************************************************************

#ifndef __VDP_C_UNION_DEFINE_H__
#define __VDP_C_UNION_DEFINE_H__
...
typedef union {
    /* Define the struct bits */
    struct {
        unsigned int    hipp_csc_coef00       : 11  ; /* [10..0] */
...
typedef union {
    /* Define the struct bits */
    struct {
        unsigned int    hipp_csc_coef01       : 11  ; /* [10..0] */
        unsigned int    reserved_0            : 21  ; /* [31..11] */
    } bits;
...
typedef union {
    /* Define the struct bits */
    struct {
        unsigned int    hipp_csc_coef02       : 11  ; /* [10..0] */
        unsigned int    reserved_0            : 21  ; /* [31..11] */
    } bits;
...
typedef union {
    /* Define the struct bits */
    struct {
        unsigned int    hipp_csc_coef10       : 11  ; /* [10..0] */
        unsigned int    reserved_0            : 21  ; /* [31..11] */
    } bits;
...
typedef union {
    /* Define the struct bits */
    struct {
        unsigned int    hipp_csc_coef11       : 11  ; /* [10..0] */
        unsigned int    reserved_0            : 21  ; /* [31..11] */
    } bits;
...
typedef union {
    /* Define the struct bits */
    struct {
        unsigned int    hipp_csc_coef12       : 11  ; /* [10..0] */
        unsigned int    reserved_0            : 21  ; /* [31..11] */
    } bits;
...
typedef union {
    /* Define the struct bits */
    struct {
        unsigned int    hipp_csc_coef20       : 11  ; /* [10..0] */
        unsigned int    reserved_0            : 21  ; /* [31..11] */
    } bits;
...
typedef union {
    /* Define the struct bits */
    struct {
        unsigned int    hipp_csc_coef21       : 11  ; /* [10..0] */
        unsigned int    reserved_0            : 21  ; /* [31..11] */
    } bits;
...
typedef union {
    /* Define the struct bits */
    struct {
        unsigned int    hipp_csc_coef22       : 11  ; /* [10..0] */
        unsigned int    reserved_0            : 21  ; /* [31..11] */
    } bits;
...
typedef struct {
    ...
    unsigned int                    reserved_8[19]                   ; /* 0x71a4~0x71ec */
    ...
    unsigned int                    reserved_9[6012]                 ; /* 0x7210~0xcffc */
    ...
    unsigned int                    reserved_10[4]                   ; /* 0xd028~0xd034 */
    U_DHD0_PARAUP                   DHD0_PARAUP                      ; /* 0xd038 */
    unsigned int                    reserved_11[19]                  ; /* 0xd03c~0xd084 */
    U_DHD0_STATE                    DHD0_STATE                       ; /* 0xd088 */
    unsigned int                    reserved_12                      ; /* 0xd08c */
    U_VO_MUX                        VO_MUX                           ; /* 0xd090 */
    unsigned int                    reserved_13[3931]                ; /* 0xd094~0x10dfc */
    U_GFX_READ_CTRL                 GFX_READ_CTRL                    ; /* 0x10e00 */
    U_GFX_MAC_CTRL                  GFX_MAC_CTRL                     ; /* 0x10e04 */
    U_GFX_OUT_CTRL                  GFX_OUT_CTRL                     ; /* 0x10e08 */
    unsigned int                    reserved_14[7]                   ; /* 0x10e0c~0x10e24 */
    U_GFX_1555_ALPHA                GFX_1555_ALPHA                   ; /* 0x10e28 */
    unsigned int                    reserved_15[5]                   ; /* 0x10e2c~0x10e3c */
