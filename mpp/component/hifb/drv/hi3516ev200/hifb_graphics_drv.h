...
HI_BOOL HIFB_GRAPHIC_DRV_GetDcmpEnableState(HAL_DISP_LAYER_E enLayer, HI_BOOL *pbEnable);
HI_BOOL HIFB_GRAPHIC_DRV_SetDcmpInfo(HAL_DISP_LAYER_E enLayer, GRAPHIC_DCMP_INFO_S *pstDcmpInfo);
...
HI_BOOL HIFB_DRV_SetGfxExt(HAL_DISP_LAYER_E enLayer, HAL_GFX_BITEXTEND_E enMode);
HI_BOOL HIFB_DRV_SetGfxPalpha(HAL_DISP_LAYER_E enLayer, HI_U32 bAlphaEn, HI_U32 bArange, HI_U8 u8Alpha0, HI_U8 u8Alpha1);
HI_BOOL HIFB_DRV_LAYER_SetLayerGalpha(HAL_DISP_LAYER_E enLayer,HI_U8 u8Alpha0);
...
HI_BOOL HIFB_Graphics_DRV_SetLayerDataFmt(HAL_DISP_LAYER_E enLayer, HAL_DISP_PIXEL_FORMAT_E  enDataFmt);
...
HI_BOOL HIFB_DRV_SetColorKeyValue(HAL_DISP_LAYER_E enLayer, HAL_GFX_KEY_MAX_S stKeyMax, HAL_GFX_KEY_MIN_S stKeyMin);
...
HI_VOID HIFB_DRV_ClrWbcMask(HAL_DISP_LAYER_E enLayer);
HI_VOID HIFB_DRV_ClearWbcIntStatus(HAL_DISP_LAYER_E enLayer);
...
HI_VOID HIFB_ZME_COEF_INIT(HI_VOID);
...
HI_S32 HIFB_DRV_CheckCscCoef(HAL_DISP_LAYER_E gfxLayer, VO_CSC_S *pstGfxCsc);
