...
static HI_S32 SAMPLE_MISC_VoDump(VO_DEV VoDev, HI_S32 s32Cnt)
{
    HI_S32             i, s32Ret;
    ...
    snprintf(szYuvName, 128, "./vo_layer%d_chn%d_%ux%u_%s_%s_%d.yuv", VoDev, g_VoChn,
...
HI_S32 vo_chn_dump(int argc, char* argv[])
#else
