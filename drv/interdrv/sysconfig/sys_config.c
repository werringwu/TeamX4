...
char sensor_list[SENSOR_NAME_LEN] = "ar0237";       /* imx307 imx327 sc4236 sc2235  imx335  os05a gc2053 bt656 bt1120 imx307_2l,imx327_2l,ar0237*/
char chip_list[CHIP_NAME_LEN]     = "hi3516ev300";  /* hi3516ev200 hi3516ev300 hi3518ev300 hi3516dv200 */
...
BUS_TYPE parse_sensor_bus_type(const char *name)
{
    ...
    if (   (0 == strncmp("imx307", name, len))
        ...
        || (0 == strncmp("imx327_2l", name, len))
        || (0 == strncmp("ar0237",name,len))
        || (0 == strncmp("sc2315e",name,len))
        || (0 == strncmp("sc2310",name,len))
        )
...
int parse_sensor_clock(const char *name)
{
         ...
         )
    {
        clock = 0x4;
           ...
           || (0 ==strncmp("ar0237",name,len))// AR0237 test
             )
    {
        clock = 0x3;
    }
...
int clkcfg(const char *s, int cmos_yuv_flag ,const char *sensor)
{
    ...
    if (0 == strncmp("hi3516ev200", s, CHIP_NAME_LEN))
    {
    ...
    else if (0 == strncmp("hi3518ev300", s, CHIP_NAME_LEN))
    {
        SYS_WRITEL(reg_crg_base+0x00A0, 0x00240400);
        SYS_WRITEL(reg_crg_base+0x00F4, 0x00110000);
        SYS_WRITEL(reg_crg_base+0x00FC, 0x00000008);
    }
    else if (   (strncmp("hi3516ev300", s, CHIP_NAME_LEN) == 0)
             || (strncmp("hi3516dv200", s, CHIP_NAME_LEN) == 0))
    {
...
void i2c0_for_mipi_sensor_pin_mux_16ev300(void)
{
...
void i2c0_for_mipi_sensor_pin_mux_16ev200(void)
{
    SYS_WRITEL(reg_iocfg_vio_base + 0x0030, 0x1d00);
    SYS_WRITEL(reg_iocfg_vio_base + 0x0034, 0x1d00);
    if (0 == strncmp("sck", board_list, BOARD_NAME_LEN)) {
...
void aic31_reset_16ev200_sck(void)
{
...
void aic31_reset_16ev300_sck(void)
{
    SYS_WRITEL(reg_iocfg_ahb_base+0x009C, 0x1000);
...
/* for 16ev200 sck */
void i2c1_for_aic31_pin_mux_16ev200(void)
{
...
/* for 16ev300 sck, 16dv200 sck */
void i2c1_for_aic31_pin_mux_16ev300(void)
{
    SYS_WRITEL(reg_iocfg_ahb_base + 0x000c, 0x1c03); /* 0x0:GPIO0_3, 0x3:I2C1_SCL */
    SYS_WRITEL(reg_iocfg_ahb_base + 0x0010, 0x1c03); /* 0x0:GPIO0_4, 0x3:I2C1_SDA */
}
...
{
    SYS_WRITEL(reg_iocfg_vio_base+0x003c, 0x1d01);
    SYS_WRITEL(reg_iocfg_vio_base+0x0038, 0x1d01);
...
void spi0_pin_mux_16ev200(void)
{
    reg_write32(0x1 << 12, 0x1 << 12, reg_crg_base+0x01bc); /* SPI0 clock for LCD*/

    SYS_WRITEL(reg_iocfg_vio_base+0x0038, 0x1077);
    SYS_WRITEL(reg_iocfg_vio_base+0x003C, 0x1407);
    SYS_WRITEL(reg_iocfg_vio_base+0x0040, 0x1077);
...
{
    SYS_WRITEL(reg_iocfg_ahb_base+0x008C, 0x1031);
    SYS_WRITEL(reg_iocfg_ahb_base+0x0084, 0x1041);
    SYS_WRITEL(reg_iocfg_ahb_base+0x0090, 0x1001);
    SYS_WRITEL(reg_iocfg_ahb_base+0x0088, 0x1001);
}
...
void vi_mipi_rx_mux_16ev300(void)
{
...
void vi_raw_mode_mux_16ev300(void)
{
...
void vi_bt656_mux_16ev300(void)
{
    SYS_WRITEL(reg_iocfg_vio_base+0x0000, 0x1002);
    SYS_WRITEL(reg_iocfg_vio_base+0x0004, 0x1002);
    SYS_WRITEL(reg_iocfg_vio_base+0x0008, 0x1003);
...
void vi_raw_mode_mux_16ev200(void)
{
    SYS_WRITEL(reg_iocfg_vio_base+0x0000, 0x1002);
    SYS_WRITEL(reg_iocfg_vio_base+0x0004, 0x1002);
...
void vo_bt1120_mode_mux_16ev300(void)
{
    SYS_WRITEL(reg_iocfg_vio_base+0x0048, 0x1A56);
    SYS_WRITEL(reg_iocfg_vio_base+0x0074, 0x1466);
    SYS_WRITEL(reg_iocfg_vio_base+0x0070, 0x1426);
    SYS_WRITEL(reg_iocfg_vio_base+0x0080, 0x1426);
    SYS_WRITEL(reg_iocfg_vio_base+0x0084, 0x1426);
    SYS_WRITEL(reg_iocfg_vio_base+0x0088, 0x1426);
    SYS_WRITEL(reg_iocfg_vio_base+0x008C, 0x1426);
    SYS_WRITEL(reg_iocfg_vio_base+0x0090, 0x1426);
    SYS_WRITEL(reg_iocfg_vio_base+0x0094, 0x1426);
    SYS_WRITEL(reg_iocfg_vio_base+0x006C, 0x1E16);
    SYS_WRITEL(reg_iocfg_vio_base+0x0068, 0x1426);
    SYS_WRITEL(reg_iocfg_vio_base+0x0058, 0x1426);
    SYS_WRITEL(reg_iocfg_vio_base+0x005C, 0x1426);
    SYS_WRITEL(reg_iocfg_vio_base+0x0060, 0x1426);
    SYS_WRITEL(reg_iocfg_vio_base+0x0064, 0x1426);
    SYS_WRITEL(reg_iocfg_vio_base+0x004C, 0x1426);
    SYS_WRITEL(reg_iocfg_vio_base+0x0050, 0x1426);

}

void vo_bt1120_mode_mux_16ev200(void)
{
    SYS_WRITEL(reg_iocfg_vio_base+0x0048, 0x1A46);
    SYS_WRITEL(reg_iocfg_vio_base+0x0074, 0x1466);
    SYS_WRITEL(reg_iocfg_vio_base+0x0070, 0x1036);
    SYS_WRITEL(reg_iocfg_ahb_base+0x0040, 0x1E66);
    SYS_WRITEL(reg_iocfg_ahb_base+0x0044, 0x1566);
    SYS_WRITEL(reg_iocfg_ahb_base+0x0048, 0x1566);
    SYS_WRITEL(reg_iocfg_ahb_base+0x004C, 0x1566);
    SYS_WRITEL(reg_iocfg_ahb_base+0x0050, 0x1566);
    SYS_WRITEL(reg_iocfg_ahb_base+0x0054, 0x1566);
    SYS_WRITEL(reg_iocfg_vio_base+0x006C, 0x1A36);
    SYS_WRITEL(reg_iocfg_vio_base+0x0068, 0x1036);
    SYS_WRITEL(reg_iocfg_vio_base+0x0058, 0x1036);
    SYS_WRITEL(reg_iocfg_vio_base+0x005C, 0x1036);
    SYS_WRITEL(reg_iocfg_vio_base+0x0060, 0x1036);
    SYS_WRITEL(reg_iocfg_vio_base+0x0064, 0x1036);
    SYS_WRITEL(reg_iocfg_vio_base+0x004C, 0x1036);
    SYS_WRITEL(reg_iocfg_vio_base+0x0050, 0x1036);
}

void vo_bt656_mode_mux_16ev300(void)
{
...
void vo_bt656_mode_mux_16ev200(void)
{
...
void vo_16bit_lcd_mux(void)
{
    ...
    SYS_WRITEL(reg_iocfg_vio_base+0x0054, 0x1035);
...
{
    SYS_WRITEL(reg_iocfg_vio_base+0x0048, 0x1A05);
    SYS_WRITEL(reg_iocfg_vio_base+0x0074, 0x1005);
    SYS_WRITEL(reg_iocfg_vio_base+0x0070, 0x1005);
    SYS_WRITEL(reg_iocfg_vio_base+0x006C, 0x1A05);
    SYS_WRITEL(reg_iocfg_vio_base+0x0068, 0x1005);
    SYS_WRITEL(reg_iocfg_vio_base+0x0058, 0x1005);
    SYS_WRITEL(reg_iocfg_vio_base+0x005C, 0x1005);
    SYS_WRITEL(reg_iocfg_vio_base+0x0060, 0x1005);
    SYS_WRITEL(reg_iocfg_vio_base+0x0064, 0x1005);
    SYS_WRITEL(reg_iocfg_vio_base+0x0054, 0x1A05);
    SYS_WRITEL(reg_iocfg_vio_base+0x004c, 0x1005);
    SYS_WRITEL(reg_iocfg_vio_base+0x0050, 0x1005);
}

void vo_8bit_lcd_for_sckb_mux_16ev200(void)
{
...
{
    SYS_WRITEL(reg_iocfg_vio_base+0x0074, 0x1034);
    SYS_WRITEL(reg_iocfg_vio_base+0x0070, 0x1034);
    SYS_WRITEL(reg_iocfg_vio_base+0x0080, 0x1034);
    SYS_WRITEL(reg_iocfg_vio_base+0x0084, 0x1034);
    SYS_WRITEL(reg_iocfg_vio_base+0x0088, 0x1034);
    SYS_WRITEL(reg_iocfg_vio_base+0x008C, 0x1034);
    SYS_WRITEL(reg_iocfg_vio_base+0x0090, 0x1034);
    SYS_WRITEL(reg_iocfg_vio_base+0x0094, 0x1034);
    SYS_WRITEL(reg_iocfg_vio_base+0x006C, 0x1A34);
    SYS_WRITEL(reg_iocfg_vio_base+0x0068, 0x1004);
    SYS_WRITEL(reg_iocfg_vio_base+0x0078, 0x1034);
    SYS_WRITEL(reg_iocfg_vio_base+0x007C, 0x1034);
}

/* for 16ev200 sck */
void i2s0_pin_mux_16ev200(void)
{
...
/* for 16ev300 sck, 16dv200 sck */
void i2s0_pin_mux_16ev300(void)
{
    /* reuse with JTAG, open when running audio */
    SYS_WRITEL(reg_iocfg_core_base + 0x0010, 0x1E25); /* I2S_MCLK */
    SYS_WRITEL(reg_iocfg_core_base + 0x0014, 0x1E65); /* I2S_BCLK */
    SYS_WRITEL(reg_iocfg_core_base + 0x0018, 0x1D25); /* I2S_WS */
    SYS_WRITEL(reg_iocfg_core_base + 0x001C, 0x1405); /* I2S_SD_RX */
    SYS_WRITEL(reg_iocfg_core_base + 0x0020, 0x1D25); /* I2S_SD_TX */
}

/* for 16ev200 demo, 16ev200 sck, 16ev300 demo */
void amp_unmute_mux_16ev200_demo(void)
{
...
/* for 16ev300 sck, 16dv200 sck */
void amp_unmute_mux_16ev300_sck(void)
{
...
/* for 18ev300 sck */
void amp_unmute_mux_18ev300(void)
{
...
{
    /* 18ev300 demo */
    if (0 == strncmp("hi3518ev300", chip_name, CHIP_NAME_LEN))
    {
        ...
        /*audio*/
        amp_unmute_mux_18ev300();
    }
    /* 16ev200 */
    else if (0 == strncmp("hi3516ev200", chip_name, CHIP_NAME_LEN))
    {   /* 16ev200 demo */
        ...
        else if (0 == strncmp("sck", board, BOARD_NAME_LEN))
        {
            ...
            i2c2_pin_mux();
            vo_bt1120_mode_mux_16ev200();
            //vo_bt656_mode_mux_16ev200();
            //spi0_pin_mux_16ev200(); //lcd
            //vo_8bit_lcd_for_sckb_mux_16ev200();

            /*audio*/
            amp_unmute_mux_16ev200_demo();
            //aic31_reset_16ev200_sck();
            //i2c1_for_aic31_pin_mux_16ev200();
            //i2s0_pin_mux_16ev200();
        }
    }
    else if (0 == strncmp("hi3516ev300", chip_name, CHIP_NAME_LEN))
    {
        if (0 == strncmp("demo", board, BOARD_NAME_LEN))
        {
            i2c0_for_mipi_sensor_pin_mux_16ev300();
            sensor_cfg_for_mipi_sensor_mux();
            ...
            if (cmos_yuv_flag == 0)
            {
                vi_mipi_rx_mux_16ev300();
            } /*cmos*/
            else if (cmos_yuv_flag == 1)
            {
                vi_raw_mode_mux_16ev300();
            }
            else
            {
            }
        ...
        {
            i2c1_pin_mux();
            vo_bt1120_mode_mux_16ev300();
            //vo_bt656_mode_mux_16ev300();
            ...
            /*audio*/
            amp_unmute_mux_16ev300_sck();
            //aic31_reset_16ev300_sck();
            //i2c1_for_aic31_pin_mux_16ev300();
            //i2s0_pin_mux_16ev300();
        }
...
int  hi_sysconfig_init(void)
{
    ...
    if (strncmp("hi3516dv200", chip_list, CHIP_NAME_LEN) == 0) {
        pinmux("hi3516ev300", board_list, g_cmos_yuv_flag);
        clkcfg("hi3516ev300", g_cmos_yuv_flag, sensor_list);
    }
    else {
...
void __exit hi_sysconfig_exit(void)
{
