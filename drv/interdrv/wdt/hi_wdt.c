...
#define OSDRV_MODULE_VERSION_STRING "HISI_WDT-MDC030001 @Hi3516ev200"

/* define watchdog IO */
#define HIWDT_BASE      0x12030000
...
#define IO_WDT_ADDRESS(x) ((uintptr_t)(gpWtdgAllReg) + ((x)-(HIWDT_BASE)))
...
static void hidog_feed(void)
{
    ...
    unsigned int v=0;
    v = (unsigned int)hiwdt_readl(HIWDT_RIS);
    v &= 0x1;
