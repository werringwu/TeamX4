...
#define DEV_FILE "/dev/hi_lsadc"

typedef enum hiLSADC_SCAN_MODE
{
...
int Sample_LSADC_SingleStepScanMode(HI_LSADC_SCAN_MODE enAdcMode, int chn)
{
    int i, value;
...
int Sample_LSADC_ContinuousScanMode(HI_LSADC_SCAN_MODE enAdcMode, int chn)
{
    int i, value;
    int fd  = open(DEV_FILE, O_RDWR);
...
#endif
{
    HI_LSADC_SCAN_MODE enAdcMode = LSADC_SCAN_MODE_BUTT;
    int chn = 0;
